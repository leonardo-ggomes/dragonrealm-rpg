...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function ph(){return new ui({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nl(),fragmentShader:`
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function mh(){return new ui({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nl(),fragmentShader:`
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function nl(){return`
...
`].filter(Gs).join(`
`)),o=yc(o),o=Ah(o,e),o=wh(o,e),a=yc(a),a=Ah(a,e),a=wh(a,e),o=Rh(o),a=Rh(a),e.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+p);const y=v+m+o,x=v+p+a,T=bh(i,i.VERTEX_SHADER,y),w=bh(i,i.FRAGMENT_SHADER,x);i.attachShader(_,T),i.attachShader(_,w),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(P){if(r.debug.checkShaderErrors){const U=i.getProgramInfoLog(_).trim(),D=i.getShaderInfoLog(T).trim(),O=i.getShaderInfoLog(w).trim();let W=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,T,w);else{const j=Eh(i,T,"vertex"),X=Eh(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;class px{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const i=new Se,s=t.properties.get(i);s.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new ui({vertexShader:dx,fragmentShader:fx,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Jt(new To(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class mx extends Di{constructor(t,e){super();const n=this;let i=null,s=1,o=null,a="local-floor",c=1,l=null,h=null,u=null,d=null,f=null,g=null;const _=new px,m=e.getContextAttributes();let p=null,v=null;const y=[],x=[],T=new Ut;let w=null;const A=new Be;A.viewport=new jt;const I=new Be;I.viewport=new jt;const S=[A,I],M=new bp;let P=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let et=y[K];return et===void 0&&(et=new $o,y[K]=et),et.getTargetRaySpace()},this.getControllerGrip=function(K){let et=y[K];return et===void 0&&(et=new $o,y[K]=et),et.getGripSpace()},this.getHand=function(K){let et=y[K];return et===void 0&&(et=new $o,y[K]=et),et.getHandSpace()};function D(K){const et=x.indexOf(K.inputSource);if(et===-1)return;const mt=y[et];mt!==void 0&&(mt.update(K.inputSource,K.frame,l||o),mt.dispatchEvent({type:K.type,data:K.inputSource}))}function O(){i.removeEventListener("select",D),i.removeEventListener("selectstart",D),i.removeEventListener("selectend",D),i.removeEventListener("squeeze",D),i.removeEventListener("squeezestart",D),i.removeEventListener("squeezeend",D),i.removeEventListener("end",O),i.removeEventListener("inputsourceschange",W);for(let K=0;K<y.length;K++){const et=x[K];et!==null&&(x[K]=null,y[K].disconnect(et))}P=null,U=null,_.reset(),t.setRenderTarget(p),f=null,d=null,u=null,i=null,v=null,ne.stop(),n.isPresenting=!1,t.setPixelRatio(w),t.setSize(T.width,T.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(K){l=K},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(K){if(i=K,i!==null){if(p=t.getRenderTarget(),i.addEventListener("select",D),i.addEventListener("selectstart",D),i.addEventListener("selectend",D),i.addEventListener("squeeze",D),i.addEventListener("squeezestart",D),i.addEventListener("squeezeend",D),i.addEventListener("end",O),i.addEventListener("inputsourceschange",W),m.xrCompatible!==!0&&await e.makeXRCompatible(),w=t.getPixelRatio(),t.getSize(T),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let mt=null,rt=null,bt=null;m.depth&&(bt=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,mt=m.stencil?tr:Qs,rt=m.stencil?Js:hi);const Yt={colorFormat:e.RGBA8,depthFormat:bt,scaleFactor:s};u=new XRWebGLBinding(i,e),d=u.createProjectionLayer(Yt),i.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),v=new Li(d.textureWidth,d.textureHeight,{format:We,type:Cn,depthTexture:new wu(d.textureWidth,d.textureHeight,rt,void 0,void 0,void 0,void 0,void 0,void 0,mt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const mt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(i,e,mt),i.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),v=new Li(f.framebufferWidth,f.framebufferHeight,{format:We,type:Cn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await i.requestReferenceSpace(a),ne.setContext(i),ne.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function W(K){for(let et=0;et<K.removed.length;et++){const mt=K.removed[et],rt=x.indexOf(mt);rt>=0&&(x[rt]=null,y[rt].disconnect(mt))}for(let et=0;et<K.added.length;et++){const mt=K.added[et];let rt=x.indexOf(mt);if(rt===-1){for(let Yt=0;Yt<y.length;Yt++)if(Yt>=x.length){x.push(mt),rt=Yt;break}else if(x[Yt]===null){x[Yt]=mt,rt=Yt;break}if(rt===-1)break}const bt=y[rt];bt&&bt.connect(mt)}}const G=new R,j=new R;function X(K,et,mt){G.setFromMatrixPosition(et.matrixWorld),j.setFromMatrixPosition(mt.matrixWorld);const rt=G.distanceTo(j),bt=et.projectionMatrix.elements,Yt=mt.projectionMatrix.elements,Rt=bt[14]/(bt[10]-1),fe=bt[14]/(bt[10]+1),ce=(bt[9]+1)/bt[5],Ht=(bt[9]-1)/bt[5],L=(bt[8]-1)/bt[0],Je=(Yt[8]+1)/Yt[0],Wt=Rt*L,Vt=Rt*Je,vt=rt/(-L+Je),re=vt*-L;if(et.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(re),K.translateZ(vt),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),bt[10]===-1)K.projectionMatrix.copy(et.projectionMatrix),K.projectionMatrixInverse.copy(et.projectionMatrixInverse);else{const _t=Rt+vt,C=fe+vt,b=Wt-re,z=Vt+(rt-re),$=ce*fe/C*_t,J=Ht*fe/C*_t;K.projectionMatrix.makePerspective(b,z,$,J,_t,C),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function nt(K,et){et===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(et.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(i===null)return;let et=K.near,mt=K.far;_.texture!==null&&(_.depthNear>0&&(et=_.depthNear),_.depthFar>0&&(mt=_.depthFar)),M.near=I.near=A.near=et,M.far=I.far=A.far=mt,(P!==M.near||U!==M.far)&&(i.updateRenderState({depthNear:M.near,depthFar:M.far}),P=M.near,U=M.far),A.layers.mask=K.layers.mask|2,I.layers.mask=K.layers.mask|4,M.layers.mask=A.layers.mask|I.layers.mask;const rt=K.parent,bt=M.cameras;nt(M,rt);for(let Yt=0;Yt<bt.length;Yt++)nt(bt[Yt],rt);bt.length===2?X(M,A,I):M.projectionMatrix.copy(A.projectionMatrix),ut(K,M,rt)};function ut(K,et,mt){mt===null?K.matrix.copy(et.matrixWorld):(K.matrix.copy(mt.matrixWorld),K.matrix.invert(),K.matrix.multiply(et.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(et.projectionMatrix),K.projectionMatrixInverse.copy(et.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=ps*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function(K){c=K,d!==null&&(d.fixedFoveation=K),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=K)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)};let xt=null;function Ot(K,et){if(h=et.getViewerPose(l||o),g=et,h!==null){const mt=h.views;f!==null&&(t.setRenderTargetFramebuffer(v,f.framebuffer),t.setRenderTarget(v));let rt=!1;mt.length!==M.cameras.length&&(M.cameras.length=0,rt=!0);for(let Rt=0;Rt<mt.length;Rt++){const fe=mt[Rt];let ce=null;if(f!==null)ce=f.getViewport(fe);else{const L=u.getViewSubImage(d,fe);ce=L.viewport,Rt===0&&(t.setRenderTargetTextures(v,L.colorTexture,L.depthStencilTexture),t.setRenderTarget(v))}let Ht=S[Rt];Ht===void 0&&(Ht=new Be,Ht.layers.enable(Rt),Ht.viewport=new jt,S[Rt]=Ht),Ht.matrix.fromArray(fe.transform.matrix),Ht.matrix.decompose(Ht.position,Ht.quaternion,Ht.scale),Ht.projectionMatrix.fromArray(fe.projectionMatrix),Ht.projectionMatrixInverse.copy(Ht.projectionMatrix).invert(),Ht.viewport.set(ce.x,ce.y,ce.width,ce.height),Rt===0&&(M.matrix.copy(Ht.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),rt===!0&&M.cameras.push(Ht)}const bt=i.enabledFeatures;if(bt&&bt.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&u){const Rt=u.getDepthInformation(mt[0]);Rt&&Rt.isValid&&Rt.texture&&_.init(t,Rt,i.renderState)}}for(let mt=0;mt<y.length;mt++){const rt=x[mt],bt=y[mt];rt!==null&&bt!==void 0&&bt.update(rt,et,l||o)}xt&&xt(K,et),et.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:et}),g=null}const ne=new Du;ne.setAnimationLoop(Ot),this.setAnimationLoop=function(K){xt=K},this.dispose=function(){}}}const Si=new In,gx=new Mt;function _x(r,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Mu(r)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,v,y,x){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),u(m,p)):p.isMeshPhongMaterial?(s(m,p),h(m,p)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,x)):p.isMeshMatcapMaterial?(s(m,p),g(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),_(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?c(m,p,v,y):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Oe&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Oe&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const v=t.get(p),y=v.envMap,x=v.envMapRotation;y&&(m.envMap.value=y,Si.copy(x),Si.x*=-1,Si.y*=-1,Si.z*=-1,y.isCubeTexture&&y.isRenderTargetTexture===!1&&(Si.y*=-1,Si.z*=-1),m.envMapRotation.value.setFromMatrix4(gx.makeRotationFromEuler(Si)),m.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,v,y){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*v,m.scale.value=y*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,v){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Oe&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const v=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function xx(r,t,e,n){let i={},s={},o=[];const a=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function c(v,y){const x=y.program;n.uniformBlockBinding(v,x)}function l(v,y){let x=i[v.id];x===void 0&&(g(v),x=h(v),i[v.id]=x,v.addEventListener("dispose",m));const T=y.program;n.updateUBOMapping(v,T);const w=t.render.frame;s[v.id]!==w&&(d(v),s[v.id]=w)}function h(v){const y=u();v.__bindingPointIndex=y;const x=r.createBuffer(),T=v.__size,w=v.usage;return r.bindBuffer(r.UNIFORM_BUFFER,x),r.bufferData(r.UNIFORM_BUFFER,T,w),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,y,x),x}function u(){for(let v=0;v<a;v++)if(o.indexOf(v)===-1)return o.push(v),v;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(v){const y=i[v.id],x=v.uniforms,T=v.__cache;r.bindBuffer(r.UNIFORM_BUFFER,y);for(let w=0,A=x.length;w<A;w++){const I=Array.isArray(x[w])?x[w]:[x[w]];for(let S=0,M=I.length;S<M;S++){const P=I[S];if(f(P,w,S,T)===!0){const U=P.__offset,D=Array.isArray(P.value)?P.value:[P.value];let O=0;for(let W=0;W<D.length;W++){const G=D[W],j=_(G);typeof G=="number"||typeof G=="boolean"?(P.__data[0]=G,r.bufferSubData(r.UNIFORM_BUFFER,U+O,P.__data)):G.isMatrix3?(P.__data[0]=G.elements[0],P.__data[1]=G.elements[1],P.__data[2]=G.elements[2],P.__data[3]=0,P.__data[4]=G.elements[3],P.__data[5]=G.elements[4],P.__data[6]=G.elements[5],P.__data[7]=0,P.__data[8]=G.elements[6],P.__data[9]=G.elements[7],P.__data[10]=G.elements[8],P.__data[11]=0):(G.toArray(P.__data,O),O+=j.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,U,P.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function f(v,y,x,T){const w=v.value,A=y+"_"+x;if(T[A]===void 0)return typeof w=="number"||typeof w=="boolean"?T[A]=w:T[A]=w.clone(),!0;{const I=T[A];if(typeof w=="number"||typeof w=="boolean"){if(I!==w)return T[A]=w,!0}else if(I.equals(w)===!1)return I.copy(w),!0}return!1}function g(v){const y=v.uniforms;let x=0;const T=16;for(let A=0,I=y.length;A<I;A++){const S=Array.isArray(y[A])?y[A]:[y[A]];for(let M=0,P=S.length;M<P;M++){const U=S[M],D=Array.isArray(U.value)?U.value:[U.value];for(let O=0,W=D.length;O<W;O++){const G=D[O],j=_(G),X=x%T,nt=X%j.boundary,ut=X+nt;x+=nt,ut!==0&&T-ut<j.storage&&(x+=T-ut),U.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=x,x+=j.storage}}}const w=x%T;return w>0&&(x+=T-w),v.__size=x,v.__cache={},this}function _(v){const y={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(y.boundary=4,y.storage=4):v.isVector2?(y.boundary=8,y.storage=8):v.isVector3||v.isColor?(y.boundary=16,y.storage=12):v.isVector4?(y.boundary=16,y.storage=16):v.isMatrix3?(y.boundary=48,y.storage=48):v.isMatrix4?(y.boundary=64,y.storage=64):v.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",v),y}function m(v){const y=v.target;y.removeEventListener("dispose",m);const x=o.indexOf(y.__bindingPointIndex);o.splice(x,1),r.deleteBuffer(i[y.id]),delete i[y.id],delete s[y.id]}function p(){for(const v in i)r.deleteBuffer(i[v]);o=[],i={},s={}}return{bind:c,update:l,dispose:p}}class vx{constructor(t={}){const{canvas:e=cf(),context:n=null,depth:i=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=o;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,p=null;const v=[],y=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=li,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let T=!1;this._outputColorSpace=_e;let w=0,A=0,I=null,S=-1,M=null;const P=new jt,U=new jt;let D=null;const O=new Et(0);let W=0,G=e.width,j=e.height,X=1,nt=null,ut=null;const xt=new jt(0,0,G,j),Ot=new jt(0,0,G,j);let ne=!1;const K=new or;let et=!1,mt=!1;const rt=new Mt,bt=new Mt,Yt=new R,Rt=new jt,fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ce=!1;function Ht(){return I===null?X:1}let L=n;function Je(E,F){return e.getContext(E,F)}try{const E={alpha:!0,depth:i,stencil:s,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${yo}`),e.addEventListener("webglcontextlost",Z,!1),e.addEventListener("webglcontextrestored",lt,!1),e.addEventListener("webglcontextcreationerror",ct,!1),L===null){const F="webgl2";if(L=Je(F,E),L===null)throw Je(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let Wt,Vt,vt,re,_t,C,b,z,$,J,Y,gt,ot,Tt,At,Q,dt,wt,It,ft,Gt,Nt,ie,N;function at(){Wt=new C_(L),Wt.init(),Nt=new ux(L,Wt),Vt=new S_(L,Wt,t,Nt),vt=new lx(L,Wt),Vt.reverseDepthBuffer&&d&&vt.buffers.depth.setReversed(!0),re=new L_(L),_t=new $0,C=new hx(L,Wt,vt,_t,Vt,Nt,re),b=new T_(x),z=new R_(x),$=new Op(L),ie=new y_(L,$),J=new I_(L,$,re,ie),Y=new U_(L,J,$,re),It=new D_(L,Vt,C),Q=new b_(_t),gt=new K0(x,b,z,Wt,Vt,ie,Q),ot=new _x(x,_t),Tt=new J0,At=new sx(Wt),wt=new v_(x,b,z,vt,Y,f,c),dt=new ax(x,Y,Vt),N=new xx(L,re,Vt,vt),ft=new M_(L,Wt,re),Gt=new P_(L,Wt,re),re.programs=gt.programs,x.capabilities=Vt,x.extensions=Wt,x.properties=_t,x.renderLists=Tt,x.shadowMap=dt,x.state=vt,x.info=re}at();const q=new mx(x,L);this.xr=q,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const E=Wt.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=Wt.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(E){E!==void 0&&(X=E,this.setSize(G,j,!1))},this.getSize=function(E){return E.set(G,j)},this.setSize=function(E,F,H=!0){if(q.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=E,j=F,e.width=Math.floor(E*X),e.height=Math.floor(F*X),H===!0&&(e.style.width=E+"px",e.style.height=F+"px"),this.setViewport(0,0,E,F)},this.getDrawingBufferSize=function(E){return E.set(G*X,j*X).floor()},this.setDrawingBufferSize=function(E,F,H){G=E,j=F,X=H,e.width=Math.floor(E*H),e.height=Math.floor(F*H),this.setViewport(0,0,E,F)},this.getCurrentViewport=function(E){return E.copy(P)},this.getViewport=function(E){return E.copy(xt)},this.setViewport=function(E,F,H,V){E.isVector4?xt.set(E.x,E.y,E.z,E.w):xt.set(E,F,H,V),vt.viewport(P.copy(xt).multiplyScalar(X).round())},this.getScissor=function(E){return E.copy(Ot)},this.setScissor=function(E,F,H,V){E.isVector4?Ot.set(E.x,E.y,E.z,E.w):Ot.set(E,F,H,V),vt.scissor(U.copy(Ot).multiplyScalar(X).round())},this.getScissorTest=function(){return ne},this.setScissorTest=function(E){vt.setScissorTest(ne=E)},this.setOpaqueSort=function(E){nt=E},this.setTransparentSort=function(E){ut=E},this.getClearColor=function(E){return E.copy(wt.getClearColor())},this.setClearColor=function(){wt.setClearColor(...arguments)},this.getClearAlpha=function(){return wt.getClearAlpha()},this.setClearAlpha=function(){wt.setClearAlpha(...arguments)},this.clear=function(E=!0,F=!0,H=!0){let V=0;if(E){let B=!1;if(I!==null){const tt=I.texture.format;B=tt===kc||tt===Oc||tt===So}if(B){const tt=I.texture.type,st=tt===Cn||tt===hi||tt===Zs||tt===Js||tt===Nc||tt===Fc,ht=wt.getClearColor(),pt=wt.getClearAlpha(),Pt=ht.r,Ct=ht.g,yt=ht.b;st?(g[0]=Pt,g[1]=Ct,g[2]=yt,g[3]=pt,L.clearBufferuiv(L.COLOR,0,g)):(_[0]=Pt,_[1]=Ct,_[2]=yt,_[3]=pt,L.clearBufferiv(L.COLOR,0,_))}else V|=L.COLOR_BUFFER_BIT}F&&(V|=L.DEPTH_BUFFER_BIT),H&&(V|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Z,!1),e.removeEventListener("webglcontextrestored",lt,!1),e.removeEventListener("webglcontextcreationerror",ct,!1),wt.dispose(),Tt.dispose(),At.dispose(),_t.dispose(),b.dispose(),z.dispose(),Y.dispose(),ie.dispose(),N.dispose(),gt.dispose(),q.dispose(),q.removeEventListener("sessionstart",al),q.removeEventListener("sessionend",cl),fi.stop()};function Z(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function lt(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const E=re.autoReset,F=dt.enabled,H=dt.autoUpdate,V=dt.needsUpdate,B=dt.type;at(),re.autoReset=E,dt.enabled=F,dt.autoUpdate=H,dt.needsUpdate=V,dt.type=B}function ct(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function Lt(E){const F=E.target;F.removeEventListener("dispose",Lt),he(F)}function he(E){we(E),_t.remove(E)}function we(E){const F=_t.get(E).programs;F!==void 0&&(F.forEach(function(H){gt.releaseProgram(H)}),E.isShaderMaterial&&gt.releaseShaderCache(E))}this.renderBufferDirect=function(E,F,H,V,B,tt){F===null&&(F=fe);const st=B.isMesh&&B.matrixWorld.determinant()<0,ht=qu(E,F,H,V,B);vt.setMaterial(V,st);let pt=H.index,Pt=1;if(V.wireframe===!0){if(pt=J.getWireframeAttribute(H),pt===void 0)return;Pt=2}const Ct=H.drawRange,yt=H.attributes.position;let Xt=Ct.start*Pt,Kt=(Ct.start+Ct.count)*Pt;tt!==null&&(Xt=Math.max(Xt,tt.start*Pt),Kt=Math.min(Kt,(tt.start+tt.count)*Pt)),pt!==null?(Xt=Math.max(Xt,0),Kt=Math.min(Kt,pt.count)):yt!=null&&(Xt=Math.max(Xt,0),Kt=Math.min(Kt,yt.count));const me=Kt-Xt;if(me<0||me===1/0)return;ie.setup(B,V,ht,H,pt);let ue,qt=ft;if(pt!==null&&(ue=$.get(pt),qt=Gt,qt.setIndex(ue)),B.isMesh)V.wireframe===!0?(vt.setLineWidth(V.wireframeLinewidth*Ht()),qt.setMode(L.LINES)):qt.setMode(L.TRIANGLES);else if(B.isLine){let St=V.linewidth;St===void 0&&(St=1),vt.setLineWidth(St*Ht()),B.isLineSegments?qt.setMode(L.LINES):B.isLineLoop?qt.setMode(L.LINE_LOOP):qt.setMode(L.LINE_STRIP)}else B.isPoints?qt.setMode(L.POINTS):B.isSprite&&qt.setMode(L.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)co("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),qt.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(Wt.get("WEBGL_multi_draw"))qt.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{const St=B._multiDrawStarts,Te=B._multiDrawCounts,$t=B._multiDrawCount,ln=pt?$.get(pt).bytesPerElement:1,Ni=_t.get(V).currentProgram.getUniforms();for(let Xe=0;Xe<$t;Xe++)Ni.setValue(L,"_gl_DrawID",Xe),qt.render(St[Xe]/ln,Te[Xe])}else if(B.isInstancedMesh)qt.renderInstances(Xt,me,B.count);else if(H.isInstancedBufferGeometry){const St=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,Te=Math.min(H.instanceCount,St);qt.renderInstances(Xt,me,Te)}else qt.render(Xt,me)};function Qt(E,F,H){E.transparent===!0&&E.side===mn&&E.forceSinglePass===!1?(E.side=Oe,E.needsUpdate=!0,hr(E,F,H),E.side=xn,E.needsUpdate=!0,hr(E,F,H),E.side=mn):hr(E,F,H)}this.compile=function(E,F,H=null){H===null&&(H=E),p=At.get(H),p.init(F),y.push(p),H.traverseVisible(function(B){B.isLight&&B.layers.test(F.layers)&&(p.pushLight(B),B.castShadow&&p.pushShadow(B))}),E!==H&&E.traverseVisible(function(B){B.isLight&&B.layers.test(F.layers)&&(p.pushLight(B),B.castShadow&&p.pushShadow(B))}),p.setupLights();const V=new Set;return E.traverse(function(B){if(!(B.isMesh||B.isPoints||B.isLine||B.isSprite))return;const tt=B.material;if(tt)if(Array.isArray(tt))for(let st=0;st<tt.length;st++){const ht=tt[st];Qt(ht,H,B),V.add(ht)}else Qt(tt,H,B),V.add(tt)}),p=y.pop(),V},this.compileAsync=function(E,F,H=null){const V=this.compile(E,F,H);return new Promise(B=>{function tt(){if(V.forEach(function(st){_t.get(st).currentProgram.isReady()&&V.delete(st)}),V.size===0){B(E);return}setTimeout(tt,10)}Wt.get("KHR_parallel_shader_compile")!==null?tt():setTimeout(tt,10)})};let cn=null;function Ln(E){cn&&cn(E)}function al(){fi.stop()}function cl(){fi.start()}const fi=new Du;fi.setAnimationLoop(Ln),typeof self<"u"&&fi.setContext(self),this.setAnimationLoop=function(E){cn=E,q.setAnimationLoop(E),E===null?fi.stop():fi.start()},q.addEventListener("sessionstart",al),q.addEventListener("sessionend",cl),this.render=function(E,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),q.enabled===!0&&q.isPresenting===!0&&(q.cameraAutoUpdate===!0&&q.updateCamera(F),F=q.getCamera()),E.isScene===!0&&E.onBeforeRender(x,E,F,I),p=At.get(E,y.length),p.init(F),y.push(p),bt.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),K.setFromProjectionMatrix(bt),mt=this.localClippingEnabled,et=Q.init(this.clippingPlanes,mt),m=Tt.get(E,v.length),m.init(),v.push(m),q.enabled===!0&&q.isPresenting===!0){const tt=x.xr.getDepthSensingMesh();tt!==null&&Ro(tt,F,-1/0,x.sortObjects)}Ro(E,F,0,x.sortObjects),m.finish(),x.sortObjects===!0&&m.sort(nt,ut),ce=q.enabled===!1||q.isPresenting===!1||q.hasDepthSensing()===!1,ce&&wt.addToRenderList(m,E),this.info.render.frame++,et===!0&&Q.beginShadows();const H=p.state.shadowsArray;dt.render(H,E,F),et===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=m.opaque,B=m.transmissive;if(p.setupLights(),F.isArrayCamera){const tt=F.cameras;if(B.length>0)for(let st=0,ht=tt.length;st<ht;st++){const pt=tt[st];hl(V,B,E,pt)}ce&&wt.render(E);for(let st=0,ht=tt.length;st<ht;st++){const pt=tt[st];ll(m,E,pt,pt.viewport)}}else B.length>0&&hl(V,B,E,F),ce&&wt.render(E),ll(m,E,F);I!==null&&A===0&&(C.updateMultisampleRenderTarget(I),C.updateRenderTargetMipmap(I)),E.isScene===!0&&E.onAfterRender(x,E,F),ie.resetDefaultState(),S=-1,M=null,y.pop(),y.length>0?(p=y[y.length-1],et===!0&&Q.setGlobalState(x.clippingPlanes,p.state.camera)):p=null,v.pop(),v.length>0?m=v[v.length-1]:m=null};function Ro(E,F,H,V){if(E.visible===!1)return;if(E.layers.test(F.layers)){if(E.isGroup)H=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(F);else if(E.isLight)p.pushLight(E),E.castShadow&&p.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||K.intersectsSprite(E)){V&&Rt.setFromMatrixPosition(E.matrixWorld).applyMatrix4(bt);const st=Y.update(E),ht=E.material;ht.visible&&m.push(E,st,ht,H,Rt.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||K.intersectsObject(E))){const st=Y.update(E),ht=E.material;if(V&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),Rt.copy(E.boundingSphere.center)):(st.boundingSphere===null&&st.computeBoundingSphere(),Rt.copy(st.boundingSphere.center)),Rt.applyMatrix4(E.matrixWorld).applyMatrix4(bt)),Array.isArray(ht)){const pt=st.groups;for(let Pt=0,Ct=pt.length;Pt<Ct;Pt++){const yt=pt[Pt],Xt=ht[yt.materialIndex];Xt&&Xt.visible&&m.push(E,st,Xt,H,Rt.z,yt)}}else ht.visible&&m.push(E,st,ht,H,Rt.z,null)}}const tt=E.children;for(let st=0,ht=tt.length;st<ht;st++)Ro(tt[st],F,H,V)}function ll(E,F,H,V){const B=E.opaque,tt=E.transmissive,st=E.transparent;p.setupLightsView(H),et===!0&&Q.setGlobalState(x.clippingPlanes,H),V&&vt.viewport(P.copy(V)),B.length>0&&lr(B,F,H),tt.length>0&&lr(tt,F,H),st.length>0&&lr(st,F,H),vt.buffers.depth.setTest(!0),vt.buffers.depth.setMask(!0),vt.buffers.color.setMask(!0),vt.setPolygonOffset(!1)}function hl(E,F,H,V){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[V.id]===void 0&&(p.state.transmissionRenderTarget[V.id]=new Li(1,1,{generateMipmaps:!0,type:Wt.has("EXT_color_buffer_half_float")||Wt.has("EXT_color_buffer_float")?sr:Cn,minFilter:Wn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:zt.workingColorSpace}));const tt=p.state.transmissionRenderTarget[V.id],st=V.viewport||P;tt.setSize(st.z*x.transmissionResolutionScale,st.w*x.transmissionResolutionScale);const ht=x.getRenderTarget();x.setRenderTarget(tt),x.getClearColor(O),W=x.getClearAlpha(),W<1&&x.setClearColor(16777215,.5),x.clear(),ce&&wt.render(H);const pt=x.toneMapping;x.toneMapping=li;const Pt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),p.setupLightsView(V),et===!0&&Q.setGlobalState(x.clippingPlanes,V),lr(E,H,V),C.updateMultisampleRenderTarget(tt),C.updateRenderTargetMipmap(tt),Wt.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let yt=0,Xt=F.length;yt<Xt;yt++){const Kt=F[yt],me=Kt.object,ue=Kt.geometry,qt=Kt.material,St=Kt.group;if(qt.side===mn&&me.layers.test(V.layers)){const Te=qt.side;qt.side=Oe,qt.needsUpdate=!0,ul(me,H,V,ue,qt,St),qt.side=Te,qt.needsUpdate=!0,Ct=!0}}Ct===!0&&(C.updateMultisampleRenderTarget(tt),C.updateRenderTargetMipmap(tt))}x.setRenderTarget(ht),x.setClearColor(O,W),Pt!==void 0&&(V.viewport=Pt),x.toneMapping=pt}function lr(E,F,H){const V=F.isScene===!0?F.overrideMaterial:null;for(let B=0,tt=E.length;B<tt;B++){const st=E[B],ht=st.object,pt=st.geometry,Pt=st.group;let Ct=st.material;Ct.allowOverride===!0&&V!==null&&(Ct=V),ht.layers.test(H.layers)&&ul(ht,F,H,pt,Ct,Pt)}}function ul(E,F,H,V,B,tt){E.onBeforeRender(x,F,H,V,B,tt),E.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),B.onBeforeRender(x,F,H,V,E,tt),B.transparent===!0&&B.side===mn&&B.forceSinglePass===!1?(B.side=Oe,B.needsUpdate=!0,x.renderBufferDirect(H,F,V,B,E,tt),B.side=xn,B.needsUpdate=!0,x.renderBufferDirect(H,F,V,B,E,tt),B.side=mn):x.renderBufferDirect(H,F,V,B,E,tt),E.onAfterRender(x,F,H,V,B,tt)}function hr(E,F,H){F.isScene!==!0&&(F=fe);const V=_t.get(E),B=p.state.lights,tt=p.state.shadowsArray,st=B.state.version,ht=gt.getParameters(E,B.state,tt,F,H),pt=gt.getProgramCacheKey(ht);let Pt=V.programs;V.environment=E.isMeshStandardMaterial?F.environment:null,V.fog=F.fog,V.envMap=(E.isMeshStandardMaterial?z:b).get(E.envMap||V.environment),V.envMapRotation=V.environment!==null&&E.envMap===null?F.environmentRotation:E.envMapRotation,Pt===void 0&&(E.addEventListener("dispose",Lt),Pt=new Map,V.programs=Pt);let Ct=Pt.get(pt);if(Ct!==void 0){if(V.currentProgram===Ct&&V.lightsStateVersion===st)return fl(E,ht),Ct}else ht.uniforms=gt.getUniforms(E),E.onBeforeCompile(ht,x),Ct=gt.acquireProgram(ht,pt),Pt.set(pt,Ct),V.uniforms=ht.uniforms;const yt=V.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(yt.clippingPlanes=Q.uniform),fl(E,ht),V.needsLights=ju(E),V.lightsStateVersion=st,V.needsLights&&(yt.ambientLightColor.value=B.state.ambient,yt.lightProbe.value=B.state.probe,yt.directionalLights.value=B.state.directional,yt.directionalLightShadows.value=B.state.directionalShadow,yt.spotLights.value=B.state.spot,yt.spotLightShadows.value=B.state.spotShadow,yt.rectAreaLights.value=B.state.rectArea,yt.ltc_1.value=B.state.rectAreaLTC1,yt.ltc_2.value=B.state.rectAreaLTC2,yt.pointLights.value=B.state.point,yt.pointLightShadows.value=B.state.pointShadow,yt.hemisphereLights.value=B.state.hemi,yt.directionalShadowMap.value=B.state.directionalShadowMap,yt.directionalShadowMatrix.value=B.state.directionalShadowMatrix,yt.spotShadowMap.value=B.state.spotShadowMap,yt.spotLightMatrix.value=B.state.spotLightMatrix,yt.spotLightMap.value=B.state.spotLightMap,yt.pointShadowMap.value=B.state.pointShadowMap,yt.pointShadowMatrix.value=B.state.pointShadowMatrix),V.currentProgram=Ct,V.uniformsList=null,Ct}function dl(E){if(E.uniformsList===null){const F=E.currentProgram.getUniforms();E.uniformsList=lo.seqWithValue(F.seq,E.uniforms)}return E.uniformsList}function fl(E,F){const H=_t.get(E);H.outputColorSpace=F.outputColorSpace,H.batching=F.batching,H.batchingColor=F.batchingColor,H.instancing=F.instancing,H.instancingColor=F.instancingColor,H.instancingMorph=F.instancingMorph,H.skinning=F.skinning,H.morphTargets=F.morphTargets,H.morphNormals=F.morphNormals,H.morphColors=F.morphColors,H.morphTargetsCount=F.morphTargetsCount,H.numClippingPlanes=F.numClippingPlanes,H.numIntersection=F.numClipIntersection,H.vertexAlphas=F.vertexAlphas,H.vertexTangents=F.vertexTangents,H.toneMapping=F.toneMapping}function qu(E,F,H,V,B){F.isScene!==!0&&(F=fe),C.resetTextureUnits();const tt=F.fog,st=V.isMeshStandardMaterial?F.environment:null,ht=I===null?x.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:De,pt=(V.isMeshStandardMaterial?z:b).get(V.envMap||st),Pt=V.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Ct=!!H.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),yt=!!H.morphAttributes.position,Xt=!!H.morphAttributes.normal,Kt=!!H.morphAttributes.color;let me=li;V.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(me=x.toneMapping);const ue=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,qt=ue!==void 0?ue.length:0,St=_t.get(V),Te=p.state.lights;if(et===!0&&(mt===!0||E!==M)){const Ue=E===M&&V.id===S;Q.setState(V,E,Ue)}let $t=!1;V.version===St.__version?(St.needsLights&&St.lightsStateVersion!==Te.state.version||St.outputColorSpace!==ht||B.isBatchedMesh&&St.batching===!1||!B.isBatchedMesh&&St.batching===!0||B.isBatchedMesh&&St.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&St.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&St.instancing===!1||!B.isInstancedMesh&&St.instancing===!0||B.isSkinnedMesh&&St.skinning===!1||!B.isSkinnedMesh&&St.skinning===!0||B.isInstancedMesh&&St.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&St.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&St.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&St.instancingMorph===!1&&B.morphTexture!==null||St.envMap!==pt||V.fog===!0&&St.fog!==tt||St.numClippingPlanes!==void 0&&(St.numClippingPlanes!==Q.numPlanes||St.numIntersection!==Q.numIntersection)||St.vertexAlphas!==Pt||St.vertexTangents!==Ct||St.morphTargets!==yt||St.morphNormals!==Xt||St.morphColors!==Kt||St.toneMapping!==me||St.morphTargetsCount!==qt)&&($t=!0):($t=!0,St.__version=V.version);let ln=St.currentProgram;$t===!0&&(ln=hr(V,F,B));let Ni=!1,Xe=!1,Ts=!1;const ae=ln.getUniforms(),Qe=St.uniforms;if(vt.useProgram(ln.program)&&(Ni=!0,Xe=!0,Ts=!0),V.id!==S&&(S=V.id,Xe=!0),Ni||M!==E){vt.buffers.depth.getReversed()?(rt.copy(E.projectionMatrix),hf(rt),uf(rt),ae.setValue(L,"projectionMatrix",rt)):ae.setValue(L,"projectionMatrix",E.projectionMatrix),ae.setValue(L,"viewMatrix",E.matrixWorldInverse);const He=ae.map.cameraPosition;He!==void 0&&He.setValue(L,Yt.setFromMatrixPosition(E.matrixWorld)),Vt.logarithmicDepthBuffer&&ae.setValue(L,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ae.setValue(L,"isOrthographic",E.isOrthographicCamera===!0),M!==E&&(M=E,Xe=!0,Ts=!0)}if(B.isSkinnedMesh){ae.setOptional(L,B,"bindMatrix"),ae.setOptional(L,B,"bindMatrixInverse");const Ue=B.skeleton;Ue&&(Ue.boneTexture===null&&Ue.computeBoneTexture(),ae.setValue(L,"boneTexture",Ue.boneTexture,C))}B.isBatchedMesh&&(ae.setOptional(L,B,"batchingTexture"),ae.setValue(L,"batchingTexture",B._matricesTexture,C),ae.setOptional(L,B,"batchingIdTexture"),ae.setValue(L,"batchingIdTexture",B._indirectTexture,C),ae.setOptional(L,B,"batchingColorTexture"),B._colorsTexture!==null&&ae.setValue(L,"batchingColorTexture",B._colorsTexture,C));const tn=H.morphAttributes;if((tn.position!==void 0||tn.normal!==void 0||tn.color!==void 0)&&It.update(B,H,ln),(Xe||St.receiveShadow!==B.receiveShadow)&&(St.receiveShadow=B.receiveShadow,ae.setValue(L,"receiveShadow",B.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Qe.envMap.value=pt,Qe.flipEnvMap.value=pt.isCubeTexture&&pt.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&F.environment!==null&&(Qe.envMapIntensity.value=F.environmentIntensity),Xe&&(ae.setValue(L,"toneMappingExposure",x.toneMappingExposure),St.needsLights&&Yu(Qe,Ts),tt&&V.fog===!0&&ot.refreshFogUniforms(Qe,tt),ot.refreshMaterialUniforms(Qe,V,X,j,p.state.transmissionRenderTarget[E.id]),lo.upload(L,dl(St),Qe,C)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(lo.upload(L,dl(St),Qe,C),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ae.setValue(L,"center",B.center),ae.setValue(L,"modelViewMatrix",B.modelViewMatrix),ae.setValue(L,"normalMatrix",B.normalMatrix),ae.setValue(L,"modelMatrix",B.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Ue=V.uniformsGroups;for(let He=0,Co=Ue.length;He<Co;He++){const pi=Ue[He];N.update(pi,ln),N.bind(pi,ln)}}return ln}function Yu(E,F){E.ambientLightColor.needsUpdate=F,E.lightProbe.needsUpdate=F,E.directionalLights.needsUpdate=F,E.directionalLightShadows.needsUpdate=F,E.pointLights.needsUpdate=F,E.pointLightShadows.needsUpdate=F,E.spotLights.needsUpdate=F,E.spotLightShadows.needsUpdate=F,E.rectAreaLights.needsUpdate=F,E.hemisphereLights.needsUpdate=F}function ju(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(E,F,H){const V=_t.get(E);V.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),_t.get(E.texture).__webglTexture=F,_t.get(E.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:H,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,F){const H=_t.get(E);H.__webglFramebuffer=F,H.__useDefaultFramebuffer=F===void 0};const Ku=L.createFramebuffer();this.setRenderTarget=function(E,F=0,H=0){I=E,w=F,A=H;let V=!0,B=null,tt=!1,st=!1;if(E){const pt=_t.get(E);if(pt.__useDefaultFramebuffer!==void 0)vt.bindFramebuffer(L.FRAMEBUFFER,null),V=!1;else if(pt.__webglFramebuffer===void 0)C.setupRenderTarget(E);else if(pt.__hasExternalTextures)C.rebindTextures(E,_t.get(E.texture).__webglTexture,_t.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const yt=E.depthTexture;if(pt.__boundDepthTexture!==yt){if(yt!==null&&_t.has(yt)&&(E.width!==yt.image.width||E.height!==yt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");C.setupDepthRenderbuffer(E)}}const Pt=E.texture;(Pt.isData3DTexture||Pt.isDataArrayTexture||Pt.isCompressedArrayTexture)&&(st=!0);const Ct=_t.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Ct[F])?B=Ct[F][H]:B=Ct[F],tt=!0):E.samples>0&&C.useMultisampledRTT(E)===!1?B=_t.get(E).__webglMultisampledFramebuffer:Array.isArray(Ct)?B=Ct[H]:B=Ct,P.copy(E.viewport),U.copy(E.scissor),D=E.scissorTest}else P.copy(xt).multiplyScalar(X).floor(),U.copy(Ot).multiplyScalar(X).floor(),D=ne;if(H!==0&&(B=Ku),vt.bindFramebuffer(L.FRAMEBUFFER,B)&&V&&vt.drawBuffers(E,B),vt.viewport(P),vt.scissor(U),vt.setScissorTest(D),tt){const pt=_t.get(E.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+F,pt.__webglTexture,H)}else if(st){const pt=_t.get(E.texture),Pt=F;L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,pt.__webglTexture,H,Pt)}else if(E!==null&&H!==0){const pt=_t.get(E.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,pt.__webglTexture,H)}S=-1},this.readRenderTargetPixels=function(E,F,H,V,B,tt,st){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ht=_t.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&st!==void 0&&(ht=ht[st]),ht){vt.bindFramebuffer(L.FRAMEBUFFER,ht);try{const pt=E.texture,Pt=pt.format,Ct=pt.type;if(!Vt.textureFormatReadable(Pt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Vt.textureTypeReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=E.width-V&&H>=0&&H<=E.height-B&&L.readPixels(F,H,V,B,Nt.convert(Pt),Nt.convert(Ct),tt)}finally{const pt=I!==null?_t.get(I).__webglFramebuffer:null;vt.bindFramebuffer(L.FRAMEBUFFER,pt)}}},this.readRenderTargetPixelsAsync=async function(E,F,H,V,B,tt,st){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ht=_t.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&st!==void 0&&(ht=ht[st]),ht)if(F>=0&&F<=E.width-V&&H>=0&&H<=E.height-B){vt.bindFramebuffer(L.FRAMEBUFFER,ht);const pt=E.texture,Pt=pt.format,Ct=pt.type;if(!Vt.textureFormatReadable(Pt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Vt.textureTypeReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const yt=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,yt),L.bufferData(L.PIXEL_PACK_BUFFER,tt.byteLength,L.STREAM_READ),L.readPixels(F,H,V,B,Nt.convert(Pt),Nt.convert(Ct),0);const Xt=I!==null?_t.get(I).__webglFramebuffer:null;vt.bindFramebuffer(L.FRAMEBUFFER,Xt);const Kt=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await lf(L,Kt,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,yt),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,tt),L.deleteBuffer(yt),L.deleteSync(Kt),tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,F=null,H=0){const V=Math.pow(2,-H),B=Math.floor(E.image.width*V),tt=Math.floor(E.image.height*V),st=F!==null?F.x:0,ht=F!==null?F.y:0;C.setTexture2D(E,0),L.copyTexSubImage2D(L.TEXTURE_2D,H,0,0,st,ht,B,tt),vt.unbindTexture()};const $u=L.createFramebuffer(),Zu=L.createFramebuffer();this.copyTextureToTexture=function(E,F,H=null,V=null,B=0,tt=null){tt===null&&(B!==0?(co("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),tt=B,B=0):tt=0);let st,ht,pt,Pt,Ct,yt,Xt,Kt,me;const ue=E.isCompressedTexture?E.mipmaps[tt]:E.image;if(H!==null)st=H.max.x-H.min.x,ht=H.max.y-H.min.y,pt=H.isBox3?H.max.z-H.min.z:1,Pt=H.min.x,Ct=H.min.y,yt=H.isBox3?H.min.z:0;else{const tn=Math.pow(2,-B);st=Math.floor(ue.width*tn),ht=Math.floor(ue.height*tn),E.isDataArrayTexture?pt=ue.depth:E.isData3DTexture?pt=Math.floor(ue.depth*tn):pt=1,Pt=0,Ct=0,yt=0}V!==null?(Xt=V.x,Kt=V.y,me=V.z):(Xt=0,Kt=0,me=0);const qt=Nt.convert(F.format),St=Nt.convert(F.type);let Te;F.isData3DTexture?(C.setTexture3D(F,0),Te=L.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(C.setTexture2DArray(F,0),Te=L.TEXTURE_2D_ARRAY):(C.setTexture2D(F,0),Te=L.TEXTURE_2D),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,F.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,F.unpackAlignment);const $t=L.getParameter(L.UNPACK_ROW_LENGTH),ln=L.getParameter(L.UNPACK_IMAGE_HEIGHT),Ni=L.getParameter(L.UNPACK_SKIP_PIXELS),Xe=L.getParameter(L.UNPACK_SKIP_ROWS),Ts=L.getParameter(L.UNPACK_SKIP_IMAGES);L.pixelStorei(L.UNPACK_ROW_LENGTH,ue.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ue.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Pt),L.pixelStorei(L.UNPACK_SKIP_ROWS,Ct),L.pixelStorei(L.UNPACK_SKIP_IMAGES,yt);const ae=E.isDataArrayTexture||E.isData3DTexture,Qe=F.isDataArrayTexture||F.isData3DTexture;if(E.isDepthTexture){const tn=_t.get(E),Ue=_t.get(F),He=_t.get(tn.__renderTarget),Co=_t.get(Ue.__renderTarget);vt.bindFramebuffer(L.READ_FRAMEBUFFER,He.__webglFramebuffer),vt.bindFramebuffer(L.DRAW_FRAMEBUFFER,Co.__webglFramebuffer);for(let pi=0;pi<pt;pi++)ae&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,_t.get(E).__webglTexture,B,yt+pi),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,_t.get(F).__webglTexture,tt,me+pi)),L.blitFramebuffer(Pt,Ct,st,ht,Xt,Kt,st,ht,L.DEPTH_BUFFER_BIT,L.NEAREST);vt.bindFramebuffer(L.READ_FRAMEBUFFER,null),vt.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(B!==0||E.isRenderTargetTexture||_t.has(E)){const tn=_t.get(E),Ue=_t.get(F);vt.bindFramebuffer(L.READ_FRAMEBUFFER,$u),vt.bindFramebuffer(L.DRAW_FRAMEBUFFER,Zu);for(let He=0;He<pt;He++)ae?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,tn.__webglTexture,B,yt+He):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,tn.__webglTexture,B),Qe?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Ue.__webglTexture,tt,me+He):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Ue.__webglTexture,tt),B!==0?L.blitFramebuffer(Pt,Ct,st,ht,Xt,Kt,st,ht,L.COLOR_BUFFER_BIT,L.NEAREST):Qe?L.copyTexSubImage3D(Te,tt,Xt,Kt,me+He,Pt,Ct,st,ht):L.copyTexSubImage2D(Te,tt,Xt,Kt,Pt,Ct,st,ht);vt.bindFramebuffer(L.READ_FRAMEBUFFER,null),vt.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else Qe?E.isDataTexture||E.isData3DTexture?L.texSubImage3D(Te,tt,Xt,Kt,me,st,ht,pt,qt,St,ue.data):F.isCompressedArrayTexture?L.compressedTexSubImage3D(Te,tt,Xt,Kt,me,st,ht,pt,qt,ue.data):L.texSubImage3D(Te,tt,Xt,Kt,me,st,ht,pt,qt,St,ue):E.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,tt,Xt,Kt,st,ht,qt,St,ue.data):E.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,tt,Xt,Kt,ue.width,ue.height,qt,ue.data):L.texSubImage2D(L.TEXTURE_2D,tt,Xt,Kt,st,ht,qt,St,ue);L.pixelStorei(L.UNPACK_ROW_LENGTH,$t),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ln),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Ni),L.pixelStorei(L.UNPACK_SKIP_ROWS,Xe),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Ts),tt===0&&F.generateMipmaps&&L.generateMipmap(Te),vt.unbindTexture()},this.copyTextureToTexture3D=function(E,F,H=null,V=null,B=0){return co('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(E,F,H,V,B)},this.initRenderTarget=function(E){_t.get(E).__webglFramebuffer===void 0&&C.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?C.setTextureCube(E,0):E.isData3DTexture?C.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?C.setTexture2DArray(E,0):C.setTexture2D(E,0),vt.unbindTexture()},this.resetState=function(){w=0,A=0,I=null,vt.reset(),ie.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return An}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=zt._getDrawingBufferColorSpace(t),e.unpackColorSpace=zt._getUnpackColorSpace()}}class yx{constructor(){k(this,"perspectiveCamera");k(this,"PITCH",Math.PI/3.2);k(this,"YAW",Math.PI/4);k(this,"distance",18);k(this,"MIN_DISTANCE",8);k(this,"MAX_DISTANCE",35);k(this,"SMOOTH",.12);k(this,"onWheel",t=>{this.distance+=t.deltaY*.02,this.distance=Math.max(this.MIN_DISTANCE,Math.min(this.MAX_DISTANCE,this.distance))});this.perspectiveCamera=new Be(50,window.innerWidth/window.innerHeight,.1,500),document.addEventListener("wheel",this.onWheel)}getIsometricDirection(t){const e=new R,n=new R(-1,0,-1).normalize(),i=new R(1,0,1).normalize(),s=new R(-1,0,1).normalize(),o=new R(1,0,-1).normalize();return t.has("w")&&e.add(n),t.has("s")&&e.add(i),t.has("a")&&e.add(s),t.has("d")&&e.add(o),e.length()>0&&e.normalize(),e}update(t){const e=new R(Math.cos(this.YAW)*Math.cos(this.PITCH),Math.sin(this.PITCH),Math.sin(this.YAW)*Math.cos(this.PITCH)).multiplyScalar(this.distance),n=t.position.clone().add(e);this.perspectiveCamera.position.lerp(n,this.SMOOTH);const i=t.position.clone().add(new R(0,1,0));this.perspectiveCamera.lookAt(i)}}class Mx{constructor(){k(this,"scene");this.scene=new Ff,this.scene.background=new Et(527122),this.scene.fog=new Wc(527122,.022),this.setupLighting()}setupLighting(){const t=new mp(1714762,2759178,.9);this.scene.add(t);const e=new Mp(857376,.6);this.scene.add(e)}}class Sx{constructor(t,e){k(this,"renderer");k(this,"camera");k(this,"mainScene");k(this,"onResize",()=>{this.camera.perspectiveCamera.aspect=window.innerWidth/window.innerHeight,this.camera.perspectiveCamera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)});this.camera=t,this.mainScene=e,this.renderer=new vx({antialias:!0}),this.renderer.setPixelRatio(devicePixelRatio),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Dc,document.body.prepend(this.renderer.domElement),window.addEventListener("resize",this.onResize)}update(){this.renderer.render(this.mainScene.scene,this.camera.perspectiveCamera)}}const Mc=.4,da=3.5,fa=5.5,bx=.25,Tx=-.5,Ex=.65,Dh=2.2,Ax=1.4,Uh=.38,pa=.55,Nh=8;class wx extends se{constructor(e){super();k(this,"loader");k(this,"mixer");k(this,"clips",{});k(this,"currentAction",null);k(this,"currentState","");k(this,"velocity",new R);k(this,"MAX_SPEED",3.5);k(this,"RUN_SPEED",6.5);k(this,"ACCELERATION",35);k(this,"FRICTION",28);k(this,"targetQuaternion",new Ze);k(this,"isAttacking",!1);k(this,"attackTimer",0);k(this,"attackDuration",0);k(this,"hitFired",!1);k(this,"onHitWindow");k(this,"isRolling",!1);k(this,"rollTimer",0);k(this,"rollDir",new R);k(this,"rollCooldown",0);k(this,"ROLL_COOLDOWN",1.2);k(this,"isHitStunned",!1);k(this,"hitStunTimer",0);k(this,"health",100);k(this,"maxHealth",100);k(this,"lifeState","alive");k(this,"deathTimer",0);k(this,"respawnTimer",0);k(this,"hitFlashTimer",0);k(this,"HIT_FLASH_DURATION",.15);k(this,"onRespawnComplete");this.loader=e;const n=new Jt(new bo(Mc,1,8,16),new wn({color:255,wireframe:!0,visible:!1}));n.position.y=.5,this.add(n),this.loader.gltfLoad.load("/models/glTF/character$animated.glb",i=>{const s=i.scene;s.scale.set(.7,.7,.7),s.traverse(a=>{a instanceof Jt&&a.geometry&&(a.geometry.computeBoundsTree(),a.material.wireframe=!1)}),this.add(s),this.mixer=new Lu(s),i.animations.forEach(a=>{this.clips[a.name]=a});const o=this.clips["CharacterArmature|Idle_Sword"]??this.clips["CharacterArmature|Idle"];o&&this.setState(o.name,1)})}get isAlive(){return this.lifeState==="alive"}applyMovement(e,n,i){if(this.lifeState!=="alive"||this.isRolling||this.isHitStunned)return;const s=n?this.RUN_SPEED:this.MAX_SPEED;if(e.length()>0){const o=e.clone().multiplyScalar(this.ACCELERATION*i);this.velocity.add(o),this.velocity.length()>s&&this.velocity.normalize().multiplyScalar(s);const a=Math.atan2(e.x,e.z);if(this.targetQuaternion.setFromAxisAngle(new R(0,1,0),a),!this.isAttacking){const c=this.velocity.length();if(n){const l=this.getDirectionalRunAnim(e);this.setStateWithSpeed(l,Math.max(.5,c/fa))}else this.setStateWithSpeed("CharacterArmature|Walk",Math.max(.3,c/da))}}else if(this.velocity.multiplyScalar(Math.max(0,1-this.FRICTION*i)),this.velocity.length()<.05){if(this.velocity.set(0,0,0),!this.isAttacking){const o=this.clips["CharacterArmature|Idle_Sword"]?"CharacterArmature|Idle_Sword":"CharacterArmature|Idle";this.setState(o,1)}}else if(!this.isAttacking){const o=this.velocity.length(),c=this.currentState.includes("Run")?fa:da;this.currentAction&&(this.currentAction.timeScale=Math.max(.2,o/c))}this.position.x+=this.velocity.x*i,this.position.z+=this.velocity.z*i}getDirectionalRunAnim(e){const n=new R(0,0,1).applyQuaternion(this.targetQuaternion),i=new R(-n.z,0,n.x),s=e.dot(n),o=e.dot(i);return s<Tx?this.clips["CharacterArmature|Run_Back"]?"CharacterArmature|Run_Back":"CharacterArmature|Run":Math.abs(o)>=Ex?o>0?this.clips["CharacterArmature|Run_Left"]?"CharacterArmature|Run_Left":"CharacterArmature|Run":this.clips["CharacterArmature|Run_Right"]?"CharacterArmature|Run_Right":"CharacterArmature|Run":"CharacterArmature|Run"}faceWorldPoint(e){if(this.lifeState!=="alive"||this.isRolling)return;const n=new R(e.x-this.position.x,0,e.z-this.position.z);n.length()<.01||(n.normalize(),this.targetQuaternion.setFromAxisAngle(new R(0,1,0),Math.atan2(n.x,n.z)))}attack(e,n){if(this.isAttacking||this.isRolling||this.isHitStunned||this.lifeState!=="alive")return!1;const i=this.clips["CharacterArmature|Sword_Slash"];if(!i)return!1;const s=.55,o=i.duration/s;this.isAttacking=!0,this.attackTimer=0,this.hitFired=!1,this.attackDuration=s;const a=this.mixer.clipAction(i);a.timeScale=o,a.setLoop(Ii,1),a.clampWhenFinished=!0,this.currentAction&&this.currentAction.fadeOut(.08),a.reset().fadeIn(.05).play(),this.currentAction=a,this.currentState="CharacterArmature|Sword_Slash";const c=new R(n.x-this.position.x,0,n.z-this.position.z).normalize(),l=2,h=Math.PI/2;return this.onHitWindow=()=>{const u=new Set;for(const d of e){if(d.userData.type!=="npc")continue;const f=d.userData.parentNpc;if(u.has(f)||!f.isAlive)continue;u.add(f);const g=new R(f.position.x-this.position.x,0,f.position.z-this.position.z);g.length()>l||(g.normalize(),c.dot(g)>=Math.cos(h)&&f.takeDamage(35,this.position))}},!0}roll(e){if(this.lifeState!=="alive"||this.isRolling||this.isAttacking||this.isHitStunned||this.rollCooldown>0||!this.clips["CharacterArmature|Roll"])return!1;this.rollDir=e.length()>.1?e.clone().normalize():new R(0,0,1).applyQuaternion(this.quaternion),this.isRolling=!0,this.rollTimer=0,this.rollCooldown=this.ROLL_COOLDOWN,this.velocity.copy(this.rollDir).multiplyScalar(Nh);const n=this.clips["CharacterArmature|Roll"],i=n.duration/pa,s=this.mixer.clipAction(n);return s.timeScale=i,s.setLoop(Ii,1),s.clampWhenFinished=!0,this.currentAction&&this.currentAction.fadeOut(.06),s.reset().fadeIn(.04).play(),this.currentAction=s,this.currentState="CharacterArmature|Roll",!0}takeDamage(e){if(this.lifeState!=="alive"||this.isRolling)return;if(this.health=Math.max(0,this.health-e),this.hitFlashTimer=this.HIT_FLASH_DURATION,this.health<=0){this.health=0,this.startDying();return}this.isAttacking=!1,this.isHitStunned=!0,this.hitStunTimer=0,this.velocity.multiplyScalar(.1);const n=this.clips["CharacterArmature|HitRecieve"]??this.clips["CharacterArmature|HitRecieve_2"];if(n&&this.mixer){const i=this.mixer.clipAction(n),s=n.duration/Uh;i.timeScale=s,i.setLoop(Ii,1),i.clampWhenFinished=!0,this.currentAction&&this.currentAction.fadeOut(.06),i.reset().fadeIn(.04).play(),this.currentAction=i,this.currentState=n.name}}startDying(){this.lifeState="dying",this.deathTimer=0,this.isAttacking=!1,this.isRolling=!1,this.isHitStunned=!1,this.velocity.set(0,0,0);const e=this.clips["CharacterArmature|Death"];if(e&&this.mixer){const n=this.mixer.clipAction(e);n.timeScale=e.duration/Dh,n.setLoop(Ii,1),n.clampWhenFinished=!0,this.currentAction&&this.currentAction.fadeOut(.1),n.reset().fadeIn(.1).play(),this.currentAction=n,this.currentState="CharacterArmature|Death"}}startRespawn(){this.lifeState="respawning",this.respawnTimer=0,this.health=this.maxHealth,this.isRolling=!1,this.isHitStunned=!1,this.rollCooldown=0,this.velocity.set(0,0,0),this.setModelOpacity(0);const e=this.clips["CharacterArmature|Idle_Sword"]?"CharacterArmature|Idle_Sword":"CharacterArmature|Idle";if(this.clips[e]&&this.mixer){const n=this.mixer.clipAction(this.clips[e]);n.timeScale=1,n.setLoop(Pi,1/0),this.currentAction&&this.currentAction.stop(),n.reset().play(),this.currentAction=n,this.currentState=e}}update(e){switch(this.mixer&&this.mixer.update(e),this.lifeState){case"alive":this.updateAlive(e);break;case"dying":this.updateDying(e);break;case"respawning":this.updateRespawning(e);break}}updateAlive(e){var i;const n=this.isRolling?20:12;if(this.quaternion.slerp(this.targetQuaternion,Math.min(1,e*n)),this.isRolling){this.rollTimer+=e;const s=this.rollTimer/pa,o=Nh*Math.pow(1-s,1.5);if(this.position.x+=this.rollDir.x*o*e,this.position.z+=this.rollDir.z*o*e,this.rollTimer>=pa){this.isRolling=!1,this.rollTimer=0,this.velocity.set(0,0,0);const a=this.clips["CharacterArmature|Idle_Sword"]?"CharacterArmature|Idle_Sword":"CharacterArmature|Idle";this.setState(a,1)}this.rollCooldown>0&&(this.rollCooldown=Math.max(0,this.rollCooldown-e));return}if(this.rollCooldown>0&&(this.rollCooldown=Math.max(0,this.rollCooldown-e)),this.isHitStunned){this.hitStunTimer+=e,this.hitStunTimer>=Uh&&(this.isHitStunned=!1,this.hitStunTimer=0,this.currentState="");return}if(this.isAttacking){this.attackTimer+=e;const s=this.attackDuration*bx;if(!this.hitFired&&this.attackTimer>=s&&(this.hitFired=!0,(i=this.onHitWindow)==null||i.call(this),this.onHitWindow=void 0),this.attackTimer>=this.attackDuration){this.isAttacking=!1,this.attackTimer=0,this.hitFired=!1;const o=this.velocity.length();if(o<.1){const a=this.clips["CharacterArmature|Idle_Sword"]?"CharacterArmature|Idle_Sword":"CharacterArmature|Idle";this.setState(a,1)}else o>this.MAX_SPEED*.85?this.setStateWithSpeed("CharacterArmature|Run",o/fa):this.setStateWithSpeed("CharacterArmature|Walk",o/da)}}if(this.hitFlashTimer>0){this.hitFlashTimer-=e;const s=Math.floor(this.hitFlashTimer/.04)%2===0;this.traverse(o=>{o instanceof Jt&&!o.material.wireframe&&(o.visible=s)})}else this.traverse(s=>{s instanceof Jt&&!s.material.wireframe&&(s.visible=!0)})}updateDying(e){this.deathTimer+=e,this.deathTimer>=Dh&&(this.lifeState="dead")}updateRespawning(e){var i;this.respawnTimer+=e;const n=Math.min(this.respawnTimer/Ax,1);this.setModelOpacity(this.easeOutCubic(n)),n>=1&&(this.lifeState="alive",this.setModelOpacity(1),(i=this.onRespawnComplete)==null||i.call(this))}setModelOpacity(e){this.traverse(n=>{n instanceof Jt&&!n.material.wireframe&&(n.visible=e>0,n.material&&(n.material.transparent=e<1,n.material.opacity=e,n.material.needsUpdate=!0))})}easeOutCubic(e){return 1-Math.pow(1-e,3)}setState(e,n){if(this.currentState===e||!this.clips[e])return;const i=this.clips[e],s=this.mixer.clipAction(i);s.timeScale=n,s.setLoop(Pi,1/0),this.currentAction&&this.currentAction.fadeOut(.15),s.reset().fadeIn(.15).play(),this.currentAction=s,this.currentState=e}setStateWithSpeed(e,n){if(!this.clips[e])return;if(this.currentState===e&&this.currentAction){this.currentAction.timeScale=Math.max(.1,n);return}const i=this.clips[e],s=this.mixer.clipAction(i);s.timeScale=Math.max(.1,n),s.setLoop(Pi,1/0),this.currentAction&&this.currentAction.fadeOut(.12),s.reset().fadeIn(.12).play(),this.currentAction=s,this.currentState=e}}const il=.8,Rx=.35,ma=.9,fn={IDLE:"DragonArmature|Dragon_Flying",CHASE:"DragonArmature|Dragon_Flying",ATTACK:"DragonArmature|Dragon_Attack",ATTACK2:"DragonArmature|Dragon_Attack2",HIT:"DragonArmature|Dragon_Hit",DEATH:"DragonArmature|Dragon_Death"};class Cx extends se{constructor(e){super();k(this,"loader");k(this,"mixer");k(this,"clips",{});k(this,"currentAction",null);k(this,"currentState","");k(this,"health",100);k(this,"maxHealth",100);k(this,"isAlive",!0);k(this,"DETECT_RANGE",18);k(this,"ATTACK_RANGE",2.4);k(this,"MOVE_SPEED",4);k(this,"ATTACK_RATE",2);k(this,"attackCooldown",0);k(this,"attackToggle",!1);k(this,"aiState","idle");k(this,"targetQuaternion",new Ze);k(this,"velocity",new R);k(this,"hitTimer",0);k(this,"HIT_DURATION",.4);k(this,"isAttacking",!1);k(this,"attackTimer",0);k(this,"attackDuration",ma);k(this,"hitFired",!1);k(this,"onHitWindow");k(this,"knockbackVel",new R);k(this,"KNOCKBACK_DECAY",8);k(this,"deathTimer",0);k(this,"DEATH_DURATION",3.5);k(this,"_pendingDamage",0);this.loader=e;const n=new Jt(new bo(il,1.2,8,16),new wn({color:16711680,wireframe:!0,visible:!1}));n.position.y=.6,this.add(n),this.loader.gltfLoad.load("/models/glTF/Dragon.glb",i=>{const s=i.scene;s.scale.set(.3,.3,.3),s.position.y=-.5,s.traverse(o=>{o instanceof Jt&&o.geometry&&(o.geometry.computeBoundsTree(),o.material.wireframe=!1,o.userData.type="npc",o.userData.parentNpc=this)}),this.add(s),this.mixer=new Lu(s),i.animations.forEach(o=>{this.clips[o.name]=o}),this.setState(fn.IDLE,1)})}takeDamage(e,n){if(this.isAlive)if(this.health=Math.max(0,this.health-e),this.health>0){if(this.setState(fn.HIT,1.2),this.hitTimer=this.HIT_DURATION,this.isAttacking=!1,this.hitFired=!1,this.attackTimer=0,n){const i=new R(this.position.x-n.x,0,this.position.z-n.z);i.lengthSq()>.001&&(i.normalize().multiplyScalar(3.5),this.knockbackVel.copy(i))}}else this.die()}die(){this.isAlive&&(this.isAlive=!1,this.aiState="dead",this.isAttacking=!1,this.velocity.set(0,0,0),this.knockbackVel.set(0,0,0),this.deathTimer=0,this.setState(fn.DEATH,1))}updateBehavior(e,n){var s;if(!this.isAlive)return 0;if(this.attackCooldown>0&&(this.attackCooldown=Math.max(0,this.attackCooldown-n)),this.hitTimer>0)return this.hitTimer-=n,this.hitTimer<=0&&(this.hitTimer=0,this.currentState=""),this.applyKnockback(n),0;if(this.isAttacking){this.attackTimer+=n;const o=this.attackDuration*Rx;return!this.hitFired&&this.attackTimer>=o&&(this.hitFired=!0,(s=this.onHitWindow)==null||s.call(this),this.onHitWindow=void 0),this.attackTimer>=this.attackDuration&&(this.isAttacking=!1,this.attackTimer=0,this.hitFired=!1,this.currentState=""),this.applyKnockback(n),this.quaternion.slerp(this.targetQuaternion,Math.min(1,n*8)),0}const i=this.position.distanceTo(e);if(i<=this.ATTACK_RANGE&&this.attackCooldown<=0){this.aiState="attack";const o=this.attackToggle?fn.ATTACK2:fn.ATTACK;this.attackToggle=!this.attackToggle;const a=this.clips[o];if(a){const c=a.duration/ma,l=this.mixer.clipAction(a);l.timeScale=c,l.setLoop(Ii,1),l.clampWhenFinished=!0,this.currentAction&&this.currentAction.fadeOut(.08),l.reset().fadeIn(.06).play(),this.currentAction=l,this.currentState=o,this.isAttacking=!0,this.attackTimer=0,this.hitFired=!1,this.attackDuration=ma,this.attackCooldown=this.ATTACK_RATE;const h=e.clone();this.onHitWindow=()=>{this.position.distanceTo(h)<=this.ATTACK_RANGE*1.4&&(this._pendingDamage=15)}}}else if(i<=this.DETECT_RANGE){this.aiState="chase";const o=Math.max(.6,this.MOVE_SPEED/4.5);this.setStateWithSpeed(fn.CHASE,o);const a=new R(e.x-this.position.x,0,e.z-this.position.z).normalize();this.velocity.lerp(a.clone().multiplyScalar(this.MOVE_SPEED),Math.min(1,n*6)),this.position.x+=this.velocity.x*n,this.position.z+=this.velocity.z*n,this.position.y+=Math.sin(Date.now()*.002)*.008,this.targetQuaternion.setFromAxisAngle(new R(0,1,0),Math.atan2(a.x,a.z))}else this.aiState="idle",this.setState(fn.IDLE,.8),this.velocity.multiplyScalar(.85),this.position.y+=Math.sin(Date.now()*.0015)*.006;return this.applyKnockback(n),this.quaternion.slerp(this.targetQuaternion,Math.min(1,n*8)),0}flushDamage(){const e=this._pendingDamage;return this._pendingDamage=0,e}updateDeath(e){return this.isAlive?!1:(this.deathTimer+=e,this.deathTimer>=this.DEATH_DURATION)}respawn(e){if(this.isAlive=!1,this.health=this.maxHealth,this.aiState="idle",this.isAttacking=!1,this.attackTimer=0,this.hitFired=!1,this.attackCooldown=0,this.hitTimer=0,this.deathTimer=0,this.velocity.set(0,0,0),this.knockbackVel.set(0,0,0),this._pendingDamage=0,this.position.copy(e),this.mixer&&this.clips[fn.IDLE]){const n=this.mixer.clipAction(this.clips[fn.IDLE]);this.currentAction&&this.currentAction.stop(),n.timeScale=1,n.setLoop(Pi,1/0),n.reset().play(),this.currentAction=n,this.currentState=fn.IDLE}else this.currentState="";this.traverse(n=>{n instanceof Jt&&(n.visible=!0)}),this.isAlive=!0}applyKnockback(e){if(this.knockbackVel.lengthSq()<.001){this.knockbackVel.set(0,0,0);return}this.position.x+=this.knockbackVel.x*e,this.position.z+=this.knockbackVel.z*e,this.knockbackVel.multiplyScalar(Math.max(0,1-this.KNOCKBACK_DECAY*e))}update(e){this.mixer&&this.mixer.update(e)}setState(e,n){if(this.currentState===e||!this.clips[e])return;const i=this.clips[e],s=this.mixer.clipAction(i);s.timeScale=n,e===fn.DEATH?(s.setLoop(Ii,1),s.clampWhenFinished=!0):s.setLoop(Pi,1/0),this.currentAction&&this.currentAction.fadeOut(.15),s.reset().fadeIn(.15).play(),this.currentAction=s,this.currentState=e}setStateWithSpeed(e,n){if(!this.clips[e])return;if(this.currentState===e&&this.currentAction){this.currentAction.timeScale=Math.max(.1,n);return}const i=this.clips[e],s=this.mixer.clipAction(i);s.timeScale=Math.max(.1,n),s.setLoop(Pi,1/0),this.currentAction&&this.currentAction.fadeOut(.12),s.reset().fadeIn(.12).play(),this.currentAction=s,this.currentState=e}}function Fh(r,t){if(t===Dd)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),r;if(t===pc||t===fu){let e=r.getIndex();if(e===null){const o=[],a=r.getAttribute("position");if(a!==void 0){for(let c=0;c<a.count;c++)o.push(c);r.setIndex(o),e=r.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),r}const n=e.count-2,i=[];if(t===pc)for(let o=1;o<=n;o++)i.push(e.getX(0)),i.push(e.getX(o)),i.push(e.getX(o+1));else for(let o=0;o<n;o++)o%2===0?(i.push(e.getX(o)),i.push(e.getX(o+1)),i.push(e.getX(o+2))):(i.push(e.getX(o+2)),i.push(e.getX(o+1)),i.push(e.getX(o)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const s=r.clone();return s.setIndex(i),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",t),r}const ga=new WeakMap;class Ix extends Ui{constructor(t){super(t),this.decoderPath="",this.decoderConfig={},this.decoderBinary=null,this.decoderPending=null,this.workerLimit=4,this.workerPool=[],this.workerNextTaskID=1,this.workerSourceURL="",this.defaultAttributeIDs={position:"POSITION",normal:"NORMAL",color:"COLOR",uv:"TEX_COORD"},this.defaultAttributeTypes={position:"Float32Array",normal:"Float32Array",color:"Float32Array",uv:"Float32Array"}}setDecoderPath(t){return this.decoderPath=t,this}setDecoderConfig(t){return this.decoderConfig=t,this}setWorkerLimit(t){return this.workerLimit=t,this}load(t,e,n,i){const s=new xo(this.manager);s.setPath(this.path),s.setResponseType("arraybuffer"),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(t,o=>{this.parse(o,e,i)},n,i)}parse(t,e,n=()=>{}){this.decodeDracoFile(t,e,null,null,_e,n).catch(n)}decodeDracoFile(t,e,n,i,s=De,o=()=>{}){const a={attributeIDs:n||this.defaultAttributeIDs,attributeTypes:i||this.defaultAttributeTypes,useUniqueIDs:!!n,vertexColorSpace:s};return this.decodeGeometry(t,a).then(e).catch(o)}decodeGeometry(t,e){const n=JSON.stringify(e);if(ga.has(t)){const c=ga.get(t);if(c.key===n)return c.promise;if(t.byteLength===0)throw new Error("THREE.DRACOLoader: Unable to re-decode a buffer with different settings. Buffer has already been transferred.")}let i;const s=this.workerNextTaskID++,o=t.byteLength,a=this._getWorker(s,o).then(c=>(i=c,new Promise((l,h)=>{i._callbacks[s]={resolve:l,reject:h},i.postMessage({type:"decode",id:s,taskConfig:e,buffer:t},[t])}))).then(c=>this._createGeometry(c.geometry));return a.catch(()=>!0).then(()=>{i&&s&&this._releaseTask(i,s)}),ga.set(t,{key:n,promise:a}),a}_createGeometry(t){const e=new be;t.index&&e.setIndex(new pe(t.index.array,1));for(let n=0;n<t.attributes.length;n++){const i=t.attributes[n],s=i.name,o=i.array,a=i.itemSize,c=new pe(o,a);s==="color"&&(this._assignVertexColorSpace(c,i.vertexColorSpace),c.normalized=!(o instanceof Float32Array)),e.setAttribute(s,c)}return e}_assignVertexColorSpace(t,e){if(e!==_e)return;const n=new Et;for(let i=0,s=t.count;i<s;i++)n.fromBufferAttribute(t,i),zt.toWorkingColorSpace(n,_e),t.setXYZ(i,n.r,n.g,n.b)}_loadLibrary(t,e){const n=new xo(this.manager);return n.setPath(this.decoderPath),n.setResponseType(e),n.setWithCredentials(this.withCredentials),new Promise((i,s)=>{n.load(t,i,void 0,s)})}preload(){return this._initDecoder(),this}_initDecoder(){if(this.decoderPending)return this.decoderPending;const t=typeof WebAssembly!="object"||this.decoderConfig.type==="js",e=[];return t?e.push(this._loadLibrary("draco_decoder.js","text")):(e.push(this._loadLibrary("draco_wasm_wrapper.js","text")),e.push(this._loadLibrary("draco_decoder.wasm","arraybuffer"))),this.decoderPending=Promise.all(e).then(n=>{const i=n[0];t||(this.decoderConfig.wasmBinary=n[1]);const s=Px.toString(),o=["/* draco decoder */",i,"","/* worker */",s.substring(s.indexOf("{")+1,s.lastIndexOf("}"))].join(`
`);this.workerSourceURL=URL.createObjectURL(new Blob([o]))}),this.decoderPending}_getWorker(t,e){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const i=new Worker(this.workerSourceURL);i._callbacks={},i._taskCosts={},i._taskLoad=0,i.postMessage({type:"init",decoderConfig:this.decoderConfig}),i.onmessage=function(s){const o=s.data;switch(o.type){case"decode":i._callbacks[o.id].resolve(o);break;case"error":i._callbacks[o.id].reject(o);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+o.type+'"')}},this.workerPool.push(i)}else this.workerPool.sort(function(i,s){return i._taskLoad>s._taskLoad?-1:1});const n=this.workerPool[this.workerPool.length-1];return n._taskCosts[t]=e,n._taskLoad+=e,n})}_releaseTask(t,e){t._taskLoad-=t._taskCosts[e],delete t._callbacks[e],delete t._taskCosts[e]}debug(){console.log("Task load: ",this.workerPool.map(t=>t._taskLoad))}dispose(){for(let t=0;t<this.workerPool.length;++t)this.workerPool[t].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function Px(){let r,t;onmessage=function(o){const a=o.data;switch(a.type){case"init":r=a.decoderConfig,t=new Promise(function(h){r.onModuleLoaded=function(u){h({draco:u})},DracoDecoderModule(r)});break;case"decode":const c=a.buffer,l=a.taskConfig;t.then(h=>{const u=h.draco,d=new u.Decoder;try{const f=e(u,d,new Int8Array(c),l),g=f.attributes.map(_=>_.array.buffer);f.index&&g.push(f.index.array.buffer),self.postMessage({type:"decode",id:a.id,geometry:f},g)}catch(f){console.error(f),self.postMessage({type:"error",id:a.id,error:f.message})}finally{u.destroy(d)}});break}};function e(o,a,c,l){const h=l.attributeIDs,u=l.attributeTypes;let d,f;const g=a.GetEncodedGeometryType(c);if(g===o.TRIANGULAR_MESH)d=new o.Mesh,f=a.DecodeArrayToMesh(c,c.byteLength,d);else if(g===o.POINT_CLOUD)d=new o.PointCloud,f=a.DecodeArrayToPointCloud(c,c.byteLength,d);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!f.ok()||d.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+f.error_msg());const _={index:null,attributes:[]};for(const m in h){const p=self[u[m]];let v,y;if(l.useUniqueIDs)y=h[m],v=a.GetAttributeByUniqueId(d,y);else{if(y=a.GetAttributeId(d,o[h[m]]),y===-1)continue;v=a.GetAttribute(d,y)}const x=i(o,a,d,m,p,v);m==="color"&&(x.vertexColorSpace=l.vertexColorSpace),_.attributes.push(x)}return g===o.TRIANGULAR_MESH&&(_.index=n(o,a,d)),o.destroy(d),_}function n(o,a,c){const h=c.num_faces()*3,u=h*4,d=o._malloc(u);a.GetTrianglesUInt32Array(c,u,d);const f=new Uint32Array(o.HEAPF32.buffer,d,h).slice();return o._free(d),{array:f,itemSize:1}}function i(o,a,c,l,h,u){const d=u.num_components(),g=c.num_points()*d,_=g*h.BYTES_PER_ELEMENT,m=s(o,h),p=o._malloc(_);a.GetAttributeDataArrayForAllPoints(c,u,m,_,p);const v=new h(o.HEAPF32.buffer,p,g).slice();return o._free(p),{name:l,array:v,itemSize:d}}function s(o,a){switch(a){case Float32Array:return o.DT_FLOAT32;case Int8Array:return o.DT_INT8;case Int16Array:return o.DT_INT16;case Int32Array:return o.DT_INT32;case Uint8Array:return o.DT_UINT8;case Uint16Array:return o.DT_UINT16;case Uint32Array:return o.DT_UINT32}}}class Lx extends Ui{constructor(t){super(t),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Bx(e)}),this.register(function(e){return new Ox(e)}),this.register(function(e){return new Yx(e)}),this.register(function(e){return new jx(e)}),this.register(function(e){return new Kx(e)}),this.register(function(e){return new zx(e)}),this.register(function(e){return new Hx(e)}),this.register(function(e){return new Vx(e)}),this.register(function(e){return new Gx(e)}),this.register(function(e){return new Fx(e)}),this.register(function(e){return new Wx(e)}),this.register(function(e){return new kx(e)}),this.register(function(e){return new qx(e)}),this.register(function(e){return new Xx(e)}),this.register(function(e){return new Ux(e)}),this.register(function(e){return new $x(e)}),this.register(function(e){return new Zx(e)})}load(t,e,n,i){const s=this;let o;if(this.resourcePath!=="")o=this.resourcePath;else if(this.path!==""){const l=js.extractUrlBase(t);o=js.resolveURL(l,this.path)}else o=js.extractUrlBase(t);this.manager.itemStart(t);const a=function(l){i?i(l):console.error(l),s.manager.itemError(t),s.manager.itemEnd(t)},c=new xo(this.manager);c.setPath(this.path),c.setResponseType("arraybuffer"),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(t,function(l){try{s.parse(l,o,function(h){e(h),s.manager.itemEnd(t)},a)}catch(h){a(h)}},n,a)}setDRACOLoader(t){return this.dracoLoader=t,this}setKTX2Loader(t){return this.ktx2Loader=t,this}setMeshoptDecoder(t){return this.meshoptDecoder=t,this}register(t){return this.pluginCallbacks.indexOf(t)===-1&&this.pluginCallbacks.push(t),this}unregister(t){return this.pluginCallbacks.indexOf(t)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(t),1),this}parse(t,e,n,i){let s;const o={},a={},c=new TextDecoder;if(typeof t=="string")s=JSON.parse(t);else if(t instanceof ArrayBuffer)if(c.decode(new Uint8Array(t,0,4))===Ou){try{o[kt.KHR_BINARY_GLTF]=new Jx(t)}catch(u){i&&i(u);return}s=JSON.parse(o[kt.KHR_BINARY_GLTF].content)}else s=JSON.parse(c.decode(t));else s=t;if(s.asset===void 0||s.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const l=new uv(s,{path:e||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});l.fileLoader.setRequestHeader(this.requestHeader);for(let h=0;h<this.pluginCallbacks.length;h++){const u=this.pluginCallbacks[h](l);u.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[u.name]=u,o[u.name]=!0}if(s.extensionsUsed)for(let h=0;h<s.extensionsUsed.length;++h){const u=s.extensionsUsed[h],d=s.extensionsRequired||[];switch(u){case kt.KHR_MATERIALS_UNLIT:o[u]=new Nx;break;case kt.KHR_DRACO_MESH_COMPRESSION:o[u]=new Qx(s,this.dracoLoader);break;case kt.KHR_TEXTURE_TRANSFORM:o[u]=new tv;break;case kt.KHR_MESH_QUANTIZATION:o[u]=new ev;break;default:d.indexOf(u)>=0&&a[u]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+u+'".')}}l.setExtensions(o),l.setPlugins(a),l.parse(n,i)}parseAsync(t,e){const n=this;return new Promise(function(i,s){n.parse(t,e,i,s)})}}function Dx(){let r={};return{get:function(t){return r[t]},add:function(t,e){r[t]=e},remove:function(t){delete r[t]},removeAll:function(){r={}}}}const kt={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class Ux{constructor(t){this.parser=t,this.name=kt.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const t=this.parser,e=this.parser.json.nodes||[];for(let n=0,i=e.length;n<i;n++){const s=e[n];s.extensions&&s.extensions[this.name]&&s.extensions[this.name].light!==void 0&&t._addNodeRef(this.cache,s.extensions[this.name].light)}}_loadLight(t){const e=this.parser,n="light:"+t;let i=e.cache.get(n);if(i)return i;const s=e.json,c=((s.extensions&&s.extensions[this.name]||{}).lights||[])[t];let l;const h=new Et(16777215);c.color!==void 0&&h.setRGB(c.color[0],c.color[1],c.color[2],De);const u=c.range!==void 0?c.range:0;switch(c.type){case"directional":l=new Pu(h),l.target.position.set(0,0,-1),l.add(l.target);break;case"point":l=new vp(h),l.distance=u;break;case"spot":l=new _p(h),l.distance=u,c.spot=c.spot||{},c.spot.innerConeAngle=c.spot.innerConeAngle!==void 0?c.spot.innerConeAngle:0,c.spot.outerConeAngle=c.spot.outerConeAngle!==void 0?c.spot.outerConeAngle:Math.PI/4,l.angle=c.spot.outerConeAngle,l.penumbra=1-c.spot.innerConeAngle/c.spot.outerConeAngle,l.target.position.set(0,0,-1),l.add(l.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+c.type)}return l.position.set(0,0,0),Vn(l,c),c.intensity!==void 0&&(l.intensity=c.intensity),l.name=e.createUniqueName(c.name||"light_"+t),i=Promise.resolve(l),e.cache.add(n,i),i}getDependency(t,e){if(t==="light")return this._loadLight(e)}createNodeAttachment(t){const e=this,n=this.parser,s=n.json.nodes[t],a=(s.extensions&&s.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(c){return n._getNodeRef(e.cache,a,c)})}}class Nx{constructor(){this.name=kt.KHR_MATERIALS_UNLIT}getMaterialType(){return wn}extendParams(t,e,n){const i=[];t.color=new Et(1,1,1),t.opacity=1;const s=e.pbrMetallicRoughness;if(s){if(Array.isArray(s.baseColorFactor)){const o=s.baseColorFactor;t.color.setRGB(o[0],o[1],o[2],De),t.opacity=o[3]}s.baseColorTexture!==void 0&&i.push(n.assignTexture(t,"map",s.baseColorTexture,_e))}return Promise.all(i)}}class Fx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(t,e){const i=this.parser.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name].emissiveStrength;return s!==void 0&&(e.emissiveIntensity=s),Promise.resolve()}}class Bx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_CLEARCOAT}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];if(o.clearcoatFactor!==void 0&&(e.clearcoat=o.clearcoatFactor),o.clearcoatTexture!==void 0&&s.push(n.assignTexture(e,"clearcoatMap",o.clearcoatTexture)),o.clearcoatRoughnessFactor!==void 0&&(e.clearcoatRoughness=o.clearcoatRoughnessFactor),o.clearcoatRoughnessTexture!==void 0&&s.push(n.assignTexture(e,"clearcoatRoughnessMap",o.clearcoatRoughnessTexture)),o.clearcoatNormalTexture!==void 0&&(s.push(n.assignTexture(e,"clearcoatNormalMap",o.clearcoatNormalTexture)),o.clearcoatNormalTexture.scale!==void 0)){const a=o.clearcoatNormalTexture.scale;e.clearcoatNormalScale=new Ut(a,a)}return Promise.all(s)}}class Ox{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_DISPERSION}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const i=this.parser.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name];return e.dispersion=s.dispersion!==void 0?s.dispersion:0,Promise.resolve()}}class kx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_IRIDESCENCE}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];return o.iridescenceFactor!==void 0&&(e.iridescence=o.iridescenceFactor),o.iridescenceTexture!==void 0&&s.push(n.assignTexture(e,"iridescenceMap",o.iridescenceTexture)),o.iridescenceIor!==void 0&&(e.iridescenceIOR=o.iridescenceIor),e.iridescenceThicknessRange===void 0&&(e.iridescenceThicknessRange=[100,400]),o.iridescenceThicknessMinimum!==void 0&&(e.iridescenceThicknessRange[0]=o.iridescenceThicknessMinimum),o.iridescenceThicknessMaximum!==void 0&&(e.iridescenceThicknessRange[1]=o.iridescenceThicknessMaximum),o.iridescenceThicknessTexture!==void 0&&s.push(n.assignTexture(e,"iridescenceThicknessMap",o.iridescenceThicknessTexture)),Promise.all(s)}}class zx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_SHEEN}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[];e.sheenColor=new Et(0,0,0),e.sheenRoughness=0,e.sheen=1;const o=i.extensions[this.name];if(o.sheenColorFactor!==void 0){const a=o.sheenColorFactor;e.sheenColor.setRGB(a[0],a[1],a[2],De)}return o.sheenRoughnessFactor!==void 0&&(e.sheenRoughness=o.sheenRoughnessFactor),o.sheenColorTexture!==void 0&&s.push(n.assignTexture(e,"sheenColorMap",o.sheenColorTexture,_e)),o.sheenRoughnessTexture!==void 0&&s.push(n.assignTexture(e,"sheenRoughnessMap",o.sheenRoughnessTexture)),Promise.all(s)}}class Hx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_TRANSMISSION}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];return o.transmissionFactor!==void 0&&(e.transmission=o.transmissionFactor),o.transmissionTexture!==void 0&&s.push(n.assignTexture(e,"transmissionMap",o.transmissionTexture)),Promise.all(s)}}class Vx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_VOLUME}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];e.thickness=o.thicknessFactor!==void 0?o.thicknessFactor:0,o.thicknessTexture!==void 0&&s.push(n.assignTexture(e,"thicknessMap",o.thicknessTexture)),e.attenuationDistance=o.attenuationDistance||1/0;const a=o.attenuationColor||[1,1,1];return e.attenuationColor=new Et().setRGB(a[0],a[1],a[2],De),Promise.all(s)}}class Gx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_IOR}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const i=this.parser.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name];return e.ior=s.ior!==void 0?s.ior:1.5,Promise.resolve()}}class Wx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_SPECULAR}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];e.specularIntensity=o.specularFactor!==void 0?o.specularFactor:1,o.specularTexture!==void 0&&s.push(n.assignTexture(e,"specularIntensityMap",o.specularTexture));const a=o.specularColorFactor||[1,1,1];return e.specularColor=new Et().setRGB(a[0],a[1],a[2],De),o.specularColorTexture!==void 0&&s.push(n.assignTexture(e,"specularColorMap",o.specularColorTexture,_e)),Promise.all(s)}}class Xx{constructor(t){this.parser=t,this.name=kt.EXT_MATERIALS_BUMP}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];return e.bumpScale=o.bumpFactor!==void 0?o.bumpFactor:1,o.bumpTexture!==void 0&&s.push(n.assignTexture(e,"bumpMap",o.bumpTexture)),Promise.all(s)}}class qx{constructor(t){this.parser=t,this.name=kt.KHR_MATERIALS_ANISOTROPY}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Pn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],o=i.extensions[this.name];return o.anisotropyStrength!==void 0&&(e.anisotropy=o.anisotropyStrength),o.anisotropyRotation!==void 0&&(e.anisotropyRotation=o.anisotropyRotation),o.anisotropyTexture!==void 0&&s.push(n.assignTexture(e,"anisotropyMap",o.anisotropyTexture)),Promise.all(s)}}class Yx{constructor(t){this.parser=t,this.name=kt.KHR_TEXTURE_BASISU}loadTexture(t){const e=this.parser,n=e.json,i=n.textures[t];if(!i.extensions||!i.extensions[this.name])return null;const s=i.extensions[this.name],o=e.options.ktx2Loader;if(!o){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return e.loadTextureImage(t,s.source,o)}}class jx{constructor(t){this.parser=t,this.name=kt.EXT_TEXTURE_WEBP}loadTexture(t){const e=this.name,n=this.parser,i=n.json,s=i.textures[t];if(!s.extensions||!s.extensions[e])return null;const o=s.extensions[e],a=i.images[o.source];let c=n.textureLoader;if(a.uri){const l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return n.loadTextureImage(t,o.source,c)}}class Kx{constructor(t){this.parser=t,this.name=kt.EXT_TEXTURE_AVIF}loadTexture(t){const e=this.name,n=this.parser,i=n.json,s=i.textures[t];if(!s.extensions||!s.extensions[e])return null;const o=s.extensions[e],a=i.images[o.source];let c=n.textureLoader;if(a.uri){const l=n.options.manager.getHandler(a.uri);l!==null&&(c=l)}return n.loadTextureImage(t,o.source,c)}}class $x{constructor(t){this.name=kt.EXT_MESHOPT_COMPRESSION,this.parser=t}loadBufferView(t){const e=this.parser.json,n=e.bufferViews[t];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],s=this.parser.getDependency("buffer",i.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(e.extensionsRequired&&e.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return s.then(function(a){const c=i.byteOffset||0,l=i.byteLength||0,h=i.count,u=i.byteStride,d=new Uint8Array(a,c,l);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(h,u,d,i.mode,i.filter).then(function(f){return f.buffer}):o.ready.then(function(){const f=new ArrayBuffer(h*u);return o.decodeGltfBuffer(new Uint8Array(f),h,u,d,i.mode,i.filter),f})})}else return null}}class Zx{constructor(t){this.name=kt.EXT_MESH_GPU_INSTANCING,this.parser=t}createNodeMesh(t){const e=this.parser.json,n=e.nodes[t];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=e.meshes[n.mesh];for(const l of i.primitives)if(l.mode!==nn.TRIANGLES&&l.mode!==nn.TRIANGLE_STRIP&&l.mode!==nn.TRIANGLE_FAN&&l.mode!==void 0)return null;const o=n.extensions[this.name].attributes,a=[],c={};for(const l in o)a.push(this.parser.getDependency("accessor",o[l]).then(h=>(c[l]=h,c[l])));return a.length<1?null:(a.push(this.parser.createNodeMesh(t)),Promise.all(a).then(l=>{const h=l.pop(),u=h.isGroup?h.children:[h],d=l[0].count,f=[];for(const g of u){const _=new Mt,m=new R,p=new Ze,v=new R(1,1,1),y=new Vf(g.geometry,g.material,d);for(let x=0;x<d;x++)c.TRANSLATION&&m.fromBufferAttribute(c.TRANSLATION,x),c.ROTATION&&p.fromBufferAttribute(c.ROTATION,x),c.SCALE&&v.fromBufferAttribute(c.SCALE,x),y.setMatrixAt(x,_.compose(m,p,v));for(const x in c)if(x==="_COLOR_0"){const T=c[x];y.instanceColor=new gc(T.array,T.itemSize,T.normalized)}else x!=="TRANSLATION"&&x!=="ROTATION"&&x!=="SCALE"&&g.geometry.setAttribute(x,c[x]);se.prototype.copy.call(y,g),this.parser.assignFinalMaterial(y),f.push(y)}return h.isGroup?(h.clear(),h.add(...f),h):f[0]}))}}const Ou="glTF",Us=12,Bh={JSON:1313821514,BIN:5130562};class Jx{constructor(t){this.name=kt.KHR_BINARY_GLTF,this.content=null,this.body=null;const e=new DataView(t,0,Us),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(t.slice(0,4))),version:e.getUint32(4,!0),length:e.getUint32(8,!0)},this.header.magic!==Ou)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-Us,s=new DataView(t,Us);let o=0;for(;o<i;){const a=s.getUint32(o,!0);o+=4;const c=s.getUint32(o,!0);if(o+=4,c===Bh.JSON){const l=new Uint8Array(t,Us+o,a);this.content=n.decode(l)}else if(c===Bh.BIN){const l=Us+o;this.body=t.slice(l,l+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class Qx{constructor(t,e){if(!e)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=kt.KHR_DRACO_MESH_COMPRESSION,this.json=t,this.dracoLoader=e,this.dracoLoader.preload()}decodePrimitive(t,e){const n=this.json,i=this.dracoLoader,s=t.extensions[this.name].bufferView,o=t.extensions[this.name].attributes,a={},c={},l={};for(const h in o){const u=Sc[h]||h.toLowerCase();a[u]=o[h]}for(const h in t.attributes){const u=Sc[h]||h.toLowerCase();if(o[h]!==void 0){const d=n.accessors[t.attributes[h]],f=ls[d.componentType];l[u]=f.name,c[u]=d.normalized===!0}}return e.getDependency("bufferView",s).then(function(h){return new Promise(function(u,d){i.decodeDracoFile(h,function(f){for(const g in f.attributes){const _=f.attributes[g],m=c[g];m!==void 0&&(_.normalized=m)}u(f)},a,l,De,d)})})}}class tv{constructor(){this.name=kt.KHR_TEXTURE_TRANSFORM}extendTexture(t,e){return(e.texCoord===void 0||e.texCoord===t.channel)&&e.offset===void 0&&e.rotation===void 0&&e.scale===void 0||(t=t.clone(),e.texCoord!==void 0&&(t.channel=e.texCoord),e.offset!==void 0&&t.offset.fromArray(e.offset),e.rotation!==void 0&&(t.rotation=e.rotation),e.scale!==void 0&&t.repeat.fromArray(e.scale),t.needsUpdate=!0),t}}class ev{constructor(){this.name=kt.KHR_MESH_QUANTIZATION}}class ku extends ar{constructor(t,e,n,i){super(t,e,n,i)}copySampleValue_(t){const e=this.resultBuffer,n=this.sampleValues,i=this.valueSize,s=t*i*3+i;for(let o=0;o!==i;o++)e[o]=n[s+o];return e}interpolate_(t,e,n,i){const s=this.resultBuffer,o=this.sampleValues,a=this.valueSize,c=a*2,l=a*3,h=i-e,u=(n-e)/h,d=u*u,f=d*u,g=t*l,_=g-l,m=-2*f+3*d,p=f-d,v=1-m,y=p-d+u;for(let x=0;x!==a;x++){const T=o[_+x+a],w=o[_+x+c]*h,A=o[g+x+a],I=o[g+x]*h;s[x]=v*T+y*w+m*A+p*I}return s}}const nv=new Ze;class iv extends ku{interpolate_(t,e,n,i){const s=super.interpolate_(t,e,n,i);return nv.fromArray(s).normalize().toArray(s),s}}const nn={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},ls={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Oh={9728:ke,9729:je,9984:ru,9985:no,9986:Vs,9987:Wn},kh={33071:si,33648:uo,10497:fs},_a={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Sc={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},ti={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},sv={CUBICSPLINE:void 0,LINEAR:nr,STEP:er},xa={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function rv(r){return r.DefaultMaterial===void 0&&(r.DefaultMaterial=new Zc({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:xn})),r.DefaultMaterial}function bi(r,t,e){for(const n in e.extensions)r[n]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[n]=e.extensions[n])}function Vn(r,t){t.extras!==void 0&&(typeof t.extras=="object"?Object.assign(r.userData,t.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+t.extras))}function ov(r,t,e){let n=!1,i=!1,s=!1;for(let l=0,h=t.length;l<h;l++){const u=t[l];if(u.POSITION!==void 0&&(n=!0),u.NORMAL!==void 0&&(i=!0),u.COLOR_0!==void 0&&(s=!0),n&&i&&s)break}if(!n&&!i&&!s)return Promise.resolve(r);const o=[],a=[],c=[];for(let l=0,h=t.length;l<h;l++){const u=t[l];if(n){const d=u.POSITION!==void 0?e.getDependency("accessor",u.POSITION):r.attributes.position;o.push(d)}if(i){const d=u.NORMAL!==void 0?e.getDependency("accessor",u.NORMAL):r.attributes.normal;a.push(d)}if(s){const d=u.COLOR_0!==void 0?e.getDependency("accessor",u.COLOR_0):r.attributes.color;c.push(d)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c)]).then(function(l){const h=l[0],u=l[1],d=l[2];return n&&(r.morphAttributes.position=h),i&&(r.morphAttributes.normal=u),s&&(r.morphAttributes.color=d),r.morphTargetsRelative=!0,r})}function av(r,t){if(r.updateMorphTargets(),t.weights!==void 0)for(let e=0,n=t.weights.length;e<n;e++)r.morphTargetInfluences[e]=t.weights[e];if(t.extras&&Array.isArray(t.extras.targetNames)){const e=t.extras.targetNames;if(r.morphTargetInfluences.length===e.length){r.morphTargetDictionary={};for(let n=0,i=e.length;n<i;n++)r.morphTargetDictionary[e[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function cv(r){let t;const e=r.extensions&&r.extensions[kt.KHR_DRACO_MESH_COMPRESSION];if(e?t="draco:"+e.bufferView+":"+e.indices+":"+va(e.attributes):t=r.indices+":"+va(r.attributes)+":"+r.mode,r.targets!==void 0)for(let n=0,i=r.targets.length;n<i;n++)t+=":"+va(r.targets[n]);return t}function va(r){let t="";const e=Object.keys(r).sort();for(let n=0,i=e.length;n<i;n++)t+=e[n]+":"+r[e[n]]+";";return t}function bc(r){switch(r){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function lv(r){return r.search(/\.jpe?g($|\?)/i)>0||r.search(/^data\:image\/jpeg/)===0?"image/jpeg":r.search(/\.webp($|\?)/i)>0||r.search(/^data\:image\/webp/)===0?"image/webp":r.search(/\.ktx2($|\?)/i)>0||r.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const hv=new Mt;class uv{constructor(t={},e={}){this.json=t,this.extensions={},this.plugins={},this.options=e,this.cache=new Dx,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=-1,s=!1,o=-1;if(typeof navigator<"u"){const a=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(a)===!0;const c=a.match(/Version\/(\d+)/);i=n&&c?parseInt(c[1],10):-1,s=a.indexOf("Firefox")>-1,o=s?a.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&i<17||s&&o<98?this.textureLoader=new pp(this.options.manager):this.textureLoader=new Sp(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new xo(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(t){this.extensions=t}setPlugins(t){this.plugins=t}parse(t,e){const n=this,i=this.json,s=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(o){const a={scene:o[0][i.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:i.asset,parser:n,userData:{}};return bi(s,a,i),Vn(a,i),Promise.all(n._invokeAll(function(c){return c.afterRoot&&c.afterRoot(a)})).then(function(){for(const c of a.scenes)c.updateMatrixWorld();t(a)})}).catch(e)}_markDefs(){const t=this.json.nodes||[],e=this.json.skins||[],n=this.json.meshes||[];for(let i=0,s=e.length;i<s;i++){const o=e[i].joints;for(let a=0,c=o.length;a<c;a++)t[o[a]].isBone=!0}for(let i=0,s=t.length;i<s;i++){const o=t[i];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(n[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(t,e){e!==void 0&&(t.refs[e]===void 0&&(t.refs[e]=t.uses[e]=0),t.refs[e]++)}_getNodeRef(t,e,n){if(t.refs[e]<=1)return n;const i=n.clone(),s=(o,a)=>{const c=this.associations.get(o);c!=null&&this.associations.set(a,c);for(const[l,h]of o.children.entries())s(h,a.children[l])};return s(n,i),i.name+="_instance_"+t.uses[e]++,i}_invokeOne(t){const e=Object.values(this.plugins);e.push(this);for(let n=0;n<e.length;n++){const i=t(e[n]);if(i)return i}return null}_invokeAll(t){const e=Object.values(this.plugins);e.unshift(this);const n=[];for(let i=0;i<e.length;i++){const s=t(e[i]);s&&n.push(s)}return n}getDependency(t,e){const n=t+":"+e;let i=this.cache.get(n);if(!i){switch(t){case"scene":i=this.loadScene(e);break;case"node":i=this._invokeOne(function(s){return s.loadNode&&s.loadNode(e)});break;case"mesh":i=this._invokeOne(function(s){return s.loadMesh&&s.loadMesh(e)});break;case"accessor":i=this.loadAccessor(e);break;case"bufferView":i=this._invokeOne(function(s){return s.loadBufferView&&s.loadBufferView(e)});break;case"buffer":i=this.loadBuffer(e);break;case"material":i=this._invokeOne(function(s){return s.loadMaterial&&s.loadMaterial(e)});break;case"texture":i=this._invokeOne(function(s){return s.loadTexture&&s.loadTexture(e)});break;case"skin":i=this.loadSkin(e);break;case"animation":i=this._invokeOne(function(s){return s.loadAnimation&&s.loadAnimation(e)});break;case"camera":i=this.loadCamera(e);break;default:if(i=this._invokeOne(function(s){return s!=this&&s.getDependency&&s.getDependency(t,e)}),!i)throw new Error("Unknown type: "+t);break}this.cache.add(n,i)}return i}getDependencies(t){let e=this.cache.get(t);if(!e){const n=this,i=this.json[t+(t==="mesh"?"es":"s")]||[];e=Promise.all(i.map(function(s,o){return n.getDependency(t,o)})),this.cache.add(t,e)}return e}loadBuffer(t){const e=this.json.buffers[t],n=this.fileLoader;if(e.type&&e.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+e.type+" buffer type is not supported.");if(e.uri===void 0&&t===0)return Promise.resolve(this.extensions[kt.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(s,o){n.load(js.resolveURL(e.uri,i.path),s,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+e.uri+'".'))})})}loadBufferView(t){const e=this.json.bufferViews[t];return this.getDependency("buffer",e.buffer).then(function(n){const i=e.byteLength||0,s=e.byteOffset||0;return n.slice(s,s+i)})}loadAccessor(t){const e=this,n=this.json,i=this.json.accessors[t];if(i.bufferView===void 0&&i.sparse===void 0){const o=_a[i.type],a=ls[i.componentType],c=i.normalized===!0,l=new a(i.count*o);return Promise.resolve(new pe(l,o,c))}const s=[];return i.bufferView!==void 0?s.push(this.getDependency("bufferView",i.bufferView)):s.push(null),i.sparse!==void 0&&(s.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),s.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(s).then(function(o){const a=o[0],c=_a[i.type],l=ls[i.componentType],h=l.BYTES_PER_ELEMENT,u=h*c,d=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0;let _,m;if(f&&f!==u){const p=Math.floor(d/f),v="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+p+":"+i.count;let y=e.cache.get(v);y||(_=new l(a,p*f,i.count*f/h),y=new Bf(_,f/h),e.cache.add(v,y)),m=new Xc(y,c,d%f/h,g)}else a===null?_=new l(i.count*c):_=new l(a,d,i.count*c),m=new pe(_,c,g);if(i.sparse!==void 0){const p=_a.SCALAR,v=ls[i.sparse.indices.componentType],y=i.sparse.indices.byteOffset||0,x=i.sparse.values.byteOffset||0,T=new v(o[1],y,i.sparse.count*p),w=new l(o[2],x,i.sparse.count*c);a!==null&&(m=new pe(m.array.slice(),m.itemSize,m.normalized)),m.normalized=!1;for(let A=0,I=T.length;A<I;A++){const S=T[A];if(m.setX(S,w[A*c]),c>=2&&m.setY(S,w[A*c+1]),c>=3&&m.setZ(S,w[A*c+2]),c>=4&&m.setW(S,w[A*c+3]),c>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}m.normalized=g}return m})}loadTexture(t){const e=this.json,n=this.options,s=e.textures[t].source,o=e.images[s];let a=this.textureLoader;if(o.uri){const c=n.manager.getHandler(o.uri);c!==null&&(a=c)}return this.loadTextureImage(t,s,a)}loadTextureImage(t,e,n){const i=this,s=this.json,o=s.textures[t],a=s.images[e],c=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[c])return this.textureCache[c];const l=this.loadImageSource(e,n).then(function(h){h.flipY=!1,h.name=o.name||a.name||"",h.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(h.name=a.uri);const d=(s.samplers||{})[o.sampler]||{};return h.magFilter=Oh[d.magFilter]||je,h.minFilter=Oh[d.minFilter]||Wn,h.wrapS=kh[d.wrapS]||fs,h.wrapT=kh[d.wrapT]||fs,h.generateMipmaps=!h.isCompressedTexture&&h.minFilter!==ke&&h.minFilter!==je,i.associations.set(h,{textures:t}),h}).catch(function(){return null});return this.textureCache[c]=l,l}loadImageSource(t,e){const n=this,i=this.json,s=this.options;if(this.sourceCache[t]!==void 0)return this.sourceCache[t].then(u=>u.clone());const o=i.images[t],a=self.URL||self.webkitURL;let c=o.uri||"",l=!1;if(o.bufferView!==void 0)c=n.getDependency("bufferView",o.bufferView).then(function(u){l=!0;const d=new Blob([u],{type:o.mimeType});return c=a.createObjectURL(d),c});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+t+" is missing URI and bufferView");const h=Promise.resolve(c).then(function(u){return new Promise(function(d,f){let g=d;e.isImageBitmapLoader===!0&&(g=function(_){const m=new Se(_);m.needsUpdate=!0,d(m)}),e.load(js.resolveURL(u,s.path),g,void 0,f)})}).then(function(u){return l===!0&&a.revokeObjectURL(c),Vn(u,o),u.userData.mimeType=o.mimeType||lv(o.uri),u}).catch(function(u){throw console.error("THREE.GLTFLoader: Couldn't load texture",c),u});return this.sourceCache[t]=h,h}assignTexture(t,e,n,i){const s=this;return this.getDependency("texture",n.index).then(function(o){if(!o)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(o=o.clone(),o.channel=n.texCoord),s.extensions[kt.KHR_TEXTURE_TRANSFORM]){const a=n.extensions!==void 0?n.extensions[kt.KHR_TEXTURE_TRANSFORM]:void 0;if(a){const c=s.associations.get(o);o=s.extensions[kt.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),s.associations.set(o,c)}}return i!==void 0&&(o.colorSpace=i),t[e]=o,o})}assignFinalMaterial(t){const e=t.geometry;let n=t.material;const i=e.attributes.tangent===void 0,s=e.attributes.color!==void 0,o=e.attributes.normal===void 0;if(t.isPoints){const a="PointsMaterial:"+n.uuid;let c=this.cache.get(a);c||(c=new Kc,Rn.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,c.sizeAttenuation=!1,this.cache.add(a,c)),n=c}else if(t.isLine){const a="LineBasicMaterial:"+n.uuid;let c=this.cache.get(a);c||(c=new Eu,Rn.prototype.copy.call(c,n),c.color.copy(n.color),c.map=n.map,this.cache.add(a,c)),n=c}if(i||s||o){let a="ClonedMaterial:"+n.uuid+":";i&&(a+="derivative-tangents:"),s&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let c=this.cache.get(a);c||(c=n.clone(),s&&(c.vertexColors=!0),o&&(c.flatShading=!0),i&&(c.normalScale&&(c.normalScale.y*=-1),c.clearcoatNormalScale&&(c.clearcoatNormalScale.y*=-1)),this.cache.add(a,c),this.associations.set(c,this.associations.get(n))),n=c}t.material=n}getMaterialType(){return Zc}loadMaterial(t){const e=this,n=this.json,i=this.extensions,s=n.materials[t];let o;const a={},c=s.extensions||{},l=[];if(c[kt.KHR_MATERIALS_UNLIT]){const u=i[kt.KHR_MATERIALS_UNLIT];o=u.getMaterialType(),l.push(u.extendParams(a,s,e))}else{const u=s.pbrMetallicRoughness||{};if(a.color=new Et(1,1,1),a.opacity=1,Array.isArray(u.baseColorFactor)){const d=u.baseColorFactor;a.color.setRGB(d[0],d[1],d[2],De),a.opacity=d[3]}u.baseColorTexture!==void 0&&l.push(e.assignTexture(a,"map",u.baseColorTexture,_e)),a.metalness=u.metallicFactor!==void 0?u.metallicFactor:1,a.roughness=u.roughnessFactor!==void 0?u.roughnessFactor:1,u.metallicRoughnessTexture!==void 0&&(l.push(e.assignTexture(a,"metalnessMap",u.metallicRoughnessTexture)),l.push(e.assignTexture(a,"roughnessMap",u.metallicRoughnessTexture))),o=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(t)}),l.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(t,a)})))}s.doubleSided===!0&&(a.side=mn);const h=s.alphaMode||xa.OPAQUE;if(h===xa.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,h===xa.MASK&&(a.alphaTest=s.alphaCutoff!==void 0?s.alphaCutoff:.5)),s.normalTexture!==void 0&&o!==wn&&(l.push(e.assignTexture(a,"normalMap",s.normalTexture)),a.normalScale=new Ut(1,1),s.normalTexture.scale!==void 0)){const u=s.normalTexture.scale;a.normalScale.set(u,u)}if(s.occlusionTexture!==void 0&&o!==wn&&(l.push(e.assignTexture(a,"aoMap",s.occlusionTexture)),s.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=s.occlusionTexture.strength)),s.emissiveFactor!==void 0&&o!==wn){const u=s.emissiveFactor;a.emissive=new Et().setRGB(u[0],u[1],u[2],De)}return s.emissiveTexture!==void 0&&o!==wn&&l.push(e.assignTexture(a,"emissiveMap",s.emissiveTexture,_e)),Promise.all(l).then(function(){const u=new o(a);return s.name&&(u.name=s.name),Vn(u,s),e.associations.set(u,{materials:t}),s.extensions&&bi(i,u,s),u})}createUniqueName(t){const e=Zt.sanitizeNodeName(t||"");return e in this.nodeNamesUsed?e+"_"+ ++this.nodeNamesUsed[e]:(this.nodeNamesUsed[e]=0,e)}loadGeometries(t){const e=this,n=this.extensions,i=this.primitiveCache;function s(a){return n[kt.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,e).then(function(c){return zh(c,a,e)})}const o=[];for(let a=0,c=t.length;a<c;a++){const l=t[a],h=cv(l),u=i[h];if(u)o.push(u.promise);else{let d;l.extensions&&l.extensions[kt.KHR_DRACO_MESH_COMPRESSION]?d=s(l):d=zh(new be,l,e),i[h]={primitive:l,promise:d},o.push(d)}}return Promise.all(o)}loadMesh(t){const e=this,n=this.json,i=this.extensions,s=n.meshes[t],o=s.primitives,a=[];for(let c=0,l=o.length;c<l;c++){const h=o[c].material===void 0?rv(this.cache):this.getDependency("material",o[c].material);a.push(h)}return a.push(e.loadGeometries(o)),Promise.all(a).then(function(c){const l=c.slice(0,c.length-1),h=c[c.length-1],u=[];for(let f=0,g=h.length;f<g;f++){const _=h[f],m=o[f];let p;const v=l[f];if(m.mode===nn.TRIANGLES||m.mode===nn.TRIANGLE_STRIP||m.mode===nn.TRIANGLE_FAN||m.mode===void 0)p=s.isSkinnedMesh===!0?new kf(_,v):new Jt(_,v),p.isSkinnedMesh===!0&&p.normalizeSkinWeights(),m.mode===nn.TRIANGLE_STRIP?p.geometry=Fh(p.geometry,fu):m.mode===nn.TRIANGLE_FAN&&(p.geometry=Fh(p.geometry,pc));else if(m.mode===nn.LINES)p=new Qf(_,v);else if(m.mode===nn.LINE_STRIP)p=new jc(_,v);else if(m.mode===nn.LINE_LOOP)p=new tp(_,v);else if(m.mode===nn.POINTS)p=new Au(_,v);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&av(p,s),p.name=e.createUniqueName(s.name||"mesh_"+t),Vn(p,s),m.extensions&&bi(i,p,m),e.assignFinalMaterial(p),u.push(p)}for(let f=0,g=u.length;f<g;f++)e.associations.set(u[f],{meshes:t,primitives:f});if(u.length===1)return s.extensions&&bi(i,u[0],s),u[0];const d=new ri;s.extensions&&bi(i,d,s),e.associations.set(d,{meshes:t});for(let f=0,g=u.length;f<g;f++)d.add(u[f]);return d})}loadCamera(t){let e;const n=this.json.cameras[t],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?e=new Be(af.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(e=new Qc(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(e.name=this.createUniqueName(n.name)),Vn(e,n),Promise.resolve(e)}loadSkin(t){const e=this.json.skins[t],n=[];for(let i=0,s=e.joints.length;i<s;i++)n.push(this._loadNodeShallow(e.joints[i]));return e.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",e.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const s=i.pop(),o=i,a=[],c=[];for(let l=0,h=o.length;l<h;l++){const u=o[l];if(u){a.push(u);const d=new Mt;s!==null&&d.fromArray(s.array,l*16),c.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',e.joints[l])}return new qc(a,c)})}loadAnimation(t){const e=this.json,n=this,i=e.animations[t],s=i.name?i.name:"animation_"+t,o=[],a=[],c=[],l=[],h=[];for(let u=0,d=i.channels.length;u<d;u++){const f=i.channels[u],g=i.samplers[f.sampler],_=f.target,m=_.node,p=i.parameters!==void 0?i.parameters[g.input]:g.input,v=i.parameters!==void 0?i.parameters[g.output]:g.output;_.node!==void 0&&(o.push(this.getDependency("node",m)),a.push(this.getDependency("accessor",p)),c.push(this.getDependency("accessor",v)),l.push(g),h.push(_))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(c),Promise.all(l),Promise.all(h)]).then(function(u){const d=u[0],f=u[1],g=u[2],_=u[3],m=u[4],p=[];for(let v=0,y=d.length;v<y;v++){const x=d[v],T=f[v],w=g[v],A=_[v],I=m[v];if(x===void 0)continue;x.updateMatrix&&x.updateMatrix();const S=n._createAnimationTracks(x,T,w,A,I);if(S)for(let M=0;M<S.length;M++)p.push(S[M])}return new xc(s,void 0,p)})}createNodeMesh(t){const e=this.json,n=this,i=e.nodes[t];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(s){const o=n._getNodeRef(n.meshCache,i.mesh,s);return i.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let c=0,l=i.weights.length;c<l;c++)a.morphTargetInfluences[c]=i.weights[c]}),o})}loadNode(t){const e=this.json,n=this,i=e.nodes[t],s=n._loadNodeShallow(t),o=[],a=i.children||[];for(let l=0,h=a.length;l<h;l++)o.push(n.getDependency("node",a[l]));const c=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([s,Promise.all(o),c]).then(function(l){const h=l[0],u=l[1],d=l[2];d!==null&&h.traverse(function(f){f.isSkinnedMesh&&f.bind(d,hv)});for(let f=0,g=u.length;f<g;f++)h.add(u[f]);return h})}_loadNodeShallow(t){const e=this.json,n=this.extensions,i=this;if(this.nodeCache[t]!==void 0)return this.nodeCache[t];const s=e.nodes[t],o=s.name?i.createUniqueName(s.name):"",a=[],c=i._invokeOne(function(l){return l.createNodeMesh&&l.createNodeMesh(t)});return c&&a.push(c),s.camera!==void 0&&a.push(i.getDependency("camera",s.camera).then(function(l){return i._getNodeRef(i.cameraCache,s.camera,l)})),i._invokeAll(function(l){return l.createNodeAttachment&&l.createNodeAttachment(t)}).forEach(function(l){a.push(l)}),this.nodeCache[t]=Promise.all(a).then(function(l){let h;if(s.isBone===!0?h=new Tu:l.length>1?h=new ri:l.length===1?h=l[0]:h=new se,h!==l[0])for(let u=0,d=l.length;u<d;u++)h.add(l[u]);if(s.name&&(h.userData.name=s.name,h.name=o),Vn(h,s),s.extensions&&bi(n,h,s),s.matrix!==void 0){const u=new Mt;u.fromArray(s.matrix),h.applyMatrix4(u)}else s.translation!==void 0&&h.position.fromArray(s.translation),s.rotation!==void 0&&h.quaternion.fromArray(s.rotation),s.scale!==void 0&&h.scale.fromArray(s.scale);return i.associations.has(h)||i.associations.set(h,{}),i.associations.get(h).nodes=t,h}),this.nodeCache[t]}loadScene(t){const e=this.extensions,n=this.json.scenes[t],i=this,s=new ri;n.name&&(s.name=i.createUniqueName(n.name)),Vn(s,n),n.extensions&&bi(e,s,n);const o=n.nodes||[],a=[];for(let c=0,l=o.length;c<l;c++)a.push(i.getDependency("node",o[c]));return Promise.all(a).then(function(c){for(let h=0,u=c.length;h<u;h++)s.add(c[h]);const l=h=>{const u=new Map;for(const[d,f]of i.associations)(d instanceof Rn||d instanceof Se)&&u.set(d,f);return h.traverse(d=>{const f=i.associations.get(d);f!=null&&u.set(d,f)}),u};return i.associations=l(s),s})}_createAnimationTracks(t,e,n,i,s){const o=[],a=t.name?t.name:t.uuid,c=[];ti[s.path]===ti.weights?t.traverse(function(d){d.morphTargetInfluences&&c.push(d.name?d.name:d.uuid)}):c.push(a);let l;switch(ti[s.path]){case ti.weights:l=gs;break;case ti.rotation:l=_s;break;case ti.translation:case ti.scale:l=xs;break;default:switch(n.itemSize){case 1:l=gs;break;case 2:case 3:default:l=xs;break}break}const h=i.interpolation!==void 0?sv[i.interpolation]:nr,u=this._getArrayFromAccessor(n);for(let d=0,f=c.length;d<f;d++){const g=new l(c[d]+"."+ti[s.path],e.array,u,h);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),o.push(g)}return o}_getArrayFromAccessor(t){let e=t.array;if(t.normalized){const n=bc(e.constructor),i=new Float32Array(e.length);for(let s=0,o=e.length;s<o;s++)i[s]=e[s]*n;e=i}return e}_createCubicSplineTrackInterpolant(t){t.createInterpolant=function(n){const i=this instanceof _s?iv:ku;return new i(this.times,this.values,this.getValueSize()/3,n)},t.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function dv(r,t,e){const n=t.attributes,i=new le;if(n.POSITION!==void 0){const a=e.json.accessors[n.POSITION],c=a.min,l=a.max;if(c!==void 0&&l!==void 0){if(i.set(new R(c[0],c[1],c[2]),new R(l[0],l[1],l[2])),a.normalized){const h=bc(ls[a.componentType]);i.min.multiplyScalar(h),i.max.multiplyScalar(h)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const s=t.targets;if(s!==void 0){const a=new R,c=new R;for(let l=0,h=s.length;l<h;l++){const u=s[l];if(u.POSITION!==void 0){const d=e.json.accessors[u.POSITION],f=d.min,g=d.max;if(f!==void 0&&g!==void 0){if(c.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),c.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),c.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),d.normalized){const _=bc(ls[d.componentType]);c.multiplyScalar(_)}a.max(c)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(a)}r.boundingBox=i;const o=new Pe;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,r.boundingSphere=o}function zh(r,t,e){const n=t.attributes,i=[];function s(o,a){return e.getDependency("accessor",o).then(function(c){r.setAttribute(a,c)})}for(const o in n){const a=Sc[o]||o.toLowerCase();a in r.attributes||i.push(s(n[o],a))}if(t.indices!==void 0&&!r.index){const o=e.getDependency("accessor",t.indices).then(function(a){r.setIndex(a)});i.push(o)}return zt.workingColorSpace!==De&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${zt.workingColorSpace}" not supported.`),Vn(r,t),dv(r,t,e),Promise.all(i).then(function(){return t.targets!==void 0?ov(r,t.targets,e):r})}class fv{constructor(){k(this,"dracoLoader");k(this,"gltfLoad");this.dracoLoader=new Ix,this.dracoLoader.setDecoderPath("/draco"),this.gltfLoad=new Lx,this.gltfLoad.setDRACOLoader(this.dracoLoader)}}const zu=0,pv=1,mv=2,Hh=2,ya=1.25,Vh=1,Ks=6*4+4+4,Ao=65535,gv=Math.pow(2,-24),Ma=Symbol("SKIP_GENERATION");function _v(r){return r.index?r.index.count:r.attributes.position.count}function bs(r){return _v(r)/3}function xv(r,t=ArrayBuffer){return r>65535?new Uint32Array(new t(4*r)):new Uint16Array(new t(2*r))}function vv(r,t){if(!r.index){const e=r.attributes.position.count,n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,i=xv(e,n);r.setIndex(new pe(i,1));for(let s=0;s<e;s++)i[s]=s}}function Hu(r,t){const e=bs(r),n=t||r.drawRange,i=n.start/3,s=(n.start+n.count)/3,o=Math.max(0,i),a=Math.min(e,s)-o;return[{offset:Math.floor(o),count:Math.floor(a)}]}function Vu(r,t){if(!r.groups||!r.groups.length)return Hu(r,t);const e=[],n=new Set,i=t||r.drawRange,s=i.start/3,o=(i.start+i.count)/3;for(const c of r.groups){const l=c.start/3,h=(c.start+c.count)/3;n.add(Math.max(s,l)),n.add(Math.min(o,h))}const a=Array.from(n.values()).sort((c,l)=>c-l);for(let c=0;c<a.length-1;c++){const l=a[c],h=a[c+1];e.push({offset:Math.floor(l),count:Math.floor(h-l)})}return e}function yv(r,t){const e=bs(r),n=Vu(r,t).sort((o,a)=>o.offset-a.offset),i=n[n.length-1];i.count=Math.min(e-i.offset,i.count);let s=0;return n.forEach(({count:o})=>s+=o),e!==s}function Sa(r,t,e,n,i){let s=1/0,o=1/0,a=1/0,c=-1/0,l=-1/0,h=-1/0,u=1/0,d=1/0,f=1/0,g=-1/0,_=-1/0,m=-1/0;for(let p=t*6,v=(t+e)*6;p<v;p+=6){const y=r[p+0],x=r[p+1],T=y-x,w=y+x;T<s&&(s=T),w>c&&(c=w),y<u&&(u=y),y>g&&(g=y);const A=r[p+2],I=r[p+3],S=A-I,M=A+I;S<o&&(o=S),M>l&&(l=M),A<d&&(d=A),A>_&&(_=A);const P=r[p+4],U=r[p+5],D=P-U,O=P+U;D<a&&(a=D),O>h&&(h=O),P<f&&(f=P),P>m&&(m=P)}n[0]=s,n[1]=o,n[2]=a,n[3]=c,n[4]=l,n[5]=h,i[0]=u,i[1]=d,i[2]=f,i[3]=g,i[4]=_,i[5]=m}function Mv(r,t=null,e=null,n=null){const i=r.attributes.position,s=r.index?r.index.array:null,o=bs(r),a=i.normalized;let c;t===null?(c=new Float32Array(o*6),e=0,n=o):(c=t,e=e||0,n=n||o);const l=i.array,h=i.offset||0;let u=3;i.isInterleavedBufferAttribute&&(u=i.data.stride);const d=["getX","getY","getZ"];for(let f=e;f<e+n;f++){const g=f*3,_=f*6;let m=g+0,p=g+1,v=g+2;s&&(m=s[m],p=s[p],v=s[v]),a||(m=m*u+h,p=p*u+h,v=v*u+h);for(let y=0;y<3;y++){let x,T,w;a?(x=i[d[y]](m),T=i[d[y]](p),w=i[d[y]](v)):(x=l[m+y],T=l[p+y],w=l[v+y]);let A=x;T<A&&(A=T),w<A&&(A=w);let I=x;T>I&&(I=T),w>I&&(I=w);const S=(I-A)/2,M=y*2;c[_+M+0]=A+S,c[_+M+1]=S+(Math.abs(A)+S)*gv}}return c}function de(r,t,e){return e.min.x=t[r],e.min.y=t[r+1],e.min.z=t[r+2],e.max.x=t[r+3],e.max.y=t[r+4],e.max.z=t[r+5],e}function Gh(r){let t=-1,e=-1/0;for(let n=0;n<3;n++){const i=r[n+3]-r[n];i>e&&(e=i,t=n)}return t}function Wh(r,t){t.set(r)}function Xh(r,t,e){let n,i;for(let s=0;s<3;s++){const o=s+3;n=r[s],i=t[s],e[s]=n<i?n:i,n=r[o],i=t[o],e[o]=n>i?n:i}}function Hr(r,t,e){for(let n=0;n<3;n++){const i=t[r+2*n],s=t[r+2*n+1],o=i-s,a=i+s;o<e[n]&&(e[n]=o),a>e[n+3]&&(e[n+3]=a)}}function Ns(r){const t=r[3]-r[0],e=r[4]-r[1],n=r[5]-r[2];return 2*(t*e+e*n+n*t)}const zn=32,Sv=(r,t)=>r.candidate-t.candidate,ei=new Array(zn).fill().map(()=>({count:0,bounds:new Float32Array(6),rightCacheBounds:new Float32Array(6),leftCacheBounds:new Float32Array(6),candidate:0})),Vr=new Float32Array(6);function bv(r,t,e,n,i,s){let o=-1,a=0;if(s===zu)o=Gh(t),o!==-1&&(a=(t[o]+t[o+3])/2);else if(s===pv)o=Gh(r),o!==-1&&(a=Tv(e,n,i,o));else if(s===mv){const c=Ns(r);let l=ya*i;const h=n*6,u=(n+i)*6;for(let d=0;d<3;d++){const f=t[d],m=(t[d+3]-f)/zn;if(i<zn/4){const p=[...ei];p.length=i;let v=0;for(let x=h;x<u;x+=6,v++){const T=p[v];T.candidate=e[x+2*d],T.count=0;const{bounds:w,leftCacheBounds:A,rightCacheBounds:I}=T;for(let S=0;S<3;S++)I[S]=1/0,I[S+3]=-1/0,A[S]=1/0,A[S+3]=-1/0,w[S]=1/0,w[S+3]=-1/0;Hr(x,e,w)}p.sort(Sv);let y=i;for(let x=0;x<y;x++){const T=p[x];for(;x+1<y&&p[x+1].candidate===T.candidate;)p.splice(x+1,1),y--}for(let x=h;x<u;x+=6){const T=e[x+2*d];for(let w=0;w<y;w++){const A=p[w];T>=A.candidate?Hr(x,e,A.rightCacheBounds):(Hr(x,e,A.leftCacheBounds),A.count++)}}for(let x=0;x<y;x++){const T=p[x],w=T.count,A=i-T.count,I=T.leftCacheBounds,S=T.rightCacheBounds;let M=0;w!==0&&(M=Ns(I)/c);let P=0;A!==0&&(P=Ns(S)/c);const U=Vh+ya*(M*w+P*A);U<l&&(o=d,l=U,a=T.candidate)}}else{for(let y=0;y<zn;y++){const x=ei[y];x.count=0,x.candidate=f+m+y*m;const T=x.bounds;for(let w=0;w<3;w++)T[w]=1/0,T[w+3]=-1/0}for(let y=h;y<u;y+=6){let w=~~((e[y+2*d]-f)/m);w>=zn&&(w=zn-1);const A=ei[w];A.count++,Hr(y,e,A.bounds)}const p=ei[zn-1];Wh(p.bounds,p.rightCacheBounds);for(let y=zn-2;y>=0;y--){const x=ei[y],T=ei[y+1];Xh(x.bounds,T.rightCacheBounds,x.rightCacheBounds)}let v=0;for(let y=0;y<zn-1;y++){const x=ei[y],T=x.count,w=x.bounds,I=ei[y+1].rightCacheBounds;T!==0&&(v===0?Wh(w,Vr):Xh(w,Vr,Vr)),v+=T;let S=0,M=0;v!==0&&(S=Ns(Vr)/c);const P=i-v;P!==0&&(M=Ns(I)/c);const U=Vh+ya*(S*v+M*P);U<l&&(o=d,l=U,a=x.candidate)}}}}else console.warn(`MeshBVH: Invalid build strategy value ${s} used.`);return{axis:o,pos:a}}function Tv(r,t,e,n){let i=0;for(let s=t,o=t+e;s<o;s++)i+=r[s*6+n*2];return i/e}class ba{constructor(){this.boundingData=new Float32Array(6)}}function Ev(r,t,e,n,i,s){let o=n,a=n+i-1;const c=s.pos,l=s.axis*2;for(;;){for(;o<=a&&e[o*6+l]<c;)o++;for(;o<=a&&e[a*6+l]>=c;)a--;if(o<a){for(let h=0;h<3;h++){let u=t[o*3+h];t[o*3+h]=t[a*3+h],t[a*3+h]=u}for(let h=0;h<6;h++){let u=e[o*6+h];e[o*6+h]=e[a*6+h],e[a*6+h]=u}o++,a--}else return o}}function Av(r,t,e,n,i,s){let o=n,a=n+i-1;const c=s.pos,l=s.axis*2;for(;;){for(;o<=a&&e[o*6+l]<c;)o++;for(;o<=a&&e[a*6+l]>=c;)a--;if(o<a){let h=r[o];r[o]=r[a],r[a]=h;for(let u=0;u<6;u++){let d=e[o*6+u];e[o*6+u]=e[a*6+u],e[a*6+u]=d}o++,a--}else return o}}function Ge(r,t){return t[r+15]===65535}function $e(r,t){return t[r+6]}function sn(r,t){return t[r+14]}function rn(r){return r+8}function on(r,t){return t[r+6]}function Gu(r,t){return t[r+7]}let Wu,Ws,ho,Xu;const wv=Math.pow(2,32);function Tc(r){return"count"in r?1:1+Tc(r.left)+Tc(r.right)}function Rv(r,t,e){return Wu=new Float32Array(e),Ws=new Uint32Array(e),ho=new Uint16Array(e),Xu=new Uint8Array(e),Ec(r,t)}function Ec(r,t){const e=r/4,n=r/2,i="count"in t,s=t.boundingData;for(let o=0;o<6;o++)Wu[e+o]=s[o];if(i)if(t.buffer){const o=t.buffer;Xu.set(new Uint8Array(o),r);for(let a=r,c=r+o.byteLength;a<c;a+=Ks){const l=a/2;Ge(l,ho)||(Ws[a/4+6]+=e)}return r+o.byteLength}else{const o=t.offset,a=t.count;return Ws[e+6]=o,ho[n+14]=a,ho[n+15]=Ao,r+Ks}else{const o=t.left,a=t.right,c=t.splitAxis;let l;if(l=Ec(r+Ks,o),l/4>wv)throw new Error("MeshBVH: Cannot store child pointer greater than 32 bits.");return Ws[e+6]=l/4,l=Ec(l,a),Ws[e+7]=c,l}}function Cv(r,t){const e=(r.index?r.index.count:r.attributes.position.count)/3,n=e>2**16,i=n?4:2,s=t?new SharedArrayBuffer(e*i):new ArrayBuffer(e*i),o=n?new Uint32Array(s):new Uint16Array(s);for(let a=0,c=o.length;a<c;a++)o[a]=a;return o}function Iv(r,t,e,n,i){const{maxDepth:s,verbose:o,maxLeafTris:a,strategy:c,onProgress:l,indirect:h}=i,u=r._indirectBuffer,d=r.geometry,f=d.index?d.index.array:null,g=h?Av:Ev,_=bs(d),m=new Float32Array(6);let p=!1;const v=new ba;return Sa(t,e,n,v.boundingData,m),x(v,e,n,m),v;function y(T){l&&l(T/_)}function x(T,w,A,I=null,S=0){if(!p&&S>=s&&(p=!0,o&&(console.warn(`MeshBVH: Max depth of ${s} reached when generating BVH. Consider increasing maxDepth.`),console.warn(d))),A<=a||S>=s)return y(w+A),T.offset=w,T.count=A,T;const M=bv(T.boundingData,I,t,w,A,c);if(M.axis===-1)return y(w+A),T.offset=w,T.count=A,T;const P=g(u,f,t,w,A,M);if(P===w||P===w+A)y(w+A),T.offset=w,T.count=A;else{T.splitAxis=M.axis;const U=new ba,D=w,O=P-w;T.left=U,Sa(t,D,O,U.boundingData,m),x(U,D,O,m,S+1);const W=new ba,G=P,j=A-O;T.right=W,Sa(t,G,j,W.boundingData,m),x(W,G,j,m,S+1)}return T}}function Pv(r,t){const e=r.geometry;t.indirect&&(r._indirectBuffer=Cv(e,t.useSharedArrayBuffer),yv(e,t.range)&&!t.verbose&&console.warn('MeshBVH: Provided geometry contains groups or a range that do not fully span the vertex contents while using the "indirect" option. BVH may incorrectly report intersections on unrendered portions of the geometry.')),r._indirectBuffer||vv(e,t);const n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,i=Mv(e),s=t.indirect?Hu(e,t.range):Vu(e,t.range);r._roots=s.map(o=>{const a=Iv(r,i,o.offset,o.count,t),c=Tc(a),l=new n(Ks*c);return Rv(0,a,l),l})}class Yn{constructor(){this.min=1/0,this.max=-1/0}setFromPointsField(t,e){let n=1/0,i=-1/0;for(let s=0,o=t.length;s<o;s++){const c=t[s][e];n=c<n?c:n,i=c>i?c:i}this.min=n,this.max=i}setFromPoints(t,e){let n=1/0,i=-1/0;for(let s=0,o=e.length;s<o;s++){const a=e[s],c=t.dot(a);n=c<n?c:n,i=c>i?c:i}this.min=n,this.max=i}isSeparated(t){return this.min>t.max||t.min>this.max}}Yn.prototype.setFromBox=function(){const r=new R;return function(e,n){const i=n.min,s=n.max;let o=1/0,a=-1/0;for(let c=0;c<=1;c++)for(let l=0;l<=1;l++)for(let h=0;h<=1;h++){r.x=i.x*c+s.x*(1-c),r.y=i.y*l+s.y*(1-l),r.z=i.z*h+s.z*(1-h);const u=e.dot(r);o=Math.min(u,o),a=Math.max(u,a)}this.min=o,this.max=a}}();const Lv=function(){const r=new R,t=new R,e=new R;return function(i,s,o){const a=i.start,c=r,l=s.start,h=t;e.subVectors(a,l),r.subVectors(i.end,i.start),t.subVectors(s.end,s.start);const u=e.dot(h),d=h.dot(c),f=h.dot(h),g=e.dot(c),m=c.dot(c)*f-d*d;let p,v;m!==0?p=(u*d-g*f)/m:p=0,v=(u+p*d)/f,o.x=p,o.y=v}}(),sl=function(){const r=new Ut,t=new R,e=new R;return function(i,s,o,a){Lv(i,s,r);let c=r.x,l=r.y;if(c>=0&&c<=1&&l>=0&&l<=1){i.at(c,o),s.at(l,a);return}else if(c>=0&&c<=1){l<0?s.at(0,a):s.at(1,a),i.closestPointToPoint(a,!0,o);return}else if(l>=0&&l<=1){c<0?i.at(0,o):i.at(1,o),s.closestPointToPoint(o,!0,a);return}else{let h;c<0?h=i.start:h=i.end;let u;l<0?u=s.start:u=s.end;const d=t,f=e;if(i.closestPointToPoint(u,!0,t),s.closestPointToPoint(h,!0,e),d.distanceToSquared(u)<=f.distanceToSquared(h)){o.copy(d),a.copy(u);return}else{o.copy(h),a.copy(f);return}}}}(),Dv=function(){const r=new R,t=new R,e=new Gn,n=new qn;return function(s,o){const{radius:a,center:c}=s,{a:l,b:h,c:u}=o;if(n.start=l,n.end=h,n.closestPointToPoint(c,!0,r).distanceTo(c)<=a||(n.start=l,n.end=u,n.closestPointToPoint(c,!0,r).distanceTo(c)<=a)||(n.start=h,n.end=u,n.closestPointToPoint(c,!0,r).distanceTo(c)<=a))return!0;const _=o.getPlane(e);if(Math.abs(_.distanceToPoint(c))<=a){const p=_.projectPoint(c,t);if(o.containsPoint(p))return!0}return!1}}(),Uv=1e-15;function Ta(r){return Math.abs(r)<Uv}class vn extends Ae{constructor(...t){super(...t),this.isExtendedTriangle=!0,this.satAxes=new Array(4).fill().map(()=>new R),this.satBounds=new Array(4).fill().map(()=>new Yn),this.points=[this.a,this.b,this.c],this.sphere=new Pe,this.plane=new Gn,this.needsUpdate=!0}intersectsSphere(t){return Dv(t,this)}update(){const t=this.a,e=this.b,n=this.c,i=this.points,s=this.satAxes,o=this.satBounds,a=s[0],c=o[0];this.getNormal(a),c.setFromPoints(a,i);const l=s[1],h=o[1];l.subVectors(t,e),h.setFromPoints(l,i);const u=s[2],d=o[2];u.subVectors(e,n),d.setFromPoints(u,i);const f=s[3],g=o[3];f.subVectors(n,t),g.setFromPoints(f,i),this.sphere.setFromPoints(this.points),this.plane.setFromNormalAndCoplanarPoint(a,t),this.needsUpdate=!1}}vn.prototype.closestPointToSegment=function(){const r=new R,t=new R,e=new qn;return function(i,s=null,o=null){const{start:a,end:c}=i,l=this.points;let h,u=1/0;for(let d=0;d<3;d++){const f=(d+1)%3;e.start.copy(l[d]),e.end.copy(l[f]),sl(e,i,r,t),h=r.distanceToSquared(t),h<u&&(u=h,s&&s.copy(r),o&&o.copy(t))}return this.closestPointToPoint(a,r),h=a.distanceToSquared(r),h<u&&(u=h,s&&s.copy(r),o&&o.copy(a)),this.closestPointToPoint(c,r),h=c.distanceToSquared(r),h<u&&(u=h,s&&s.copy(r),o&&o.copy(c)),Math.sqrt(u)}}();vn.prototype.intersectsTriangle=function(){const r=new vn,t=new Array(3),e=new Array(3),n=new Yn,i=new Yn,s=new R,o=new R,a=new R,c=new R,l=new R,h=new qn,u=new qn,d=new qn,f=new R;function g(_,m,p){const v=_.points;let y=0,x=-1;for(let T=0;T<3;T++){const{start:w,end:A}=h;w.copy(v[T]),A.copy(v[(T+1)%3]),h.delta(o);const I=Ta(m.distanceToPoint(w));if(Ta(m.normal.dot(o))&&I){p.copy(h),y=2;break}const S=m.intersectLine(h,f);if(!S&&I&&f.copy(w),(S||I)&&!Ta(f.distanceTo(A))){if(y<=1)(y===1?p.start:p.end).copy(f),I&&(x=y);else if(y>=2){(x===1?p.start:p.end).copy(f),y=2;break}if(y++,y===2&&x===-1)break}}return y}return function(m,p=null,v=!1){this.needsUpdate&&this.update(),m.isExtendedTriangle?m.needsUpdate&&m.update():(r.copy(m),r.update(),m=r);const y=this.plane,x=m.plane;if(Math.abs(y.normal.dot(x.normal))>1-1e-10){const T=this.satBounds,w=this.satAxes;e[0]=m.a,e[1]=m.b,e[2]=m.c;for(let S=0;S<4;S++){const M=T[S],P=w[S];if(n.setFromPoints(P,e),M.isSeparated(n))return!1}const A=m.satBounds,I=m.satAxes;t[0]=this.a,t[1]=this.b,t[2]=this.c;for(let S=0;S<4;S++){const M=A[S],P=I[S];if(n.setFromPoints(P,t),M.isSeparated(n))return!1}for(let S=0;S<4;S++){const M=w[S];for(let P=0;P<4;P++){const U=I[P];if(s.crossVectors(M,U),n.setFromPoints(s,t),i.setFromPoints(s,e),n.isSeparated(i))return!1}}return p&&(v||console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."),p.start.set(0,0,0),p.end.set(0,0,0)),!0}else{const T=g(this,x,u);if(T===1&&m.containsPoint(u.end))return p&&(p.start.copy(u.end),p.end.copy(u.end)),!0;if(T!==2)return!1;const w=g(m,y,d);if(w===1&&this.containsPoint(d.end))return p&&(p.start.copy(d.end),p.end.copy(d.end)),!0;if(w!==2)return!1;if(u.delta(a),d.delta(c),a.dot(c)<0){let D=d.start;d.start=d.end,d.end=D}const A=u.start.dot(a),I=u.end.dot(a),S=d.start.dot(a),M=d.end.dot(a),P=I<S,U=A<M;return A!==M&&S!==I&&P===U?!1:(p&&(l.subVectors(u.start,d.start),l.dot(a)>0?p.start.copy(u.start):p.start.copy(d.start),l.subVectors(u.end,d.end),l.dot(a)<0?p.end.copy(u.end):p.end.copy(d.end)),!0)}}}();vn.prototype.distanceToPoint=function(){const r=new R;return function(e){return this.closestPointToPoint(e,r),e.distanceTo(r)}}();vn.prototype.distanceToTriangle=function(){const r=new R,t=new R,e=["a","b","c"],n=new qn,i=new qn;return function(o,a=null,c=null){const l=a||c?n:null;if(this.intersectsTriangle(o,l))return(a||c)&&(a&&l.getCenter(a),c&&l.getCenter(c)),0;let h=1/0;for(let u=0;u<3;u++){let d;const f=e[u],g=o[f];this.closestPointToPoint(g,r),d=g.distanceToSquared(r),d<h&&(h=d,a&&a.copy(r),c&&c.copy(g));const _=this[f];o.closestPointToPoint(_,r),d=_.distanceToSquared(r),d<h&&(h=d,a&&a.copy(_),c&&c.copy(r))}for(let u=0;u<3;u++){const d=e[u],f=e[(u+1)%3];n.set(this[d],this[f]);for(let g=0;g<3;g++){const _=e[g],m=e[(g+1)%3];i.set(o[_],o[m]),sl(n,i,r,t);const p=r.distanceToSquared(t);p<h&&(h=p,a&&a.copy(r),c&&c.copy(t))}}return Math.sqrt(h)}}();class ze{constructor(t,e,n){this.isOrientedBox=!0,this.min=new R,this.max=new R,this.matrix=new Mt,this.invMatrix=new Mt,this.points=new Array(8).fill().map(()=>new R),this.satAxes=new Array(3).fill().map(()=>new R),this.satBounds=new Array(3).fill().map(()=>new Yn),this.alignedSatBounds=new Array(3).fill().map(()=>new Yn),this.needsUpdate=!1,t&&this.min.copy(t),e&&this.max.copy(e),n&&this.matrix.copy(n)}set(t,e,n){this.min.copy(t),this.max.copy(e),this.matrix.copy(n),this.needsUpdate=!0}copy(t){this.min.copy(t.min),this.max.copy(t.max),this.matrix.copy(t.matrix),this.needsUpdate=!0}}ze.prototype.update=function(){return function(){const t=this.matrix,e=this.min,n=this.max,i=this.points;for(let l=0;l<=1;l++)for(let h=0;h<=1;h++)for(let u=0;u<=1;u++){const d=1*l|2*h|4*u,f=i[d];f.x=l?n.x:e.x,f.y=h?n.y:e.y,f.z=u?n.z:e.z,f.applyMatrix4(t)}const s=this.satBounds,o=this.satAxes,a=i[0];for(let l=0;l<3;l++){const h=o[l],u=s[l],d=1<<l,f=i[d];h.subVectors(a,f),u.setFromPoints(h,i)}const c=this.alignedSatBounds;c[0].setFromPointsField(i,"x"),c[1].setFromPointsField(i,"y"),c[2].setFromPointsField(i,"z"),this.invMatrix.copy(this.matrix).invert(),this.needsUpdate=!1}}();ze.prototype.intersectsBox=function(){const r=new Yn;return function(e){this.needsUpdate&&this.update();const n=e.min,i=e.max,s=this.satBounds,o=this.satAxes,a=this.alignedSatBounds;if(r.min=n.x,r.max=i.x,a[0].isSeparated(r)||(r.min=n.y,r.max=i.y,a[1].isSeparated(r))||(r.min=n.z,r.max=i.z,a[2].isSeparated(r)))return!1;for(let c=0;c<3;c++){const l=o[c],h=s[c];if(r.setFromBox(l,e),h.isSeparated(r))return!1}return!0}}();ze.prototype.intersectsTriangle=function(){const r=new vn,t=new Array(3),e=new Yn,n=new Yn,i=new R;return function(o){this.needsUpdate&&this.update(),o.isExtendedTriangle?o.needsUpdate&&o.update():(r.copy(o),r.update(),o=r);const a=this.satBounds,c=this.satAxes;t[0]=o.a,t[1]=o.b,t[2]=o.c;for(let d=0;d<3;d++){const f=a[d],g=c[d];if(e.setFromPoints(g,t),f.isSeparated(e))return!1}const l=o.satBounds,h=o.satAxes,u=this.points;for(let d=0;d<3;d++){const f=l[d],g=h[d];if(e.setFromPoints(g,u),f.isSeparated(e))return!1}for(let d=0;d<3;d++){const f=c[d];for(let g=0;g<4;g++){const _=h[g];if(i.crossVectors(f,_),e.setFromPoints(i,t),n.setFromPoints(i,u),e.isSeparated(n))return!1}}return!0}}();ze.prototype.closestPointToPoint=function(){return function(t,e){return this.needsUpdate&&this.update(),e.copy(t).applyMatrix4(this.invMatrix).clamp(this.min,this.max).applyMatrix4(this.matrix),e}}();ze.prototype.distanceToPoint=function(){const r=new R;return function(e){return this.closestPointToPoint(e,r),e.distanceTo(r)}}();ze.prototype.distanceToBox=function(){const r=["x","y","z"],t=new Array(12).fill().map(()=>new qn),e=new Array(12).fill().map(()=>new qn),n=new R,i=new R;return function(o,a=0,c=null,l=null){if(this.needsUpdate&&this.update(),this.intersectsBox(o))return(c||l)&&(o.getCenter(i),this.closestPointToPoint(i,n),o.closestPointToPoint(n,i),c&&c.copy(n),l&&l.copy(i)),0;const h=a*a,u=o.min,d=o.max,f=this.points;let g=1/0;for(let m=0;m<8;m++){const p=f[m];i.copy(p).clamp(u,d);const v=p.distanceToSquared(i);if(v<g&&(g=v,c&&c.copy(p),l&&l.copy(i),v<h))return Math.sqrt(v)}let _=0;for(let m=0;m<3;m++)for(let p=0;p<=1;p++)for(let v=0;v<=1;v++){const y=(m+1)%3,x=(m+2)%3,T=p<<y|v<<x,w=1<<m|p<<y|v<<x,A=f[T],I=f[w];t[_].set(A,I);const M=r[m],P=r[y],U=r[x],D=e[_],O=D.start,W=D.end;O[M]=u[M],O[P]=p?u[P]:d[P],O[U]=v?u[U]:d[P],W[M]=d[M],W[P]=p?u[P]:d[P],W[U]=v?u[U]:d[P],_++}for(let m=0;m<=1;m++)for(let p=0;p<=1;p++)for(let v=0;v<=1;v++){i.x=m?d.x:u.x,i.y=p?d.y:u.y,i.z=v?d.z:u.z,this.closestPointToPoint(i,n);const y=i.distanceToSquared(n);if(y<g&&(g=y,c&&c.copy(n),l&&l.copy(i),y<h))return Math.sqrt(y)}for(let m=0;m<12;m++){const p=t[m];for(let v=0;v<12;v++){const y=e[v];sl(p,y,n,i);const x=n.distanceToSquared(i);if(x<g&&(g=x,c&&c.copy(n),l&&l.copy(i),x<h))return Math.sqrt(x)}}return Math.sqrt(g)}}();class rl{constructor(t){this._getNewPrimitive=t,this._primitives=[]}getPrimitive(){const t=this._primitives;return t.length===0?this._getNewPrimitive():t.pop()}releasePrimitive(t){this._primitives.push(t)}}class Nv extends rl{constructor(){super(()=>new vn)}}const an=new Nv;class Fv{constructor(){this.float32Array=null,this.uint16Array=null,this.uint32Array=null;const t=[];let e=null;this.setBuffer=n=>{e&&t.push(e),e=n,this.float32Array=new Float32Array(n),this.uint16Array=new Uint16Array(n),this.uint32Array=new Uint32Array(n)},this.clearBuffer=()=>{e=null,this.float32Array=null,this.uint16Array=null,this.uint32Array=null,t.length!==0&&this.setBuffer(t.pop())}}}const oe=new Fv;let ai,as;const Zi=[],Gr=new rl(()=>new le);function Bv(r,t,e,n,i,s){ai=Gr.getPrimitive(),as=Gr.getPrimitive(),Zi.push(ai,as),oe.setBuffer(r._roots[t]);const o=Ac(0,r.geometry,e,n,i,s);oe.clearBuffer(),Gr.releasePrimitive(ai),Gr.releasePrimitive(as),Zi.pop(),Zi.pop();const a=Zi.length;return a>0&&(as=Zi[a-1],ai=Zi[a-2]),o}function Ac(r,t,e,n,i=null,s=0,o=0){const{float32Array:a,uint16Array:c,uint32Array:l}=oe;let h=r*2;if(Ge(h,c)){const g=$e(r,l),_=sn(h,c);return de(r,a,ai),n(g,_,!1,o,s+r,ai)}else{let U=function(O){const{uint16Array:W,uint32Array:G}=oe;let j=O*2;for(;!Ge(j,W);)O=rn(O),j=O*2;return $e(O,G)},D=function(O){const{uint16Array:W,uint32Array:G}=oe;let j=O*2;for(;!Ge(j,W);)O=on(O,G),j=O*2;return $e(O,G)+sn(j,W)};var d=U,f=D;const g=rn(r),_=on(r,l);let m=g,p=_,v,y,x,T;if(i&&(x=ai,T=as,de(m,a,x),de(p,a,T),v=i(x),y=i(T),y<v)){m=_,p=g;const O=v;v=y,y=O,x=T}x||(x=ai,de(m,a,x));const w=Ge(m*2,c),A=e(x,w,v,o+1,s+m);let I;if(A===Hh){const O=U(m),G=D(m)-O;I=n(O,G,!0,o+1,s+m,x)}else I=A&&Ac(m,t,e,n,i,s,o+1);if(I)return!0;T=as,de(p,a,T);const S=Ge(p*2,c),M=e(T,S,y,o+1,s+p);let P;if(M===Hh){const O=U(p),G=D(p)-O;P=n(O,G,!0,o+1,s+p,T)}else P=M&&Ac(p,t,e,n,i,s,o+1);return!!P}}const Fs=new R,Ea=new R;function Ov(r,t,e={},n=0,i=1/0){const s=n*n,o=i*i;let a=1/0,c=null;if(r.shapecast({boundsTraverseOrder:h=>(Fs.copy(t).clamp(h.min,h.max),Fs.distanceToSquared(t)),intersectsBounds:(h,u,d)=>d<a&&d<o,intersectsTriangle:(h,u)=>{h.closestPointToPoint(t,Fs);const d=t.distanceToSquared(Fs);return d<a&&(Ea.copy(Fs),a=d,c=u),d<s}}),a===1/0)return null;const l=Math.sqrt(a);return e.point?e.point.copy(Ea):e.point=Ea.clone(),e.distance=l,e.faceIndex=c,e}const kv=parseInt(yo)>=169,Ti=new R,Ei=new R,Ai=new R,Wr=new Ut,Xr=new Ut,qr=new Ut,qh=new R,Yh=new R,jh=new R,Bs=new R;function zv(r,t,e,n,i,s,o,a){let c;if(s===Oe?c=r.intersectTriangle(n,e,t,!0,i):c=r.intersectTriangle(t,e,n,s!==mn,i),c===null)return null;const l=r.origin.distanceTo(i);return l<o||l>a?null:{distance:l,point:i.clone()}}function Hv(r,t,e,n,i,s,o,a,c,l,h){Ti.fromBufferAttribute(t,s),Ei.fromBufferAttribute(t,o),Ai.fromBufferAttribute(t,a);const u=zv(r,Ti,Ei,Ai,Bs,c,l,h);if(u){const d=new R;Ae.getBarycoord(Bs,Ti,Ei,Ai,d),n&&(Wr.fromBufferAttribute(n,s),Xr.fromBufferAttribute(n,o),qr.fromBufferAttribute(n,a),u.uv=Ae.getInterpolation(Bs,Ti,Ei,Ai,Wr,Xr,qr,new Ut)),i&&(Wr.fromBufferAttribute(i,s),Xr.fromBufferAttribute(i,o),qr.fromBufferAttribute(i,a),u.uv1=Ae.getInterpolation(Bs,Ti,Ei,Ai,Wr,Xr,qr,new Ut)),e&&(qh.fromBufferAttribute(e,s),Yh.fromBufferAttribute(e,o),jh.fromBufferAttribute(e,a),u.normal=Ae.getInterpolation(Bs,Ti,Ei,Ai,qh,Yh,jh,new R),u.normal.dot(r.direction)>0&&u.normal.multiplyScalar(-1));const f={a:s,b:o,c:a,normal:new R,materialIndex:0};Ae.getNormal(Ti,Ei,Ai,f.normal),u.face=f,u.faceIndex=s,kv&&(u.barycoord=d)}return u}function wo(r,t,e,n,i,s,o){const a=n*3;let c=a+0,l=a+1,h=a+2;const u=r.index;r.index&&(c=u.getX(c),l=u.getX(l),h=u.getX(h));const{position:d,normal:f,uv:g,uv1:_}=r.attributes,m=Hv(e,d,f,g,_,c,l,h,t,s,o);return m?(m.faceIndex=n,i&&i.push(m),m):null}function xe(r,t,e,n){const i=r.a,s=r.b,o=r.c;let a=t,c=t+1,l=t+2;e&&(a=e.getX(a),c=e.getX(c),l=e.getX(l)),i.x=n.getX(a),i.y=n.getY(a),i.z=n.getZ(a),s.x=n.getX(c),s.y=n.getY(c),s.z=n.getZ(c),o.x=n.getX(l),o.y=n.getY(l),o.z=n.getZ(l)}function Vv(r,t,e,n,i,s,o,a){const{geometry:c,_indirectBuffer:l}=r;for(let h=n,u=n+i;h<u;h++)wo(c,t,e,h,s,o,a)}function Gv(r,t,e,n,i,s,o){const{geometry:a,_indirectBuffer:c}=r;let l=1/0,h=null;for(let u=n,d=n+i;u<d;u++){let f;f=wo(a,t,e,u,null,s,o),f&&f.distance<l&&(h=f,l=f.distance)}return h}function Wv(r,t,e,n,i,s,o){const{geometry:a}=e,{index:c}=a,l=a.attributes.position;for(let h=r,u=t+r;h<u;h++){let d;if(d=h,xe(o,d*3,c,l),o.needsUpdate=!0,n(o,d,i,s))return!0}return!1}function Xv(r,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=r.geometry,n=e.index?e.index.array:null,i=e.attributes.position;let s,o,a,c,l=0;const h=r._roots;for(let d=0,f=h.length;d<f;d++)s=h[d],o=new Uint32Array(s),a=new Uint16Array(s),c=new Float32Array(s),u(0,l),l+=s.byteLength;function u(d,f,g=!1){const _=d*2;if(a[_+15]===Ao){const p=o[d+6],v=a[_+14];let y=1/0,x=1/0,T=1/0,w=-1/0,A=-1/0,I=-1/0;for(let S=3*p,M=3*(p+v);S<M;S++){let P=n[S];const U=i.getX(P),D=i.getY(P),O=i.getZ(P);U<y&&(y=U),U>w&&(w=U),D<x&&(x=D),D>A&&(A=D),O<T&&(T=O),O>I&&(I=O)}return c[d+0]!==y||c[d+1]!==x||c[d+2]!==T||c[d+3]!==w||c[d+4]!==A||c[d+5]!==I?(c[d+0]=y,c[d+1]=x,c[d+2]=T,c[d+3]=w,c[d+4]=A,c[d+5]=I,!0):!1}else{const p=d+8,v=o[d+6],y=p+f,x=v+f;let T=g,w=!1,A=!1;t?T||(w=t.has(y),A=t.has(x),T=!w&&!A):(w=!0,A=!0);const I=T||w,S=T||A;let M=!1;I&&(M=u(p,f,T));let P=!1;S&&(P=u(v,f,T));const U=M||P;if(U)for(let D=0;D<3;D++){const O=p+D,W=v+D,G=c[O],j=c[O+3],X=c[W],nt=c[W+3];c[d+D]=G<X?G:X,c[d+D+3]=j>nt?j:nt}return U}}}function di(r,t,e,n,i){let s,o,a,c,l,h;const u=1/e.direction.x,d=1/e.direction.y,f=1/e.direction.z,g=e.origin.x,_=e.origin.y,m=e.origin.z;let p=t[r],v=t[r+3],y=t[r+1],x=t[r+3+1],T=t[r+2],w=t[r+3+2];return u>=0?(s=(p-g)*u,o=(v-g)*u):(s=(v-g)*u,o=(p-g)*u),d>=0?(a=(y-_)*d,c=(x-_)*d):(a=(x-_)*d,c=(y-_)*d),s>c||a>o||((a>s||isNaN(s))&&(s=a),(c<o||isNaN(o))&&(o=c),f>=0?(l=(T-m)*f,h=(w-m)*f):(l=(w-m)*f,h=(T-m)*f),s>h||l>o)?!1:((l>s||s!==s)&&(s=l),(h<o||o!==o)&&(o=h),s<=i&&o>=n)}function qv(r,t,e,n,i,s,o,a){const{geometry:c,_indirectBuffer:l}=r;for(let h=n,u=n+i;h<u;h++){let d=l?l[h]:h;wo(c,t,e,d,s,o,a)}}function Yv(r,t,e,n,i,s,o){const{geometry:a,_indirectBuffer:c}=r;let l=1/0,h=null;for(let u=n,d=n+i;u<d;u++){let f;f=wo(a,t,e,c?c[u]:u,null,s,o),f&&f.distance<l&&(h=f,l=f.distance)}return h}function jv(r,t,e,n,i,s,o){const{geometry:a}=e,{index:c}=a,l=a.attributes.position;for(let h=r,u=t+r;h<u;h++){let d;if(d=e.resolveTriangleIndex(h),xe(o,d*3,c,l),o.needsUpdate=!0,n(o,d,i,s))return!0}return!1}function Kv(r,t,e,n,i,s,o){oe.setBuffer(r._roots[t]),wc(0,r,e,n,i,s,o),oe.clearBuffer()}function wc(r,t,e,n,i,s,o){const{float32Array:a,uint16Array:c,uint32Array:l}=oe,h=r*2;if(Ge(h,c)){const d=$e(r,l),f=sn(h,c);Vv(t,e,n,d,f,i,s,o)}else{const d=rn(r);di(d,a,n,s,o)&&wc(d,t,e,n,i,s,o);const f=on(r,l);di(f,a,n,s,o)&&wc(f,t,e,n,i,s,o)}}const $v=["x","y","z"];function Zv(r,t,e,n,i,s){oe.setBuffer(r._roots[t]);const o=Rc(0,r,e,n,i,s);return oe.clearBuffer(),o}function Rc(r,t,e,n,i,s){const{float32Array:o,uint16Array:a,uint32Array:c}=oe;let l=r*2;if(Ge(l,a)){const u=$e(r,c),d=sn(l,a);return Gv(t,e,n,u,d,i,s)}else{const u=Gu(r,c),d=$v[u],g=n.direction[d]>=0;let _,m;g?(_=rn(r),m=on(r,c)):(_=on(r,c),m=rn(r));const v=di(_,o,n,i,s)?Rc(_,t,e,n,i,s):null;if(v){const T=v.point[d];if(g?T<=o[m+u]:T>=o[m+u+3])return v}const x=di(m,o,n,i,s)?Rc(m,t,e,n,i,s):null;return v&&x?v.distance<=x.distance?v:x:v||x||null}}const Yr=new le,Ji=new vn,Qi=new vn,Os=new Mt,Kh=new ze,jr=new ze;function Jv(r,t,e,n){oe.setBuffer(r._roots[t]);const i=Cc(0,r,e,n);return oe.clearBuffer(),i}function Cc(r,t,e,n,i=null){const{float32Array:s,uint16Array:o,uint32Array:a}=oe;let c=r*2;if(i===null&&(e.boundingBox||e.computeBoundingBox(),Kh.set(e.boundingBox.min,e.boundingBox.max,n),i=Kh),Ge(c,o)){const h=t.geometry,u=h.index,d=h.attributes.position,f=e.index,g=e.attributes.position,_=$e(r,a),m=sn(c,o);if(Os.copy(n).invert(),e.boundsTree)return de(r,s,jr),jr.matrix.copy(Os),jr.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:v=>jr.intersectsBox(v),intersectsTriangle:v=>{v.a.applyMatrix4(n),v.b.applyMatrix4(n),v.c.applyMatrix4(n),v.needsUpdate=!0;for(let y=_*3,x=(m+_)*3;y<x;y+=3)if(xe(Qi,y,u,d),Qi.needsUpdate=!0,v.intersectsTriangle(Qi))return!0;return!1}});for(let p=_*3,v=(m+_)*3;p<v;p+=3){xe(Ji,p,u,d),Ji.a.applyMatrix4(Os),Ji.b.applyMatrix4(Os),Ji.c.applyMatrix4(Os),Ji.needsUpdate=!0;for(let y=0,x=f.count;y<x;y+=3)if(xe(Qi,y,f,g),Qi.needsUpdate=!0,Ji.intersectsTriangle(Qi))return!0}}else{const h=r+8,u=a[r+6];return de(h,s,Yr),!!(i.intersectsBox(Yr)&&Cc(h,t,e,n,i)||(de(u,s,Yr),i.intersectsBox(Yr)&&Cc(u,t,e,n,i)))}}const Kr=new Mt,Aa=new ze,ks=new ze,Qv=new R,ty=new R,ey=new R,ny=new R;function iy(r,t,e,n={},i={},s=0,o=1/0){t.boundingBox||t.computeBoundingBox(),Aa.set(t.boundingBox.min,t.boundingBox.max,e),Aa.needsUpdate=!0;const a=r.geometry,c=a.attributes.position,l=a.index,h=t.attributes.position,u=t.index,d=an.getPrimitive(),f=an.getPrimitive();let g=Qv,_=ty,m=null,p=null;i&&(m=ey,p=ny);let v=1/0,y=null,x=null;return Kr.copy(e).invert(),ks.matrix.copy(Kr),r.shapecast({boundsTraverseOrder:T=>Aa.distanceToBox(T),intersectsBounds:(T,w,A)=>A<v&&A<o?(w&&(ks.min.copy(T.min),ks.max.copy(T.max),ks.needsUpdate=!0),!0):!1,intersectsRange:(T,w)=>{if(t.boundsTree)return t.boundsTree.shapecast({boundsTraverseOrder:I=>ks.distanceToBox(I),intersectsBounds:(I,S,M)=>M<v&&M<o,intersectsRange:(I,S)=>{for(let M=I,P=I+S;M<P;M++){xe(f,3*M,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let U=T,D=T+w;U<D;U++){xe(d,3*U,l,c),d.needsUpdate=!0;const O=d.distanceToTriangle(f,g,m);if(O<v&&(_.copy(g),p&&p.copy(m),v=O,y=U,x=M),O<s)return!0}}}});{const A=bs(t);for(let I=0,S=A;I<S;I++){xe(f,3*I,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let M=T,P=T+w;M<P;M++){xe(d,3*M,l,c),d.needsUpdate=!0;const U=d.distanceToTriangle(f,g,m);if(U<v&&(_.copy(g),p&&p.copy(m),v=U,y=M,x=I),U<s)return!0}}}}}),an.releasePrimitive(d),an.releasePrimitive(f),v===1/0?null:(n.point?n.point.copy(_):n.point=_.clone(),n.distance=v,n.faceIndex=y,i&&(i.point?i.point.copy(p):i.point=p.clone(),i.point.applyMatrix4(Kr),_.applyMatrix4(Kr),i.distance=_.sub(i.point).length(),i.faceIndex=x),n)}function sy(r,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=r.geometry,n=e.index?e.index.array:null,i=e.attributes.position;let s,o,a,c,l=0;const h=r._roots;for(let d=0,f=h.length;d<f;d++)s=h[d],o=new Uint32Array(s),a=new Uint16Array(s),c=new Float32Array(s),u(0,l),l+=s.byteLength;function u(d,f,g=!1){const _=d*2;if(a[_+15]===Ao){const p=o[d+6],v=a[_+14];let y=1/0,x=1/0,T=1/0,w=-1/0,A=-1/0,I=-1/0;for(let S=p,M=p+v;S<M;S++){const P=3*r.resolveTriangleIndex(S);for(let U=0;U<3;U++){let D=P+U;D=n?n[D]:D;const O=i.getX(D),W=i.getY(D),G=i.getZ(D);O<y&&(y=O),O>w&&(w=O),W<x&&(x=W),W>A&&(A=W),G<T&&(T=G),G>I&&(I=G)}}return c[d+0]!==y||c[d+1]!==x||c[d+2]!==T||c[d+3]!==w||c[d+4]!==A||c[d+5]!==I?(c[d+0]=y,c[d+1]=x,c[d+2]=T,c[d+3]=w,c[d+4]=A,c[d+5]=I,!0):!1}else{const p=d+8,v=o[d+6],y=p+f,x=v+f;let T=g,w=!1,A=!1;t?T||(w=t.has(y),A=t.has(x),T=!w&&!A):(w=!0,A=!0);const I=T||w,S=T||A;let M=!1;I&&(M=u(p,f,T));let P=!1;S&&(P=u(v,f,T));const U=M||P;if(U)for(let D=0;D<3;D++){const O=p+D,W=v+D,G=c[O],j=c[O+3],X=c[W],nt=c[W+3];c[d+D]=G<X?G:X,c[d+D+3]=j>nt?j:nt}return U}}}function ry(r,t,e,n,i,s,o){oe.setBuffer(r._roots[t]),Ic(0,r,e,n,i,s,o),oe.clearBuffer()}function Ic(r,t,e,n,i,s,o){const{float32Array:a,uint16Array:c,uint32Array:l}=oe,h=r*2;if(Ge(h,c)){const d=$e(r,l),f=sn(h,c);qv(t,e,n,d,f,i,s,o)}else{const d=rn(r);di(d,a,n,s,o)&&Ic(d,t,e,n,i,s,o);const f=on(r,l);di(f,a,n,s,o)&&Ic(f,t,e,n,i,s,o)}}const oy=["x","y","z"];function ay(r,t,e,n,i,s){oe.setBuffer(r._roots[t]);const o=Pc(0,r,e,n,i,s);return oe.clearBuffer(),o}function Pc(r,t,e,n,i,s){const{float32Array:o,uint16Array:a,uint32Array:c}=oe;let l=r*2;if(Ge(l,a)){const u=$e(r,c),d=sn(l,a);return Yv(t,e,n,u,d,i,s)}else{const u=Gu(r,c),d=oy[u],g=n.direction[d]>=0;let _,m;g?(_=rn(r),m=on(r,c)):(_=on(r,c),m=rn(r));const v=di(_,o,n,i,s)?Pc(_,t,e,n,i,s):null;if(v){const T=v.point[d];if(g?T<=o[m+u]:T>=o[m+u+3])return v}const x=di(m,o,n,i,s)?Pc(m,t,e,n,i,s):null;return v&&x?v.distance<=x.distance?v:x:v||x||null}}const $r=new le,ts=new vn,es=new vn,zs=new Mt,$h=new ze,Zr=new ze;function cy(r,t,e,n){oe.setBuffer(r._roots[t]);const i=Lc(0,r,e,n);return oe.clearBuffer(),i}function Lc(r,t,e,n,i=null){const{float32Array:s,uint16Array:o,uint32Array:a}=oe;let c=r*2;if(i===null&&(e.boundingBox||e.computeBoundingBox(),$h.set(e.boundingBox.min,e.boundingBox.max,n),i=$h),Ge(c,o)){const h=t.geometry,u=h.index,d=h.attributes.position,f=e.index,g=e.attributes.position,_=$e(r,a),m=sn(c,o);if(zs.copy(n).invert(),e.boundsTree)return de(r,s,Zr),Zr.matrix.copy(zs),Zr.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:v=>Zr.intersectsBox(v),intersectsTriangle:v=>{v.a.applyMatrix4(n),v.b.applyMatrix4(n),v.c.applyMatrix4(n),v.needsUpdate=!0;for(let y=_,x=m+_;y<x;y++)if(xe(es,3*t.resolveTriangleIndex(y),u,d),es.needsUpdate=!0,v.intersectsTriangle(es))return!0;return!1}});for(let p=_,v=m+_;p<v;p++){const y=t.resolveTriangleIndex(p);xe(ts,3*y,u,d),ts.a.applyMatrix4(zs),ts.b.applyMatrix4(zs),ts.c.applyMatrix4(zs),ts.needsUpdate=!0;for(let x=0,T=f.count;x<T;x+=3)if(xe(es,x,f,g),es.needsUpdate=!0,ts.intersectsTriangle(es))return!0}}else{const h=r+8,u=a[r+6];return de(h,s,$r),!!(i.intersectsBox($r)&&Lc(h,t,e,n,i)||(de(u,s,$r),i.intersectsBox($r)&&Lc(u,t,e,n,i)))}}const Jr=new Mt,wa=new ze,Hs=new ze,ly=new R,hy=new R,uy=new R,dy=new R;function fy(r,t,e,n={},i={},s=0,o=1/0){t.boundingBox||t.computeBoundingBox(),wa.set(t.boundingBox.min,t.boundingBox.max,e),wa.needsUpdate=!0;const a=r.geometry,c=a.attributes.position,l=a.index,h=t.attributes.position,u=t.index,d=an.getPrimitive(),f=an.getPrimitive();let g=ly,_=hy,m=null,p=null;i&&(m=uy,p=dy);let v=1/0,y=null,x=null;return Jr.copy(e).invert(),Hs.matrix.copy(Jr),r.shapecast({boundsTraverseOrder:T=>wa.distanceToBox(T),intersectsBounds:(T,w,A)=>A<v&&A<o?(w&&(Hs.min.copy(T.min),Hs.max.copy(T.max),Hs.needsUpdate=!0),!0):!1,intersectsRange:(T,w)=>{if(t.boundsTree){const A=t.boundsTree;return A.shapecast({boundsTraverseOrder:I=>Hs.distanceToBox(I),intersectsBounds:(I,S,M)=>M<v&&M<o,intersectsRange:(I,S)=>{for(let M=I,P=I+S;M<P;M++){const U=A.resolveTriangleIndex(M);xe(f,3*U,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let D=T,O=T+w;D<O;D++){const W=r.resolveTriangleIndex(D);xe(d,3*W,l,c),d.needsUpdate=!0;const G=d.distanceToTriangle(f,g,m);if(G<v&&(_.copy(g),p&&p.copy(m),v=G,y=D,x=M),G<s)return!0}}}})}else{const A=bs(t);for(let I=0,S=A;I<S;I++){xe(f,3*I,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let M=T,P=T+w;M<P;M++){const U=r.resolveTriangleIndex(M);xe(d,3*U,l,c),d.needsUpdate=!0;const D=d.distanceToTriangle(f,g,m);if(D<v&&(_.copy(g),p&&p.copy(m),v=D,y=M,x=I),D<s)return!0}}}}}),an.releasePrimitive(d),an.releasePrimitive(f),v===1/0?null:(n.point?n.point.copy(_):n.point=_.clone(),n.distance=v,n.faceIndex=y,i&&(i.point?i.point.copy(p):i.point=p.clone(),i.point.applyMatrix4(Jr),_.applyMatrix4(Jr),i.distance=_.sub(i.point).length(),i.faceIndex=x),n)}function py(){return typeof SharedArrayBuffer<"u"}const $s=new oe.constructor,vo=new oe.constructor,ni=new rl(()=>new le),ns=new le,is=new le,Ra=new le,Ca=new le;let Ia=!1;function my(r,t,e,n){if(Ia)throw new Error("MeshBVH: Recursive calls to bvhcast not supported.");Ia=!0;const i=r._roots,s=t._roots;let o,a=0,c=0;const l=new Mt().copy(e).invert();for(let h=0,u=i.length;h<u;h++){$s.setBuffer(i[h]),c=0;const d=ni.getPrimitive();de(0,$s.float32Array,d),d.applyMatrix4(l);for(let f=0,g=s.length;f<g&&(vo.setBuffer(s[f]),o=pn(0,0,e,l,n,a,c,0,0,d),vo.clearBuffer(),c+=s[f].length,!o);f++);if(ni.releasePrimitive(d),$s.clearBuffer(),a+=i[h].length,o)break}return Ia=!1,o}function pn(r,t,e,n,i,s=0,o=0,a=0,c=0,l=null,h=!1){let u,d;h?(u=vo,d=$s):(u=$s,d=vo);const f=u.float32Array,g=u.uint32Array,_=u.uint16Array,m=d.float32Array,p=d.uint32Array,v=d.uint16Array,y=r*2,x=t*2,T=Ge(y,_),w=Ge(x,v);let A=!1;if(w&&T)h?A=i($e(t,p),sn(t*2,v),$e(r,g),sn(r*2,_),c,o+t,a,s+r):A=i($e(r,g),sn(r*2,_),$e(t,p),sn(t*2,v),a,s+r,c,o+t);else if(w){const I=ni.getPrimitive();de(t,m,I),I.applyMatrix4(e);const S=rn(r),M=on(r,g);de(S,f,ns),de(M,f,is);const P=I.intersectsBox(ns),U=I.intersectsBox(is);A=P&&pn(t,S,n,e,i,o,s,c,a+1,I,!h)||U&&pn(t,M,n,e,i,o,s,c,a+1,I,!h),ni.releasePrimitive(I)}else{const I=rn(t),S=on(t,p);de(I,m,Ra),de(S,m,Ca);const M=l.intersectsBox(Ra),P=l.intersectsBox(Ca);if(M&&P)A=pn(r,I,e,n,i,s,o,a,c+1,l,h)||pn(r,S,e,n,i,s,o,a,c+1,l,h);else if(M)if(T)A=pn(r,I,e,n,i,s,o,a,c+1,l,h);else{const U=ni.getPrimitive();U.copy(Ra).applyMatrix4(e);const D=rn(r),O=on(r,g);de(D,f,ns),de(O,f,is);const W=U.intersectsBox(ns),G=U.intersectsBox(is);A=W&&pn(I,D,n,e,i,o,s,c,a+1,U,!h)||G&&pn(I,O,n,e,i,o,s,c,a+1,U,!h),ni.releasePrimitive(U)}else if(P)if(T)A=pn(r,S,e,n,i,s,o,a,c+1,l,h);else{const U=ni.getPrimitive();U.copy(Ca).applyMatrix4(e);const D=rn(r),O=on(r,g);de(D,f,ns),de(O,f,is);const W=U.intersectsBox(ns),G=U.intersectsBox(is);A=W&&pn(S,D,n,e,i,o,s,c,a+1,U,!h)||G&&pn(S,O,n,e,i,o,s,c,a+1,U,!h),ni.releasePrimitive(U)}}return A}const Qr=new ze,Zh=new le,gy={strategy:zu,maxDepth:40,maxLeafTris:10,useSharedArrayBuffer:!1,setBoundingBox:!0,onProgress:null,indirect:!1,verbose:!0,range:null};class ol{static serialize(t,e={}){e={cloneBuffers:!0,...e};const n=t.geometry,i=t._roots,s=t._indirectBuffer,o=n.getIndex();let a;return e.cloneBuffers?a={roots:i.map(c=>c.slice()),index:o?o.array.slice():null,indirectBuffer:s?s.slice():null}:a={roots:i,index:o?o.array:null,indirectBuffer:s},a}static deserialize(t,e,n={}){n={setIndex:!0,indirect:!!t.indirectBuffer,...n};const{index:i,roots:s,indirectBuffer:o}=t,a=new ol(e,{...n,[Ma]:!0});if(a._roots=s,a._indirectBuffer=o||null,n.setIndex){const c=e.getIndex();if(c===null){const l=new pe(t.index,1,!1);e.setIndex(l)}else c.array!==i&&(c.array.set(i),c.needsUpdate=!0)}return a}get indirect(){return!!this._indirectBuffer}constructor(t,e={}){if(t.isBufferGeometry){if(t.index&&t.index.isInterleavedBufferAttribute)throw new Error("MeshBVH: InterleavedBufferAttribute is not supported for the index attribute.")}else throw new Error("MeshBVH: Only BufferGeometries are supported.");if(e=Object.assign({...gy,[Ma]:!1},e),e.useSharedArrayBuffer&&!py())throw new Error("MeshBVH: SharedArrayBuffer is not available.");this.geometry=t,this._roots=null,this._indirectBuffer=null,e[Ma]||(Pv(this,e),!t.boundingBox&&e.setBoundingBox&&(t.boundingBox=this.getBoundingBox(new le))),this.resolveTriangleIndex=e.indirect?n=>this._indirectBuffer[n]:n=>n}refit(t=null){return(this.indirect?sy:Xv)(this,t)}traverse(t,e=0){const n=this._roots[e],i=new Uint32Array(n),s=new Uint16Array(n);o(0);function o(a,c=0){const l=a*2,h=s[l+15]===Ao;if(h){const u=i[a+6],d=s[l+14];t(c,h,new Float32Array(n,a*4,6),u,d)}else{const u=a+Ks/4,d=i[a+6],f=i[a+7];t(c,h,new Float32Array(n,a*4,6),f)||(o(u,c+1),o(d,c+1))}}}raycast(t,e=xn,n=0,i=1/0){const s=this._roots,o=this.geometry,a=[],c=e.isMaterial,l=Array.isArray(e),h=o.groups,u=c?e.side:e,d=this.indirect?ry:Kv;for(let f=0,g=s.length;f<g;f++){const _=l?e[h[f].materialIndex].side:u,m=a.length;if(d(this,f,_,t,a,n,i),l){const p=h[f].materialIndex;for(let v=m,y=a.length;v<y;v++)a[v].face.materialIndex=p}}return a}raycastFirst(t,e=xn,n=0,i=1/0){const s=this._roots,o=this.geometry,a=e.isMaterial,c=Array.isArray(e);let l=null;const h=o.groups,u=a?e.side:e,d=this.indirect?ay:Zv;for(let f=0,g=s.length;f<g;f++){const _=c?e[h[f].materialIndex].side:u,m=d(this,f,_,t,n,i);m!=null&&(l==null||m.distance<l.distance)&&(l=m,c&&(m.face.materialIndex=h[f].materialIndex))}return l}intersectsGeometry(t,e){let n=!1;const i=this._roots,s=this.indirect?cy:Jv;for(let o=0,a=i.length;o<a&&(n=s(this,o,t,e),!n);o++);return n}shapecast(t){const e=an.getPrimitive(),n=this.indirect?jv:Wv;let{boundsTraverseOrder:i,intersectsBounds:s,intersectsRange:o,intersectsTriangle:a}=t;if(o&&a){const u=o;o=(d,f,g,_,m)=>u(d,f,g,_,m)?!0:n(d,f,this,a,g,_,e)}else o||(a?o=(u,d,f,g)=>n(u,d,this,a,f,g,e):o=(u,d,f)=>f);let c=!1,l=0;const h=this._roots;for(let u=0,d=h.length;u<d;u++){const f=h[u];if(c=Bv(this,u,s,o,i,l),c)break;l+=f.byteLength}return an.releasePrimitive(e),c}bvhcast(t,e,n){let{intersectsRanges:i,intersectsTriangles:s}=n;const o=an.getPrimitive(),a=this.geometry.index,c=this.geometry.attributes.position,l=this.indirect?g=>{const _=this.resolveTriangleIndex(g);xe(o,_*3,a,c)}:g=>{xe(o,g*3,a,c)},h=an.getPrimitive(),u=t.geometry.index,d=t.geometry.attributes.position,f=t.indirect?g=>{const _=t.resolveTriangleIndex(g);xe(h,_*3,u,d)}:g=>{xe(h,g*3,u,d)};if(s){const g=(_,m,p,v,y,x,T,w)=>{for(let A=p,I=p+v;A<I;A++){f(A),h.a.applyMatrix4(e),h.b.applyMatrix4(e),h.c.applyMatrix4(e),h.needsUpdate=!0;for(let S=_,M=_+m;S<M;S++)if(l(S),o.needsUpdate=!0,s(o,h,S,A,y,x,T,w))return!0}return!1};if(i){const _=i;i=function(m,p,v,y,x,T,w,A){return _(m,p,v,y,x,T,w,A)?!0:g(m,p,v,y,x,T,w,A)}}else i=g}return my(this,t,e,i)}intersectsBox(t,e){return Qr.set(t.min,t.max,e),Qr.needsUpdate=!0,this.shapecast({intersectsBounds:n=>Qr.intersectsBox(n),intersectsTriangle:n=>Qr.intersectsTriangle(n)})}intersectsSphere(t){return this.shapecast({intersectsBounds:e=>t.intersectsBox(e),intersectsTriangle:e=>e.intersectsSphere(t)})}closestPointToGeometry(t,e,n={},i={},s=0,o=1/0){return(this.indirect?fy:iy)(this,t,e,n,i,s,o)}closestPointToPoint(t,e={},n=0,i=1/0){return Ov(this,t,e,n,i)}getBoundingBox(t){return t.makeEmpty(),this._roots.forEach(n=>{de(0,new Float32Array(n),Zh),t.union(Zh)}),t}}function Jh(r,t,e){return r===null?null:(r.point.applyMatrix4(t.matrixWorld),r.distance=r.point.distanceTo(e.ray.origin),r.object=t,r)}const to=new vs,Qh=new R,tu=new Mt,_y=Jt.prototype.raycast,xy=Jf.prototype.raycast,eu=new R,Ee=new Jt,eo=[];function vy(r,t){this.isBatchedMesh?yy.call(this,r,t):My.call(this,r,t)}function yy(r,t){if(this.boundsTrees){const e=this.boundsTrees,n=this._drawInfo||this._instanceInfo,i=this._drawRanges||this._geometryInfo,s=this.matrixWorld;Ee.material=this.material,Ee.geometry=this.geometry;const o=Ee.geometry.boundsTree,a=Ee.geometry.drawRange;Ee.geometry.boundingSphere===null&&(Ee.geometry.boundingSphere=new Pe);for(let c=0,l=n.length;c<l;c++){if(!this.getVisibleAt(c))continue;const h=n[c].geometryIndex;if(Ee.geometry.boundsTree=e[h],this.getMatrixAt(c,Ee.matrixWorld).premultiply(s),!Ee.geometry.boundsTree){this.getBoundingBoxAt(h,Ee.geometry.boundingBox),this.getBoundingSphereAt(h,Ee.geometry.boundingSphere);const u=i[h];Ee.geometry.setDrawRange(u.start,u.count)}Ee.raycast(r,eo);for(let u=0,d=eo.length;u<d;u++){const f=eo[u];f.object=this,f.batchId=c,t.push(f)}eo.length=0}Ee.geometry.boundsTree=o,Ee.geometry.drawRange=a,Ee.material=null,Ee.geometry=null}else xy.call(this,r,t)}function My(r,t){if(this.geometry.boundsTree){if(this.material===void 0)return;tu.copy(this.matrixWorld).invert(),to.copy(r.ray).applyMatrix4(tu),eu.setFromMatrixScale(this.matrixWorld),Qh.copy(to.direction).multiply(eu);const e=Qh.length(),n=r.near/e,i=r.far/e,s=this.geometry.boundsTree;if(r.firstHitOnly===!0){const o=Jh(s.raycastFirst(to,this.material,n,i),this,r);o&&t.push(o)}else{const o=s.raycast(to,this.material,n,i);for(let a=0,c=o.length;a<c;a++){const l=Jh(o[a],this,r);l&&t.push(l)}}}else _y.call(this,r,t)}function Sy(r={}){return this.boundsTree=new ol(this,r),this.boundsTree}function by(){this.boundsTree=null}const Ty=18,Ey=35,Ay=[{x:5,y:-1.5,z:-10},{x:-3,y:-1.5,z:-8},{x:8,y:-1.5,z:-5},{x:-6,y:-1.5,z:-14},{x:12,y:-1.5,z:-18},{x:-10,y:-1.5,z:-20},{x:0,y:-1.5,z:-22},{x:15,y:-1.5,z:-8}],wy=4,Ry=12;class Cy{constructor(t){k(this,"npcs",[]);k(this,"group",new ri);k(this,"loader");k(this,"respawnQueue",[]);this.loader=t}spawn(t){const e=new Cx(this.loader);e.position.set(t.x,t.y,t.z),this.npcs.push(e),this.group.add(e)}update(t,e,n,i){for(let o=this.respawnQueue.length-1;o>=0;o--){const a=this.respawnQueue[o];if(a.timer-=t,a.timer<=0){const c=this.chooseFarSpawn(e);a.npc.respawn(new R(c.x,c.y,c.z)),this.npcs.includes(a.npc)||this.npcs.push(a.npc),this.respawnQueue.splice(o,1)}}this.npcs=this.npcs.filter(o=>o.isAlive||o.parent!==null);let s=0;for(const o of this.npcs){const a=o.position.distanceTo(e);if(!o.isAlive){o.update(t),o.updateDeath(t)&&(this.scheduleRespawn(o),this.npcs=this.npcs.filter(h=>h!==o));continue}if(a>Ey||(o.update(t),a>Ty))continue;o.updateBehavior(e,t);const c=o.flushDamage();if(c>0){if(s+=c,i){const l=new R(e.x-o.position.x,0,e.z-o.position.z).normalize();i.npcAttackSlash(o.position.clone(),l)}if(n){const l=new R(e.x-o.position.x,0,e.z-o.position.z);n.applyPlayerKnockback(l,3.5)}}}return this.resolveNpcCollisions(),s}scheduleRespawn(t){t.traverse(e=>{e instanceof Jt&&(e.visible=!1)}),this.respawnQueue.push({npc:t,timer:wy})}chooseFarSpawn(t){const e=[...Ay].sort((i,s)=>{const o=new R(i.x,i.y,i.z).distanceTo(t);return new R(s.x,s.y,s.z).distanceTo(t)-o});return e.find(i=>new R(i.x,i.y,i.z).distanceTo(t)>=Ry)??e[0]}resolveNpcCollisions(){const t=il*2;for(let e=0;e<this.npcs.length;e++)for(let n=e+1;n<this.npcs.length;n++){const i=this.npcs[e],s=this.npcs[n];if(!i.isAlive||!s.isAlive)continue;const o=new R(i.position.x-s.position.x,0,i.position.z-s.position.z),a=o.length();if(a<t&&a>.001){const c=(t-a)/2,l=o.normalize().multiplyScalar(c);i.position.x+=l.x,i.position.z+=l.z,s.position.x-=l.x,s.position.z-=l.z}}}getAll(){return this.npcs}collectNpcMeshes(t){const e=[];return t.forEach(n=>{n.traverse(i=>{i instanceof Jt&&i.userData.type==="npc"&&e.push(i)})}),e}}class Iy{constructor(){k(this,"container");k(this,"healthBar");k(this,"healthVal");k(this,"staminaBar");k(this,"healthCur",100);k(this,"healthPrev",100);k(this,"staminaCur",100);k(this,"killsEl");k(this,"kills",0);k(this,"minimapCanvas");k(this,"minimapCtx");k(this,"enemyBlips",new Map);k(this,"playerAngle",0);k(this,"alertEl");k(this,"alertText");k(this,"alertTimeout",null);k(this,"hitVignette");k(this,"hitFlashTimeout",null);k(this,"rafId",0);k(this,"_healthAnim",100);k(this,"_staminaAnim",100);this.injectStyles(),this.container=this.buildDOM(),document.body.appendChild(this.container),this.queryRefs(),this.startAnimation()}setHealth(t){const e=Math.max(0,Math.min(100,t));e<this.healthCur&&this.flashHit(),this.healthCur=e,e<30?this.container.classList.add("critical"):this.container.classList.remove("critical")}setStamina(t){this.staminaCur=Math.max(0,Math.min(100,t))}setAmmo(t,e){this.kills=t,this.killsEl&&(this.killsEl.textContent=String(this.kills).padStart(3,"0"))}addEnemy(t){this.enemyBlips.set(t.id,t)}removeEnemy(t){this.enemyBlips.delete(t)}clearEnemies(){this.enemyBlips.clear()}showAlert(t,e=3e3){var n;if(!t){(n=this.alertEl)==null||n.classList.remove("show");return}this.alertTimeout&&clearTimeout(this.alertTimeout),this.alertText.textContent=t,this.alertEl.classList.add("show"),this.alertTimeout=setTimeout(()=>{this.alertEl.classList.remove("show")},e)}update(t){this.playerAngle=t,this.renderMinimap()}flashHit(){this.hitFlashTimeout&&clearTimeout(this.hitFlashTimeout),this.hitVignette.classList.add("flash"),this.hitFlashTimeout=setTimeout(()=>{this.hitVignette.classList.remove("flash")},350)}startAnimation(){const t=()=>{this.rafId=requestAnimationFrame(t),this._healthAnim+=(this.healthCur-this._healthAnim)*.1,this._staminaAnim+=(this.staminaCur-this._staminaAnim)*.12;const e=this._healthAnim,n=this._staminaAnim;this.healthBar&&(this.healthBar.style.width=`${e}%`),this.staminaBar&&(this.staminaBar.style.width=`${n}%`),this.healthBar&&(e<25?this.healthBar.style.background="var(--c-hp-crit)":e<50?this.healthBar.style.background="var(--c-hp-low)":this.healthBar.style.background="var(--c-hp)"),this.healthVal&&(this.healthVal.textContent=String(Math.round(e)))};t()}renderMinimap(){const t=this.minimapCtx,e=this.minimapCanvas.width,n=e/2,i=n-2;t.clearRect(0,0,e,e),t.save(),t.beginPath(),t.arc(n,n,i,0,Math.PI*2),t.clip(),t.fillStyle="rgba(4, 6, 12, 0.92)",t.fillRect(0,0,e,e),t.strokeStyle="rgba(255,255,255,0.04)",t.lineWidth=.5;for(let o=-3;o<=3;o++){const a=n+o/3*i;t.beginPath(),t.moveTo(a,n-i),t.lineTo(a,n+i),t.stroke(),t.beginPath(),t.moveTo(n-i,a),t.lineTo(n+i,a),t.stroke()}t.strokeStyle="rgba(255,255,255,0.05)",[.4,.75].forEach(o=>{t.beginPath(),t.arc(n,n,i*o,0,Math.PI*2),t.stroke()}),this.enemyBlips.forEach(o=>{const a=Math.hypot(o.x,o.z),c=a>1?o.x/a:o.x,l=a>1?o.z/a:o.z,h=n+c*i*.88,u=n+l*i*.88,d=t.createRadialGradient(h,u,0,h,u,7);d.addColorStop(0,"rgba(255,60,60,0.55)"),d.addColorStop(1,"transparent"),t.beginPath(),t.arc(h,u,7,0,Math.PI*2),t.fillStyle=d,t.fill(),t.save(),t.translate(h,u),t.rotate(Math.PI/4),t.fillStyle="#e03030",t.fillRect(-3,-3,6,6),t.restore()}),t.save(),t.translate(n,n),t.rotate(-this.playerAngle),t.fillStyle="#00d4ff",t.beginPath(),t.moveTo(0,-9),t.lineTo(5,5),t.lineTo(0,2),t.lineTo(-5,5),t.closePath(),t.fill(),t.restore();const s=t.createRadialGradient(n,n,i*.45,n,n,i);s.addColorStop(0,"transparent"),s.addColorStop(1,"rgba(0,0,0,0.7)"),t.fillStyle=s,t.fillRect(0,0,e,e),t.restore(),t.beginPath(),t.arc(n,n,i,0,Math.PI*2),t.strokeStyle="rgba(0,180,220,0.25)",t.lineWidth=1.5,t.stroke(),t.beginPath(),t.arc(n,n,i+1.5,0,Math.PI*2),t.strokeStyle="rgba(0,0,0,0.8)",t.lineWidth=3,t.stroke()}buildDOM(){const t=document.createElement("div");return t.id="hud",t.innerHTML=`
...
50%       { opacity: 0.85; }
  ...
  `,document.head.appendChild(t)}}function bn(r,t,e,n,i,s="linear"){const o=t.length,a=new Float32Array(o*3),c=new Float32Array(o);for(let f=0;f<o;f++)a[f*3]=t[f].x,a[f*3+1]=t[f].y,a[f*3+2]=t[f].z,c[f]=t[f].size;const l=new be;l.setAttribute("position",new Le(a,3));const h=Math.max(...t.map(f=>f.maxLife)),u=new Kc({color:e,size:n,sizeAttenuation:!0,transparent:!0,opacity:1,blending:i,depthWrite:!1,vertexColors:!1}),d=new Au(l,u);return r.add(d),{points:d,geo:l,mat:u,pts:t,life:h,maxLife:h,fadeCurve:s}}function Py(r){return r>.7?(1-r)/.3:r>.2?1:r/.2}function Ly(r){return r<.5?1:(r-.5)/.5}class Dy{constructor(t){k(this,"scene");k(this,"batches",[]);k(this,"runTrailTimer",0);k(this,"TRAIL_INTERVAL",.042);k(this,"dragonFireTimers",new Map);k(this,"FIRE_INTERVAL",.06);k(this,"MAX_BATCHES",80);this.scene=t}update(t){for(let e=this.batches.length-1;e>=0;e--){const n=this.batches[e];if(n.life-=t,n.life<=0){this.scene.remove(n.points),n.geo.dispose(),n.mat.dispose(),this.batches.splice(e,1);continue}const i=n.geo.getAttribute("position"),s=i.array;n.life/n.maxLife;for(let a=0;a<n.pts.length;a++){const c=n.pts[a];c.life<=0||(c.life-=t,c.vx*=Math.pow(c.drag,t),c.vz*=Math.pow(c.drag,t),c.vy-=c.gravity*t,c.x+=c.vx*t,c.y+=c.vy*t,c.z+=c.vz*t,s[a*3]=c.x,s[a*3+1]=c.y,s[a*3+2]=c.z)}i.needsUpdate=!0;const o=n.life/n.maxLife;switch(n.fadeCurve){case"fire":n.mat.opacity=Py(o);break;case"blood":n.mat.opacity=Ly(o);break;default:n.mat.opacity=o;break}}}addBatch(t){if(this.batches.length>=this.MAX_BATCHES){const e=this.batches.reduce((n,i)=>n.life<i.life?n:i);this.scene.remove(e.points),e.geo.dispose(),e.mat.dispose(),this.batches.splice(this.batches.indexOf(e),1)}this.batches.push(t)}slashArc(t,e){const i=Math.atan2(e.x,e.z),s=Math.PI*.85,o=[];for(let l=0;l<22;l++){const h=l/21,u=i-s/2+h*s,d=4.5+Math.random()*2;o.push({x:t.x+Math.sin(u)*.3,y:t.y+.9+Math.random()*.3,z:t.z+Math.cos(u)*.3,vx:Math.sin(u)*d,vy:1.2+Math.random()*1,vz:Math.cos(u)*d,life:.25+Math.random()*.1,maxLife:.35,gravity:5,drag:.88,size:.07+Math.random()*.05})}const a=.35,c=bn(this.scene,o,8969727,.08,Hn,"linear");c.life=c.maxLife=a,this.addBatch(c),this.spawnRing(t.clone().setY(t.y+.9),e,6737151,.5,.25)}hitSpark(t){const n=[];for(let s=0;s<16;s++){const o=Math.random()*Math.PI*2,a=(Math.random()-.5)*Math.PI*.8,c=2.5+Math.random()*4;n.push({x:t.x+(Math.random()-.5)*.2,y:t.y+.8+Math.random()*.3,z:t.z+(Math.random()-.5)*.2,vx:Math.cos(o)*Math.cos(a)*c,vy:Math.abs(Math.sin(a))*c*1.1,vz:Math.sin(o)*Math.cos(a)*c,life:.2+Math.random()*.15,maxLife:.35,gravity:10,drag:.84,size:.06+Math.random()*.04})}const i=bn(this.scene,n,16737792,.07,Hn,"linear");this.addBatch(i),this.spawnRing(t.clone().setY(t.y+.8),new R(0,0,1),16777215,.25,.12)}bloodBurst(t,e){const i=[];for(let l=0;l<20;l++){const u=1.5+Math.random()*3.5,d=e.z,f=-e.x,g=(Math.random()-.5)*.7;i.push({x:t.x,y:t.y+.7+Math.random()*.5,z:t.z,vx:e.x*u+d*g*u,vy:.8+Math.random()*1.8,vz:e.z*u+f*g*u,life:.28+Math.random()*.22,maxLife:.5,gravity:14,drag:.8,size:.05+Math.random()*.04})}const s=bn(this.scene,i,13373713,.06,En,"blood");this.addBatch(s);const o=10,a=[];for(let l=0;l<o;l++){const h=.5+Math.random()*2;a.push({x:t.x+(Math.random()-.5)*.3,y:t.y+.6,z:t.z+(Math.random()-.5)*.3,vx:e.x*h+(Math.random()-.5)*1.5,vy:.3+Math.random()*.8,vz:e.z*h+(Math.random()-.5)*1.5,life:.35+Math.random()*.3,maxLife:.65,gravity:18,drag:.75,size:.07+Math.random()*.05})}const c=bn(this.scene,a,8914952,.08,En,"blood");this.addBatch(c)}npcAttackSlash(t,e){const i=Math.atan2(e.x,e.z),s=Math.PI*.7,o=[];for(let c=0;c<16;c++){const l=c/15,h=i-s/2+l*s,u=3.5+Math.random()*1.5;o.push({x:t.x,y:t.y+.9+Math.random()*.2,z:t.z,vx:Math.sin(h)*u,vy:1+Math.random()*.8,vz:Math.cos(h)*u,life:.18+Math.random()*.08,maxLife:.26,gravity:6,drag:.88,size:.06+Math.random()*.03})}const a=bn(this.scene,o,16720384,.07,Hn,"linear");this.addBatch(a),this.spawnRing(t.clone().setY(t.y+.9),e,16724736,.4,.22)}respawnBurst(t){const n=[];for(let s=0;s<32;s++){const o=s/32*Math.PI*2,a=3+Math.random()*4;n.push({x:t.x,y:t.y+.5+Math.random()*.4,z:t.z,vx:Math.cos(o)*a,vy:1.2+Math.random()*3.5,vz:Math.sin(o)*a,life:.5+Math.random()*.5,maxLife:1,gravity:5,drag:.86,size:.09+Math.random()*.07})}const i=bn(this.scene,n,16769152,.1,Hn,"linear");this.addBatch(i),this.spawnRing(t.clone().setY(t.y+.5),new R(1,0,0),16760896,.1,.55),this.spawnRing(t.clone().setY(t.y+.5),new R(1,0,0),16777215,.1,.7)}tickRunTrail(t,e,n,i){if(!i){this.runTrailTimer=0;return}if(this.runTrailTimer+=t,this.runTrailTimer<this.TRAIL_INTERVAL)return;this.runTrailTimer=0;const s=5,o=n.clone().negate(),a=[];for(let l=0;l<s;l++){const h=(Math.random()-.5)*.4,u=1.5+Math.random()*1.5;a.push({x:e.x+o.x*.2+-o.z*h,y:e.y+.06+Math.random()*.08,z:e.z+o.z*.2+o.x*h,vx:o.x*u+(Math.random()-.5)*.5,vy:.3+Math.random()*.5,vz:o.z*u+(Math.random()-.5)*.5,life:.25+Math.random()*.15,maxLife:.4,gravity:2,drag:.82,size:.14+Math.random()*.1})}const c=bn(this.scene,a,13156528,.15,En,"linear");c.mat.opacity=.22,this.addBatch(c)}tickDragonFire(t,e,n,i){if(!i){this.dragonFireTimers.delete(e);return}const o=(this.dragonFireTimers.get(e)??0)+t;this.dragonFireTimers.set(e,o<this.FIRE_INTERVAL?o:0),!(o<this.FIRE_INTERVAL)&&this.spawnDragonFireBatch(n)}spawnDragonFireBatch(t){const n=[];for(let l=0;l<4;l++){const h=Math.random()*Math.PI*2,u=Math.random()*.5;n.push({x:t.x+Math.cos(h)*u,y:t.y+.3+Math.random()*.8,z:t.z+Math.sin(h)*u,vx:(Math.random()-.5)*.4,vy:.6+Math.random()*.8,vz:(Math.random()-.5)*.4,life:.3+Math.random()*.3,maxLife:.6,gravity:-.8,drag:.97,size:.05+Math.random()*.04})}const i=bn(this.scene,n,16768392,.06,Hn,"fire");i.life=i.maxLife=.6,this.addBatch(i);const s=5,o=[];for(let l=0;l<s;l++){const h=Math.random()*Math.PI*2,u=.2+Math.random()*.7;o.push({x:t.x+Math.cos(h)*u,y:t.y+.1+Math.random()*1,z:t.z+Math.sin(h)*u,vx:(Math.random()-.5)*.6,vy:.35+Math.random()*.55,vz:(Math.random()-.5)*.6,life:.4+Math.random()*.4,maxLife:.8,gravity:-.5,drag:.95,size:.08+Math.random()*.07})}const a=Math.random()<.5?16733440:16720384,c=bn(this.scene,o,a,.09,Hn,"fire");if(c.life=c.maxLife=.8,c.mat.opacity=.35,this.addBatch(c),Math.random()<.55){const l=[{x:t.x+(Math.random()-.5)*.9,y:t.y+.8+Math.random()*.8,z:t.z+(Math.random()-.5)*.9,vx:(Math.random()-.5)*.25,vy:.18+Math.random()*.22,vz:(Math.random()-.5)*.25,life:.7+Math.random()*.5,maxLife:1.2,gravity:-.15,drag:.93,size:.22+Math.random()*.16}],h=bn(this.scene,l,3347464,.24,En,"linear");h.mat.opacity=.09+Math.random()*.07,h.life=h.maxLife=1.2,this.addBatch(h)}}spawnRing(t,e,n,i,s){const o=new $c(i,.035,5,28,Math.PI*.8),a=new wn({color:n,transparent:!0,opacity:.75,blending:Hn,depthWrite:!1}),c=new Jt(o,a);c.position.copy(t),c.rotation.x=Math.PI/2,c.rotation.z=Math.atan2(e.x,e.z),this.scene.add(c);let l=0;const h=()=>{l+=.016;const u=Math.min(l/s,1);c.scale.setScalar(1+u*2.5),a.opacity=.75*(1-u),u<1?requestAnimationFrame(h):(this.scene.remove(c),o.dispose(),a.dispose())};h()}dispose(){for(const t of this.batches)this.scene.remove(t.points),t.geo.dispose(),t.mat.dispose();this.batches=[]}}const Uy=[{id:"wind_slash",name:"Corte de Vento",description:"Projeta uma lâmina de ar que atravessa inimigos em linha",killsRequired:1,cooldown:3,damage:45,range:8,color:"#88ffee",icon:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
        ...
        </svg>`}];class Ny{constructor(){k(this,"powers");k(this,"killCount",0);k(this,"activePower",null);k(this,"panelOpen",!1);k(this,"onPowerActivated");k(this,"root");k(this,"hotbarSlots",[]);k(this,"panelEl");k(this,"killsDisplay");this.powers=Uy.map(t=>({...t,unlocked:!1,currentCooldown:0})),this.buildDOM(),this.injectStyles(),this.bindKeys(),this.updateHotbar()}onDragonKilled(t,e){this.killCount++,this.killsDisplay.textContent=String(this.killCount);const n=this.powers.find(i=>!i.unlocked&&i.killsRequired<=this.killCount);n&&(n.unlocked=!0,this.showUnlockNotification(n),this.updateHotbar(),this.updatePanel())}update(t){let e=!1;for(const n of this.powers)n.currentCooldown>0&&(n.currentCooldown=Math.max(0,n.currentCooldown-t),e=!0);e&&this.updateCooldownUI()}getActivePower(){if(this.activePower===null)return null;const t=this.powers[this.activePower];return t!=null&&t.unlocked?t:null}activateSelected(t,e){var i;const n=this.getActivePower();return!n||n.currentCooldown>0?!1:(n.currentCooldown=n.cooldown,this.updateCooldownUI(),(i=this.onPowerActivated)==null||i.call(this,n,t,e),!0)}buildDOM(){this.root=document.createElement("div"),this.root.id="inv-root";const t=document.createElement("div");t.id="inv-hotbar";for(let i=0;i<5;i++){const s=document.createElement("div");s.className="inv-slot",s.dataset.index=String(i),s.innerHTML=`
...
#gui-play-btn:active {
    transform: translateY(0);
        ...
        `,document.head.appendChild(t)}}be.prototype.computeBoundsTree=Sy;be.prototype.disposeBoundsTree=by;Jt.prototype.raycast=vy;const nu=25,By=-30,Oy=[new R(1,0,0),new R(-1,0,0),new R(0,0,1),new R(0,0,-1),new R(1,0,1).normalize(),new R(-1,0,1).normalize(),new R(1,0,-1).normalize(),new R(-1,0,-1).normalize()];class ky{constructor(){k(this,"camera");k(this,"mainScene");k(this,"renderer");k(this,"clock");k(this,"player");k(this,"loader");k(this,"npcManager");k(this,"hud");k(this,"collisionMeshes",[]);k(this,"groundRaycaster",new ra);k(this,"wallRaycaster",new ra);k(this,"mouseRaycaster",new ra);k(this,"DOWN",new R(0,-1,0));k(this,"velocityY",0);k(this,"GRAVITY",-20);k(this,"isGrounded",!1);k(this,"JUMP_FORCE",9);k(this,"jumpBuffered",!1);k(this,"coyoteTimer",0);k(this,"COYOTE_TIME",.12);k(this,"WALL_PROBE_LEN",Mc+.18);k(this,"knockbackVel",new R);k(this,"KNOCKBACK_FRICTION",14);k(this,"spawnPoint",new R(0,10,0));k(this,"keysPressed",new Set);k(this,"mouseWorldPos",new R);k(this,"screenMouse",new Ut);k(this,"playerStamina",100);k(this,"STAMINA_DRAIN",28);k(this,"STAMINA_REGEN",14);k(this,"isRunning",!1);k(this,"vfx");k(this,"powers");k(this,"gameUI");k(this,"gameReady",!1);k(this,"update",()=>{if(requestAnimationFrame(this.update),this.renderer.update(),!this.gameReady)return;const t=Math.min(this.clock.getDelta(),.05);this.camera.update(this.player),this.updateMouseWorldPosition(),this.mouseWorldPos.lengthSq()>0&&this.player.faceWorldPoint(this.mouseWorldPos);const e=this.playerStamina>0;this.isRunning=this.keysPressed.has("shift")&&e&&(this.keysPressed.has("w")||this.keysPressed.has("s")||this.keysPressed.has("a")||this.keysPressed.has("d"));const n=this.camera.getIsometricDirection(this.keysPressed);this.player.applyMovement(n,this.isRunning,t),this.handleJump(t),this.applyGravity(t),this.checkGround(),this.player.lifeState==="alive"&&this.player.position.y<By&&this.respawnPlayer(),this.resolveWallCollisions(),this.resolvePlayerNpcCollisions(),this.updateKnockback(t);const i=this.npcManager.npcs.filter(a=>a.isAlive).length,s=this.npcManager.update(t,this.player.position,this,this.vfx),o=this.npcManager.npcs.filter(a=>a.isAlive).length;if(o<i){const a=i-o;for(let c=0;c<a;c++)this.powers.onDragonKilled(this.player.position.clone(),new R);this.hud.setAmmo(0,0)}if(s>0&&this.player.lifeState==="alive"&&(this.player.takeDamage(s),this.hud.setHealth(this.player.health)),this.player.update(t),this.handlePlayerLifecycle(),this.vfx.update(t),this.isRunning&&this.isGrounded){const a=this.player.velocity.clone();a.lengthSq()>.01&&a.normalize(),this.vfx.tickRunTrail(t,this.player.position.clone(),a,!0)}else this.vfx.tickRunTrail(t,this.player.position.clone(),new R,!1);for(const a of this.npcManager.npcs)this.vfx.tickDragonFire(t,a.uuid,a.position.clone(),a.isAlive);this.updateStamina(t),this.updateMinimapEnemies(),this.hud.update(Math.PI*1.25),this.powers.update(t)});this.clock=new Tp,this.loader=new fv,this.camera=new yx,this.mainScene=new Mx,this.renderer=new Sx(this.camera,this.mainScene),this.player=new wx(this.loader),this.npcManager=new Cy(this.loader),this.hud=new Iy,this.gameUI=new Fy(()=>{this.gameReady=!0,this.clock.start()}),this.mainScene.scene.add(this.npcManager.group),this.vfx=new Dy(this.mainScene.scene),this.powers=new Ny,this.powers.onPowerActivated=(t,e,n)=>{this.executePower(t,e,n)},this.npcManager.spawn({x:5,y:-1.5,z:-10}),this.npcManager.spawn({x:-3,y:-1.5,z:-8}),this.npcManager.spawn({x:8,y:-1.5,z:-5}),this.npcManager.spawn({x:-6,y:-1.5,z:-14}),this.loader.gltfLoad.load("/models/the_lost_portal_-_enviroment.glb",t=>{const e=t.scene;e.scale.set(.01,.01,.01),e.position.set(0,-2,0),e.traverse(i=>{i instanceof Jt&&i.geometry&&(i.geometry.computeBoundsTree(),i.material.wireframe=!1,this.collisionMeshes.push(i))});const n=new Pu(16777215,1);n.position.set(3,6,-5),n.castShadow=!0,n.target=e,this.mainScene.scene.add(n),this.mainScene.scene.add(e),this.player.position.set(0,10,0),this.spawnPoint.set(0,10,0),this.mainScene.scene.add(this.player),this.hud.setHealth(this.player.health),this.hud.setStamina(this.playerStamina),this.hud.setAmmo(6,24),this.gameUI.setProgress(100)},t=>{t.total>0&&this.gameUI.setProgress(Math.round(t.loaded/t.total*90))}),this.setupInput(),this.update()}setupInput(){window.addEventListener("keydown",t=>{const e=t.key.toLowerCase();if(this.keysPressed.add(e),(e===" "||e==="arrowup")&&!t.repeat&&(this.jumpBuffered=!0),e==="q"&&!t.repeat&&this.player.lifeState==="alive"){const n=this.camera.getIsometricDirection(this.keysPressed);this.player.roll(n)}}),window.addEventListener("keyup",t=>{this.keysPressed.delete(t.key.toLowerCase())}),window.addEventListener("contextmenu",t=>t.preventDefault()),window.addEventListener("mousemove",t=>{this.screenMouse.set(t.clientX/window.innerWidth*2-1,t.clientY/window.innerHeight*-2+1)}),window.addEventListener("mousedown",t=>{if(t.button===0&&this.player.isAlive){const e=this.npcManager.collectNpcMeshes(this.npcManager.npcs),n=new R(this.mouseWorldPos.x-this.player.position.x,0,this.mouseWorldPos.z-this.player.position.z).normalize();if(!this.player.attack(e,this.mouseWorldPos))return;this.vfx.slashArc(this.player.position.clone(),n);const s=this.player.onHitWindow;this.player.onHitWindow=()=>{s==null||s();const o=this.npcManager.npcs.filter(a=>a.isAlive).sort((a,c)=>a.position.distanceTo(this.player.position)-c.position.distanceTo(this.player.position))[0];o&&o.position.distanceTo(this.player.position)<=2.2&&(this.vfx.hitSpark(o.position.clone()),this.vfx.bloodBurst(o.position.clone(),n))}}t.button===2&&this.player.isAlive&&(t.preventDefault(),this.powers.activateSelected(this.player.position.clone(),this.mouseWorldPos.clone()))})}updateMouseWorldPosition(){if(this.mouseRaycaster.setFromCamera(this.screenMouse,this.camera.perspectiveCamera),this.collisionMeshes.length>0){const s=[];if(this.collisionMeshes.forEach(o=>s.push(...this.mouseRaycaster.intersectObject(o,!0))),s.length>0){s.sort((o,a)=>o.distance-a.distance),this.mouseWorldPos.copy(s[0].point);return}}const t=this.mouseRaycaster.ray,e=1,n=-this.player.position.y,i=t.direction.dot(new R(0,e,0));if(Math.abs(i)>1e-6){const s=-(t.origin.y*e+n)/i;s>0&&t.at(s,this.mouseWorldPos)}}applyGravity(t){this.isGrounded&&this.velocityY<=0?this.velocityY=0:(this.velocityY+=this.GRAVITY*t,this.velocityY<-30&&(this.velocityY=-30)),this.player.position.y+=this.velocityY*t}checkGround(){const t=this.player.position.clone();t.y+=.5,this.groundRaycaster.set(t,this.DOWN),this.groundRaycaster.far=1.8;const e=[];if(this.collisionMeshes.forEach(s=>e.push(...this.groundRaycaster.intersectObject(s,!0))),e.length===0){this.isGrounded=!1;return}e.sort((s,o)=>s.distance-o.distance);const n=e[0].point.y;this.player.position.y-n<=.12&&this.velocityY<=.5?(this.player.position.y=n,this.velocityY=0,this.isGrounded=!0,this.coyoteTimer=this.COYOTE_TIME):this.isGrounded=!1}handleJump(t){this.isGrounded||(this.coyoteTimer=Math.max(0,this.coyoteTimer-t)),this.jumpBuffered&&(this.jumpBuffered=!1,(this.isGrounded||this.coyoteTimer>0)&&(this.velocityY=this.JUMP_FORCE,this.isGrounded=!1,this.coyoteTimer=0,this.player.clips["CharacterArmature|Jump_Full_Short"]&&this.player.setState("CharacterArmature|Jump_Full_Short",1.4)))}resolveWallCollisions(){if(this.collisionMeshes.length===0)return;const t=this.player.position.clone();t.y+=.8;for(const e of Oy){this.wallRaycaster.set(t,e),this.wallRaycaster.far=this.WALL_PROBE_LEN;const n=[];if(this.collisionMeshes.forEach(c=>n.push(...this.wallRaycaster.intersectObject(c,!0))),n.length===0)continue;n.sort((c,l)=>c.distance-l.distance);const i=n[0],s=this.WALL_PROBE_LEN-i.distance;if(s<=0)continue;let o;if(i.face?o=i.face.normal.clone().transformDirection(i.object.matrixWorld):o=e.clone().negate(),o.y=0,o.lengthSq()<.001)continue;o.normalize(),this.player.position.x+=o.x*s,this.player.position.z+=o.z*s;const a=this.player.velocity.dot(e);a>0&&(this.player.velocity.x-=e.x*a,this.player.velocity.z-=e.z*a)}}applyPlayerKnockback(t,e){const n=t.clone();n.y=0,!(n.lengthSq()<.001)&&(n.normalize().multiplyScalar(e),this.knockbackVel.add(n))}updateKnockback(t){if(this.knockbackVel.lengthSq()<1e-4){this.knockbackVel.set(0,0,0);return}this.player.position.x+=this.knockbackVel.x*t,this.player.position.z+=this.knockbackVel.z*t,this.knockbackVel.multiplyScalar(Math.max(0,1-this.KNOCKBACK_FRICTION*t))}resolvePlayerNpcCollisions(){const t=Mc+il;for(const e of this.npcManager.npcs){if(!e.isAlive)continue;const n=new R(this.player.position.x-e.position.x,0,this.player.position.z-e.position.z),i=n.length();if(i<t&&i>.001){const s=t-i,o=n.normalize().multiplyScalar(s*.6);this.player.position.x+=o.x,this.player.position.z+=o.z}}}updateStamina(t){this.isRunning?(this.playerStamina=Math.max(0,this.playerStamina-this.STAMINA_DRAIN*t),this.playerStamina===0&&this.hud.showAlert("SEM FOLEGO!",1500)):this.playerStamina=Math.min(100,this.playerStamina+this.STAMINA_REGEN*t),this.hud.setStamina(this.playerStamina)}updateMinimapEnemies(){this.hud.clearEnemies();for(const t of this.npcManager.npcs){if(!t.isAlive)continue;const e=t.position.clone().sub(this.player.position);this.hud.addEnemy({id:t.uuid,x:e.x/nu,z:e.z/nu}),e.length()<4&&this.hud.showAlert("INIMIGO PROXIMO!",1500)}}handlePlayerLifecycle(){switch(this.player.lifeState){case"dying":this.hud.showAlert("VOCÊ MORREU",99999);break;case"dead":this.triggerRespawn();break}}triggerRespawn(){this.player.lifeState="respawning",setTimeout(()=>{this.velocityY=0,this.isGrounded=!1,this.coyoteTimer=0,this.knockbackVel.set(0,0,0),this.player.position.copy(this.spawnPoint),this.player.startRespawn(),this.playerStamina=100,this.hud.setStamina(this.playerStamina),this.hud.setHealth(this.player.health),this.hud.showAlert("",0),this.vfx.respawnBurst(this.spawnPoint.clone()),this.player.onRespawnComplete=()=>{this.hud.showAlert("",0)}},1*1e3)}respawnPlayer(){this.velocityY=0,this.isGrounded=!1,this.coyoteTimer=0,this.knockbackVel.set(0,0,0),this.player.velocity.set(0,0,0),this.player.position.copy(this.spawnPoint),this.player.lifeState==="alive"&&(this.player.health=this.player.maxHealth,this.hud.setHealth(this.player.health),this.playerStamina=100,this.hud.setStamina(this.playerStamina),this.hud.showAlert("CAIU NO VAZIO!",2e3),this.vfx.respawnBurst(this.spawnPoint.clone()))}executePower(t,e,n){const i=new R(n.x-e.x,0,n.z-e.z).normalize(),s=this.npcManager.npcs.filter(o=>o.isAlive?o.position.distanceTo(n)<=t.range||o.position.distanceTo(e)<=t.range:!1);switch(t.id){case"wind_slash":{this.vfx.slashArc(e.clone(),i),s.forEach(o=>{const a=o.position.clone().sub(e).normalize();i.dot(a)>.5&&o.takeDamage(t.damage,e)});break}case"seismic":{this.vfx.respawnBurst(e.clone()),s.forEach(o=>{o.position.distanceTo(e)<=t.range&&o.takeDamage(t.damage,e)});break}case"crimson_flame":{this.vfx.respawnBurst(n.clone()),this.vfx.bloodBurst(n.clone(),i),s.forEach(o=>{o.position.distanceTo(n)<=t.range&&o.takeDamage(t.damage,e)});break}case"phantom_bolt":{const o=s.sort((a,c)=>a.position.distanceTo(e)-c.position.distanceTo(e)).slice(0,3);o.forEach(a=>{this.vfx.hitSpark(a.position.clone()),a.takeDamage(t.damage,e)}),o.length>0&&this.vfx.slashArc(e.clone(),i);break}case"final_storm":{this.vfx.respawnBurst(e.clone()),this.vfx.slashArc(e.clone(),i),this.vfx.bloodBurst(n.clone(),i),s.forEach(o=>{this.vfx.hitSpark(o.position.clone()),o.takeDamage(t.damage,e)});break}}}}new ky;
